...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_LoadPageEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_LoadPageEventHandler(int PageNumber, [In, Out] ref int Continue);
}
