...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_SelectedObjectChangeEventHandler
...
namespace ACPDFCREACTIVEX
{
  [ComVisible(false)]
  [TypeLibType(16)]
  public delegate void _IPDFCreactiveXEvents_SelectedObjectChangeEventHandler();
}
