...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_ObjectTextChangeEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_ObjectTextChangeEventHandler([MarshalAs(UnmanagedType.IDispatch), In] object pObject);
}
