...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_SavePageEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_SavePageEventHandler(int PageNumber, [In, Out] ref int Continue);
}
