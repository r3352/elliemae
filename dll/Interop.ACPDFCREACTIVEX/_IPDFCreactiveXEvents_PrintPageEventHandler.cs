...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_PrintPageEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_PrintPageEventHandler(int PageNumber, [In, Out] ref int Continue);
}
