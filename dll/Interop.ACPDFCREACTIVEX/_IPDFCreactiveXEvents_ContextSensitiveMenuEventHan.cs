...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_ContextSensitiveMenuEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_ContextSensitiveMenuEventHandler([In, Out] ref int Continue);
}
