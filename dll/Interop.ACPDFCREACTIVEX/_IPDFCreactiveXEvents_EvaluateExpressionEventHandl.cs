...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_EvaluateExpressionEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_EvaluateExpressionEventHandler(
    [MarshalAs(UnmanagedType.IDispatch), In] object pObject,
    [MarshalAs(UnmanagedType.BStr), In, Out] ref string result,
