...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_BeforeDeleteEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_BeforeDeleteEventHandler([In, Out] ref int Continue);
}
