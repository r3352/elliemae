...
// Type: ACPDFCREACTIVEX.ReachTextOptionConstants
...
{
  public enum ReachTextOptionConstants
  {
    acReachTextOptionStart = -1, // 0xFFFFFFFF
    acReachTextOptionCurrent = 0,
    acReachTextOptionStartNoCase = 1,
    acReachTextOptionCurrentNoCase = 2,
  }
}
