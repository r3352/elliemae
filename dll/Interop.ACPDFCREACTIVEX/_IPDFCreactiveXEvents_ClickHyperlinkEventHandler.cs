...
// Type: ACPDFCREACTIVEX._IPDFCreactiveXEvents_ClickHyperlinkEventHandler
...
namespace ACPDFCREACTIVEX
{
  [TypeLibType(16)]
  [ComVisible(false)]
  public delegate void _IPDFCreactiveXEvents_ClickHyperlinkEventHandler(
    [MarshalAs(UnmanagedType.BStr)] string Object,
    [MarshalAs(UnmanagedType.BStr)] string Hyperlink,
