...
// Type: EllieMae.Encompass.BusinessObjects.LockDeskSettings.ONRPRetailBranchSetting
...
{
  public class ONRPRetailBranchSetting : ONRPBranchSetting
  {
    public bool UseParentInfo;

    public ONRPRetailBranchSetting Convert(ONRPBranchSetting setting)
    {
