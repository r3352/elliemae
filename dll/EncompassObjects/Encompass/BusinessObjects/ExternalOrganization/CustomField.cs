      ...
      if (type <= 211)
      {
        switch (type - 101)
        {
          ...
          case 5:
            ...
            bool flag4 = false;
            return Utils.FormatInput(value, this.type, ref flag4);
          case 6:
            ...
            int result2;
            bool flag5 = strArray4.Length == 1 && strArray4[0].Length == 9 && int.TryParse(strArray4[0], out result2);
            if (!flag5)
              flag5 = strArray4.Length == 3 && strArray4[0].Length == 3 && strArray4[1].Length == 2 && strArray4[2].Length == 4 && int.TryParse(strArray4[0], out result2) && int.TryParse(strArray4[1], out result2) && int.TryParse(strArray4[2], out result2);
            if (!flag5)
              throw new FieldValidationException(this.FieldName, value, "Value is not a valid SSN. Format is XXXXXXXXX or XXX-XX-XXXX");
            bool flag6 = false;
            return Utils.FormatInput(value, this.type, ref flag6);
          default:
            switch (type - 201)
            {
              case 0:
