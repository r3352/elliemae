...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_BeforeDeleteEvent
...
{
  public class _IPDFCreactiveXEvents_BeforeDeleteEvent
  {
    public int @continue;

    public _IPDFCreactiveXEvents_BeforeDeleteEvent(int @continue) => this.@continue = @continue;
  }
}
