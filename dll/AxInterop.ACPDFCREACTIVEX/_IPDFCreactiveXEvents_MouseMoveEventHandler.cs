...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_MouseMoveEventHandler
...
{
  public delegate void _IPDFCreactiveXEvents_MouseMoveEventHandler(
    object sender,
    _IPDFCreactiveXEvents_MouseMoveEvent e);
}
