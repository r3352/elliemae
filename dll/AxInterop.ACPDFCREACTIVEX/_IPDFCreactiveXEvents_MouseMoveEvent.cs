...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_MouseMoveEvent
...
{
  public class _IPDFCreactiveXEvents_MouseMoveEvent
  {
    public acObject pObject;
    public int xPos;
    public int yPos;

    public _IPDFCreactiveXEvents_MouseMoveEvent(acObject pObject, int xPos, int yPos)
    {
