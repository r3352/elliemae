...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_PrintPageEventHandler
...
{
  public delegate void _IPDFCreactiveXEvents_PrintPageEventHandler(
    object sender,
    _IPDFCreactiveXEvents_PrintPageEvent e);
}
