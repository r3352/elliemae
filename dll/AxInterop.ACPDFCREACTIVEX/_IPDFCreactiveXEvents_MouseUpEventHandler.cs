...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_MouseUpEventHandler
...
{
  public delegate void _IPDFCreactiveXEvents_MouseUpEventHandler(
    object sender,
    _IPDFCreactiveXEvents_MouseUpEvent e);
}
