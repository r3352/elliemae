...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_ActivateObjectEvent
...
{
  public class _IPDFCreactiveXEvents_ActivateObjectEvent
  {
    public object pObject;
    public int @continue;

    public _IPDFCreactiveXEvents_ActivateObjectEvent(object pObject, int @continue)
    {
