...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_NewObjectEventHandler
...
{
  public delegate void _IPDFCreactiveXEvents_NewObjectEventHandler(
    object sender,
    _IPDFCreactiveXEvents_NewObjectEvent e);
}
