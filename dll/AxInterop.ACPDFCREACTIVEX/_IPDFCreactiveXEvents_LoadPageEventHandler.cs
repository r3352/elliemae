...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_LoadPageEventHandler
...
{
  public delegate void _IPDFCreactiveXEvents_LoadPageEventHandler(
    object sender,
    _IPDFCreactiveXEvents_LoadPageEvent e);
}
