...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_SavePageEventHandler
...
{
  public delegate void _IPDFCreactiveXEvents_SavePageEventHandler(
    object sender,
    _IPDFCreactiveXEvents_SavePageEvent e);
}
