...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_SavePageEvent
...
{
  public class _IPDFCreactiveXEvents_SavePageEvent
  {
    public int pageNumber;
    public int @continue;

    public _IPDFCreactiveXEvents_SavePageEvent(int pageNumber, int @continue)
    {
