...
// Type: AxACPDFCREACTIVEX._IPDFCreactiveXEvents_ClickHyperlinkEvent
...
{
  public class _IPDFCreactiveXEvents_ClickHyperlinkEvent
  {
    public string @object;
    public string hyperlink;
    public int @continue;

    public _IPDFCreactiveXEvents_ClickHyperlinkEvent(
      string @object,
      string hyperlink,
      int @continue)
    {
