...
namespace EllieMae.Encompass.Forms.Design
{
  public class FieldSelector : System.Windows.Forms.Form
  {
    ...
    public FieldSelector()
    {
      ...
      this.sortMngrStandard = new ListViewSortManager(this.lvwStandard, new Type[3]
      {
    ...
    {
      if (((FeaturesAclManager) Session.ACL.GetAclManager((AclCategory) 0)).CheckPermission((AclFeature) 932, Session.UserInfo))
        return;
    ...
    private FieldDescriptor resolveMultiInstanceField(FieldDescriptor field)
    {
      using (InstanceSelectorDialog instanceSelectorDialog = new InstanceSelectorDialog((FieldInstanceSpecifierType) field.InstanceSpecifierType))
        return ((System.Windows.Forms.Form) instanceSelectorDialog).ShowDialog((IWin32Window) this) != DialogResult.OK ? (FieldDescriptor) null : field.GetInstanceDescriptor((object) instanceSelectorDialog.SelectedInstance);
    }
    ...
    private void btnNew_Click(object sender, EventArgs e)
    {
      ...
      {
        if (((System.Windows.Forms.Form) fieldsEditorDialog).ShowDialog((IWin32Window) this) != DialogResult.OK)
          return;
    ...
    private void tabsFields_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (this.tabsFields.SelectedTab == this.tpVirtual && this.sortMngrVirtual == null)
      {
        ...
        this.loadVirtualFields((string) null);
        this.sortMngrVirtual = new ListViewSortManager(this.lvwVirtual, new Type[3]
        {
          typeof (FieldSelector.ListViewFieldIDSort),
          typeof (ListViewTextSort),
          typeof (ListViewTextSort)
      ...
      else
      {
        ...
        Cursor.Current = Cursors.WaitCursor;
        this.loadCustomFields((string) null);
        this.sortMngrCustom = new ListViewSortManager(this.lvwCustom, new Type[3]
        {
          typeof (FieldSelector.ListViewFieldIDSort),
          typeof (ListViewTextSort),
          typeof (ListViewTextSort)
