...
// Type: EllieMae.EMLite.ePass.LoginUserEventArgs
...
{
  public class LoginUserEventArgs : QuestionEventArgs
  {
    private bool showDialogs;

    public LoginUserEventArgs(bool showDialogs)
    {
      this.showDialogs = showDialogs;
      this.Response = true;
    }

    public bool ShowDialogs => this.showDialogs;
  }
}
