...
// Type: EllieMae.EMLite.ePass.Browser.EncPrintJobEventArgs
...
{
  public class EncPrintJobEventArgs : EventArgs
  {
    public bool Success { get; }

    public EncPrintJobEventArgs(bool success) => this.Success = success;
  }
}
