...
// Type: EllieMae.EMLite.ePass.Messaging.ConcurrentUpdateNotificationEventHandler
...
{
  public delegate void ConcurrentUpdateNotificationEventHandler(
    object sender,
    ConcurrentUpdateArgs eventArgs);
}
