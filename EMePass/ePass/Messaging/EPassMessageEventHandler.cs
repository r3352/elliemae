...
// Type: EllieMae.EMLite.ePass.Messaging.EPassMessageEventHandler
...
{
  public delegate void EPassMessageEventHandler(object sender, EPassMessageEventArgs eventArgs);
}
