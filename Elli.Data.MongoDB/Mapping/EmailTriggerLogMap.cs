...
// Type: Elli.Data.MongoDB.Mapping.EmailTriggerLogMap
...
{
  public class EmailTriggerLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (EmailTriggerLog)))
        return;
      BsonClassMap.RegisterClassMap<EmailTriggerLog>((Action<BsonClassMap<EmailTriggerLog>>) (cm => cm.AutoMap()));
