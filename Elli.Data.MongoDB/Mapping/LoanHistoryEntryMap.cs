...
// Type: Elli.Data.MongoDB.Mapping.LoanHistoryEntryMap
...
{
  internal class LoanHistoryEntryMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LoanHistoryEntry)))
        return;
      BsonClassMap.RegisterClassMap<LoanHistoryEntry>((Action<BsonClassMap<LoanHistoryEntry>>) (cm => cm.AutoMap()));
    }
  }
}
