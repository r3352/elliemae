...
// Type: Elli.Data.MongoDB.Mapping.FundingMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class FundingMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Funding)))
        return;
      BsonClassMap.RegisterClassMap<Funding>((Action<BsonClassMap<Funding>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Funding, Loan>>) (c => c.Loan));
      }));
    }
  }
}
