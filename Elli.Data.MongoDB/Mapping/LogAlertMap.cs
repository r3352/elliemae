...
// Type: Elli.Data.MongoDB.Mapping.LogAlertMap
...
{
  public class LogAlertMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LogAlert)))
        return;
      BsonClassMap.RegisterClassMap<LogAlert>((Action<BsonClassMap<LogAlert>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<LogRecord>((Expression<Func<LogAlert, LogRecord>>) (c => c.LogRecord));
      }));
