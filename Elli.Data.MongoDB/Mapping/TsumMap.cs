...
// Type: Elli.Data.MongoDB.Mapping.TsumMap
...
{
  public class TsumMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Tsum)))
        return;
      BsonClassMap.RegisterClassMap<Tsum>((Action<BsonClassMap<Tsum>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Tsum, Loan>>) (c => c.Loan));
      }));
    }
  }
}
