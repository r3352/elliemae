...
// Type: Elli.Data.MongoDB.Mapping.HtmlEmailLogMap
...
{
  public class HtmlEmailLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (HtmlEmailLog)))
        return;
      BsonClassMap.RegisterClassMap<HtmlEmailLog>((Action<BsonClassMap<HtmlEmailLog>>) (cm => cm.AutoMap()));
