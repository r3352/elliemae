...
// Type: Elli.Data.MongoDB.Mapping.MarginIndexLogMap
...
{
  public class MarginIndexLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (MarginIndexLog)))
        return;
      BsonClassMap.RegisterClassMap<MarginIndexLog>((Action<BsonClassMap<MarginIndexLog>>) (cm => cm.AutoMap()));
