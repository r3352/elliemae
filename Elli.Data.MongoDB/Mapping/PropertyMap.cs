...
// Type: Elli.Data.MongoDB.Mapping.PropertyMap
  ...
  public class PropertyMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Property)))
        return;
      BsonClassMap.RegisterClassMap<Property>((Action<BsonClassMap<Property>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Property, Loan>>) (c => c.Loan));
      }));
    }
  }
}
