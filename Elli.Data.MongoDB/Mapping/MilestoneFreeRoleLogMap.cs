...
// Type: Elli.Data.MongoDB.Mapping.MilestoneFreeRoleLogMap
...
{
  public class MilestoneFreeRoleLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (MilestoneFreeRoleLog)))
        return;
      BsonClassMap.RegisterClassMap<MilestoneFreeRoleLog>((Action<BsonClassMap<MilestoneFreeRoleLog>>) (cm => cm.AutoMap()));
      LoanAssociateMap.Register();
