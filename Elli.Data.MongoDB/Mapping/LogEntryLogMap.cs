...
// Type: Elli.Data.MongoDB.Mapping.LogEntryLogMap
...
{
  public class LogEntryLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LogEntryLog)))
        return;
      BsonClassMap.RegisterClassMap<LogEntryLog>((Action<BsonClassMap<LogEntryLog>>) (cm => cm.AutoMap()));
