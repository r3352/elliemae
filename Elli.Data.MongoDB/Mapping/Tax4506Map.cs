...
// Type: Elli.Data.MongoDB.Mapping.Tax4506Map
...
{
  public class Tax4506Map
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Tax4506)))
        return;
      BsonClassMap.RegisterClassMap<Tax4506>((Action<BsonClassMap<Tax4506>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Application>((Expression<Func<Tax4506, Application>>) (c => c.Application));
      }));
    }
  }
}
