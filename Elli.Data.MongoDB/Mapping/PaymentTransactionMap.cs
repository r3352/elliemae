...
// Type: Elli.Data.MongoDB.Mapping.PaymentTransactionMap
...
{
  public class PaymentTransactionMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (PaymentTransaction)))
        return;
      BsonClassMap.RegisterClassMap<PaymentTransaction>((Action<BsonClassMap<PaymentTransaction>>) (cm => cm.AutoMap()));
    }
  }
}
