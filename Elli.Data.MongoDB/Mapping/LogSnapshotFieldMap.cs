...
// Type: Elli.Data.MongoDB.Mapping.LogSnapshotFieldMap
...
{
  public class LogSnapshotFieldMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LogSnapshotField)))
        return;
      BsonClassMap.RegisterClassMap<LogSnapshotField>((Action<BsonClassMap<LogSnapshotField>>) (cm => cm.AutoMap()));
    }
  }
}
