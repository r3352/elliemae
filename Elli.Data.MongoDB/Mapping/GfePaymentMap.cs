...
// Type: Elli.Data.MongoDB.Mapping.GfePaymentMap
...
{
  public class GfePaymentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (GfePayment)))
        return;
      BsonClassMap.RegisterClassMap<GfePayment>((Action<BsonClassMap<GfePayment>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Gfe>((Expression<Func<GfePayment, Gfe>>) (c => c.Gfe));
      }));
    }
  }
}
