...
// Type: Elli.Data.MongoDB.Mapping.TQLDocumentMap
...
{
  public class TQLDocumentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (TQLDocument)))
        return;
      BsonClassMap.RegisterClassMap<TQLDocument>((Action<BsonClassMap<TQLDocument>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<TQL>((Expression<Func<TQLDocument, TQL>>) (c => c.TQL));
      }));
    }
  }
}
