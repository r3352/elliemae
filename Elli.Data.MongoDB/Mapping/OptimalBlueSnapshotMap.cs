...
// Type: Elli.Data.MongoDB.Mapping.OptimalBlueSnapshotMap
...
{
  public class OptimalBlueSnapshotMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (OptimalBlueSnapshot)))
        return;
      BsonClassMap.RegisterClassMap<OptimalBlueSnapshot>((Action<BsonClassMap<OptimalBlueSnapshot>>) (cm => cm.AutoMap()));
    }
  }
}
