...
// Type: Elli.Data.MongoDB.Mapping.LockDenialLogMap
...
{
  public class LockDenialLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LockDenialLog)))
        return;
      BsonClassMap.RegisterClassMap<LockDenialLog>((Action<BsonClassMap<LockDenialLog>>) (cm => cm.AutoMap()));
