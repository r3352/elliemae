...
// Type: Elli.Data.MongoDB.Mapping.DownPaymentMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class DownPaymentMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (DownPayment)))
        return;
      BsonClassMap.RegisterClassMap<DownPayment>((Action<BsonClassMap<DownPayment>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<DownPayment, Loan>>) (c => c.Loan));
      }));
    }
  }
}
