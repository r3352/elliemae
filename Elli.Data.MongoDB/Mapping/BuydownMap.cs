...
// Type: Elli.Data.MongoDB.Mapping.BuydownMap
...
{
  public class BuydownMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Buydown)))
        return;
      BsonClassMap.RegisterClassMap<Buydown>((Action<BsonClassMap<Buydown>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<LoanProductData>((Expression<Func<Buydown, LoanProductData>>) (c => c.LoanProductData));
      }));
    }
  }
}
