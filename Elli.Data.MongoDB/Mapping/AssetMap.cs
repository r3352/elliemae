...
// Type: Elli.Data.MongoDB.Mapping.AssetMap
  ...
  public class AssetMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Asset)))
        return;
      BsonClassMap.RegisterClassMap<Asset>((Action<BsonClassMap<Asset>>) (cm =>
      {
        cm.AutoMap();
        cm.MapProperty<bool>((Expression<Func<Asset, bool>>) (c => c.IsVod));
        cm.UnmapProperty<Application>((Expression<Func<Asset, Application>>) (c => c.Application));
      }));
    }
  }
}
