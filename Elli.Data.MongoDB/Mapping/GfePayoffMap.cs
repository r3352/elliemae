...
// Type: Elli.Data.MongoDB.Mapping.GfePayoffMap
...
{
  public class GfePayoffMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (GfePayoff)))
        return;
      BsonClassMap.RegisterClassMap<GfePayoff>((Action<BsonClassMap<GfePayoff>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Gfe>((Expression<Func<GfePayoff, Gfe>>) (c => c.Gfe));
      }));
    }
  }
}
