...
// Type: Elli.Data.MongoDB.Mapping.LockConfirmLogMap
...
{
  public class LockConfirmLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LockConfirmLog)))
        return;
      BsonClassMap.RegisterClassMap<LockConfirmLog>((Action<BsonClassMap<LockConfirmLog>>) (cm => cm.AutoMap()));
