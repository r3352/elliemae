...
// Type: Elli.Data.MongoDB.Mapping.CrmLogMap
...
{
  public class CrmLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (CrmLog)))
        return;
      BsonClassMap.RegisterClassMap<CrmLog>((Action<BsonClassMap<CrmLog>>) (cm => cm.AutoMap()));
