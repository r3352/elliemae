...
// Type: Elli.Data.MongoDB.Mapping.MilestoneTaskContactMap
...
{
  public class MilestoneTaskContactMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (MilestoneTaskContact)))
        return;
      BsonClassMap.RegisterClassMap<MilestoneTaskContact>((Action<BsonClassMap<MilestoneTaskContact>>) (cm => cm.AutoMap()));
    }
  }
}
