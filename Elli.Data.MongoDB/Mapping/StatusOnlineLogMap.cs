...
// Type: Elli.Data.MongoDB.Mapping.StatusOnlineLogMap
...
{
  public class StatusOnlineLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (StatusOnlineLog)))
        return;
      BsonClassMap.RegisterClassMap<StatusOnlineLog>((Action<BsonClassMap<StatusOnlineLog>>) (cm =>
      {
        cm.AutoMap();
        cm.MapField("soEvents").SetElementName("Events");
      }));
      LogAlertMap.Register();
      LogCommentMap.Register();
      StatusOnlineEventMap.Register();
    }
  }
}
