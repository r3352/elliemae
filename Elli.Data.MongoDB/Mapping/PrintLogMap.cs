...
// Type: Elli.Data.MongoDB.Mapping.PrintLogMap
...
{
  public class PrintLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (PrintLog)))
        return;
      BsonClassMap.RegisterClassMap<PrintLog>((Action<BsonClassMap<PrintLog>>) (cm =>
      {
        cm.AutoMap();
        cm.MapField("printForms").SetElementName("PrintForms");
      }));
      LogAlertMap.Register();
      LogCommentMap.Register();
      PrintFormMap.Register();
    }
  }
}
