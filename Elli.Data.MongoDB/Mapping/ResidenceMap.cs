...
// Type: Elli.Data.MongoDB.Mapping.ResidenceMap
  ...
  public class ResidenceMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Residence)))
        return;
      BsonClassMap.RegisterClassMap<Residence>((Action<BsonClassMap<Residence>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Application>((Expression<Func<Residence, Application>>) (c => c.Application));
      }));
    }
  }
}
