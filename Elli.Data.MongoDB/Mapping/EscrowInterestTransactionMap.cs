...
// Type: Elli.Data.MongoDB.Mapping.EscrowInterestTransactionMap
...
{
  public class EscrowInterestTransactionMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (EscrowInterestTransaction)))
        return;
      BsonClassMap.RegisterClassMap<EscrowInterestTransaction>((Action<BsonClassMap<EscrowInterestTransaction>>) (cm => cm.AutoMap()));
    }
  }
}
