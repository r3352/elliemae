...
// Type: Elli.Data.MongoDB.Mapping.ShippingMap
  ...
  public class ShippingMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Shipping)))
        return;
      BsonClassMap.RegisterClassMap<Shipping>((Action<BsonClassMap<Shipping>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Shipping, Loan>>) (c => c.Loan));
        cm.MapField("shippingContacts").SetElementName("ShippingContacts");
      }));
      ShippingContactMap.Register();
    }
  }
}
