...
// Type: Elli.Data.MongoDB.Mapping.ComplianceTestLogMap
...
{
  public class ComplianceTestLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (ComplianceTestLog)))
        return;
      BsonClassMap.RegisterClassMap<ComplianceTestLog>((Action<BsonClassMap<ComplianceTestLog>>) (cm => cm.AutoMap()));
