...
// Type: Elli.Data.MongoDB.Mapping.EdmDocumentMap
...
{
  public class EdmDocumentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (EdmDocument)))
        return;
      BsonClassMap.RegisterClassMap<EdmDocument>((Action<BsonClassMap<EdmDocument>>) (cm => cm.AutoMap()));
    }
  }
}
