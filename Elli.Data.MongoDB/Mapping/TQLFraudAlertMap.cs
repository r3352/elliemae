...
// Type: Elli.Data.MongoDB.Mapping.TQLFraudAlertMap
...
{
  public class TQLFraudAlertMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (TQLFraudAlert)))
        return;
      BsonClassMap.RegisterClassMap<TQLFraudAlert>((Action<BsonClassMap<TQLFraudAlert>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<TQL>((Expression<Func<TQLFraudAlert, TQL>>) (c => c.TQL));
      }));
    }
  }
}
