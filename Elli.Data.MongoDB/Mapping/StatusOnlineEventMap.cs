...
// Type: Elli.Data.MongoDB.Mapping.StatusOnlineEventMap
...
{
  public class StatusOnlineEventMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (StatusOnlineEvent)))
        return;
      BsonClassMap.RegisterClassMap<StatusOnlineEvent>((Action<BsonClassMap<StatusOnlineEvent>>) (cm => cm.AutoMap()));
    }
  }
}
