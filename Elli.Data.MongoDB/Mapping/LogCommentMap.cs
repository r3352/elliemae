...
// Type: Elli.Data.MongoDB.Mapping.LogCommentMap
...
{
  public class LogCommentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LogComment)))
        return;
      BsonClassMap.RegisterClassMap<LogComment>((Action<BsonClassMap<LogComment>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<LogRecord>((Expression<Func<LogComment, LogRecord>>) (c => c.LogRecord));
      }));
    }
  }
}
