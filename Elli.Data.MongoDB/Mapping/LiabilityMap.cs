...
// Type: Elli.Data.MongoDB.Mapping.LiabilityMap
...
{
  public class LiabilityMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Liability)))
        return;
      BsonClassMap.RegisterClassMap<Liability>((Action<BsonClassMap<Liability>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Application>((Expression<Func<Liability, Application>>) (c => c.Application));
      }));
    }
  }
}
