...
// Type: Elli.Data.MongoDB.Mapping.IncomeMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class IncomeMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Income)))
        return;
      BsonClassMap.RegisterClassMap<Income>((Action<BsonClassMap<Income>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Application>((Expression<Func<Income, Application>>) (c => c.Application));
      }));
    }
  }
}
