...
// Type: Elli.Data.MongoDB.Mapping.PurchaseCreditMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class PurchaseCreditMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (PurchaseCredit)))
        return;
      BsonClassMap.RegisterClassMap<PurchaseCredit>((Action<BsonClassMap<PurchaseCredit>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<PurchaseCredit, Loan>>) (c => c.Loan));
      }));
    }
  }
}
