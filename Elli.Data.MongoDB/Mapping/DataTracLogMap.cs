...
// Type: Elli.Data.MongoDB.Mapping.DataTracLogMap
...
{
  public class DataTracLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (DataTracLog)))
        return;
      BsonClassMap.RegisterClassMap<DataTracLog>((Action<BsonClassMap<DataTracLog>>) (cm => cm.AutoMap()));
