...
// Type: Elli.Data.MongoDB.Mapping.MilestoneLogMap
...
{
  public class MilestoneLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (MilestoneLog)))
        return;
      BsonClassMap.RegisterClassMap<MilestoneLog>((Action<BsonClassMap<MilestoneLog>>) (cm => cm.AutoMap()));
