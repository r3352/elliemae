...
// Type: Elli.Data.MongoDB.Mapping.CorrespondentMap
...
{
  public class CorrespondentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Correspondent)))
        return;
      BsonClassMap.RegisterClassMap<Correspondent>((Action<BsonClassMap<Correspondent>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Correspondent, Loan>>) (c => c.Loan));
      }));
    }
  }
}
