...
// Type: Elli.Data.MongoDB.Mapping.EmploymentMap
...
{
  public class EmploymentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Employment)))
        return;
      BsonClassMap.RegisterClassMap<Employment>((Action<BsonClassMap<Employment>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Application>((Expression<Func<Employment, Application>>) (c => c.Application));
      }));
    }
  }
}
