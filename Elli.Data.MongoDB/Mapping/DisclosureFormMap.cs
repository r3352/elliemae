...
// Type: Elli.Data.MongoDB.Mapping.DisclosureFormMap
...
{
  public class DisclosureFormMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (DisclosureForm)))
        return;
      BsonClassMap.RegisterClassMap<DisclosureForm>((Action<BsonClassMap<DisclosureForm>>) (cm => cm.AutoMap()));
    }
  }
}
