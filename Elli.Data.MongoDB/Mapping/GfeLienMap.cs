...
// Type: Elli.Data.MongoDB.Mapping.GfeLienMap
...
{
  public class GfeLienMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (GfeLien)))
        return;
      BsonClassMap.RegisterClassMap<GfeLien>((Action<BsonClassMap<GfeLien>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Gfe>((Expression<Func<GfeLien, Gfe>>) (c => c.Gfe));
      }));
    }
  }
}
