...
// Type: Elli.Data.MongoDB.Mapping.ATRQMCommonMap
...
{
  public class ATRQMCommonMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (ATRQMCommon)))
        return;
      BsonClassMap.RegisterClassMap<ATRQMCommon>((Action<BsonClassMap<ATRQMCommon>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<ATRQMCommon, Loan>>) (c => c.Loan));
      }));
    }
  }
}
