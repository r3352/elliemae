...
// Type: Elli.Data.MongoDB.Mapping.EmDocumentMap
...
{
  public class EmDocumentMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (EmDocument)))
        return;
      BsonClassMap.RegisterClassMap<EmDocument>((Action<BsonClassMap<EmDocument>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<EmDocument, Loan>>) (c => c.Loan));
      }));
    }
  }
}
