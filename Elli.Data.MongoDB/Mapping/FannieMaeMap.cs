...
// Type: Elli.Data.MongoDB.Mapping.FannieMaeMap
...
{
  public class FannieMaeMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (FannieMae)))
        return;
      BsonClassMap.RegisterClassMap<FannieMae>((Action<BsonClassMap<FannieMae>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<FannieMae, Loan>>) (c => c.Loan));
      }));
    }
  }
}
