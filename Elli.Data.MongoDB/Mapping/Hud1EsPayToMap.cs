...
// Type: Elli.Data.MongoDB.Mapping.Hud1EsPayToMap
...
{
  public class Hud1EsPayToMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Hud1EsPayTo)))
        return;
      BsonClassMap.RegisterClassMap<Hud1EsPayTo>((Action<BsonClassMap<Hud1EsPayTo>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Hud1Es>((Expression<Func<Hud1EsPayTo, Hud1Es>>) (c => c.Hud1Es));
      }));
    }
  }
}
