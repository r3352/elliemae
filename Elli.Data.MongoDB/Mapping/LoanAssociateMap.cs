...
// Type: Elli.Data.MongoDB.Mapping.LoanAssociateMap
...
{
  public class LoanAssociateMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LoanAssociate)))
        return;
      BsonClassMap.RegisterClassMap<LoanAssociate>((Action<BsonClassMap<LoanAssociate>>) (cm => cm.AutoMap()));
    }
  }
}
