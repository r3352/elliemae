...
// Type: Elli.Data.MongoDB.Mapping.LogConditionMap
...
{
  public class LogConditionMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LogCondition)))
        return;
      BsonClassMap.RegisterClassMap<LogCondition>((Action<BsonClassMap<LogCondition>>) (cm => cm.AutoMap()));
    }
  }
}
