...
// Type: Elli.Data.MongoDB.Mapping.DocumentOrderSnapshotMap
...
{
  public class DocumentOrderSnapshotMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (DocumentOrderSnapshot)))
        return;
      BsonClassMap.RegisterClassMap<DocumentOrderSnapshot>((Action<BsonClassMap<DocumentOrderSnapshot>>) (cm => cm.AutoMap()));
    }
  }
}
