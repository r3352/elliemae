...
// Type: Elli.Data.MongoDB.Mapping.McawMap
...
{
  public class McawMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Mcaw)))
        return;
      BsonClassMap.RegisterClassMap<Mcaw>((Action<BsonClassMap<Mcaw>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Mcaw, Loan>>) (c => c.Loan));
      }));
    }
  }
}
