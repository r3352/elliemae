...
// Type: Elli.Data.MongoDB.Mapping.TPOMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class TPOMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (TPO)))
        return;
      BsonClassMap.RegisterClassMap<TPO>((Action<BsonClassMap<TPO>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<TPO, Loan>>) (c => c.Loan));
      }));
    }
  }
}
