...
// Type: Elli.Data.MongoDB.Mapping.LoanPurchaseTransactionMap
...
{
  public class LoanPurchaseTransactionMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LoanPurchaseTransaction)))
        return;
      BsonClassMap.RegisterClassMap<LoanPurchaseTransaction>((Action<BsonClassMap<LoanPurchaseTransaction>>) (cm => cm.AutoMap()));
    }
  }
}
