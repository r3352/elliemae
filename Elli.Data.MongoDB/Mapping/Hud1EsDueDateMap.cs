...
// Type: Elli.Data.MongoDB.Mapping.Hud1EsDueDateMap
...
{
  public class Hud1EsDueDateMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Hud1EsDueDate)))
        return;
      BsonClassMap.RegisterClassMap<Hud1EsDueDate>((Action<BsonClassMap<Hud1EsDueDate>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Hud1Es>((Expression<Func<Hud1EsDueDate, Hud1Es>>) (c => c.Hud1Es));
      }));
    }
  }
}
