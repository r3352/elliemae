...
// Type: Elli.Data.MongoDB.Mapping.CustomFieldMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class CustomFieldMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (CustomField)))
        return;
      BsonClassMap.RegisterClassMap<CustomField>((Action<BsonClassMap<CustomField>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<CustomField, Loan>>) (c => c.Loan));
      }));
    }
  }
}
