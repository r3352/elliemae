...
// Type: Elli.Data.MongoDB.Mapping.PrivacyPolicyMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class PrivacyPolicyMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (PrivacyPolicy)))
        return;
      BsonClassMap.RegisterClassMap<PrivacyPolicy>((Action<BsonClassMap<PrivacyPolicy>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<PrivacyPolicy, Loan>>) (c => c.Loan));
      }));
    }
  }
}
