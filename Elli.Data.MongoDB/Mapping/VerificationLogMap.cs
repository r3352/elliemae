...
// Type: Elli.Data.MongoDB.Mapping.VerificationLogMap
...
{
  public class VerificationLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (VerificationLog)))
        return;
      BsonClassMap.RegisterClassMap<VerificationLog>((Action<BsonClassMap<VerificationLog>>) (cm => cm.AutoMap()));
