...
// Type: Elli.Data.MongoDB.Mapping.FileAttachmentReferenceMap
...
{
  public class FileAttachmentReferenceMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (FileAttachmentReference)))
        return;
      BsonClassMap.RegisterClassMap<FileAttachmentReference>((Action<BsonClassMap<FileAttachmentReference>>) (cm => cm.AutoMap()));
    }
  }
}
