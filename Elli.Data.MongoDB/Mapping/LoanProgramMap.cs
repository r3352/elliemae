...
// Type: Elli.Data.MongoDB.Mapping.LoanProgramMap
...
{
  public class LoanProgramMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LoanProgram)))
        return;
      BsonClassMap.RegisterClassMap<LoanProgram>((Action<BsonClassMap<LoanProgram>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<LoanProgram, Loan>>) (c => c.Loan));
      }));
    }
  }
}
