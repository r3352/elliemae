...
// Type: Elli.Data.MongoDB.Mapping.EdmLogMap
...
{
  public class EdmLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (EdmLog)))
        return;
      BsonClassMap.RegisterClassMap<EdmLog>((Action<BsonClassMap<EdmLog>>) (cm =>
      {
        cm.AutoMap();
        cm.MapField("documents").SetElementName("Documents");
      }));
      EdmDocumentMap.Register();
