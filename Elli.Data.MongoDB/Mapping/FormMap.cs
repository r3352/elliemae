...
// Type: Elli.Data.MongoDB.Mapping.FormMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class FormMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Form)))
        return;
      BsonClassMap.RegisterClassMap<Form>((Action<BsonClassMap<Form>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Form, Loan>>) (c => c.Loan));
      }));
    }
  }
}
