...
// Type: Elli.Data.MongoDB.Mapping.OtherTransactionMap
...
{
  public class OtherTransactionMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (OtherTransaction)))
        return;
      BsonClassMap.RegisterClassMap<OtherTransaction>((Action<BsonClassMap<OtherTransaction>>) (cm => cm.AutoMap()));
    }
  }
}
