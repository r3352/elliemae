...
// Type: Elli.Data.MongoDB.Mapping.Hud1EsSetupMap
...
{
  public class Hud1EsSetupMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Hud1EsSetup)))
        return;
      BsonClassMap.RegisterClassMap<Hud1EsSetup>((Action<BsonClassMap<Hud1EsSetup>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Hud1Es>((Expression<Func<Hud1EsSetup, Hud1Es>>) (c => c.Hud1Es));
      }));
    }
  }
}
