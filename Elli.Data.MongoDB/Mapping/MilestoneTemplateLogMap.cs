...
// Type: Elli.Data.MongoDB.Mapping.MilestoneTemplateLogMap
...
{
  public class MilestoneTemplateLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (MilestoneTemplateLog)))
        return;
      BsonClassMap.RegisterClassMap<MilestoneTemplateLog>((Action<BsonClassMap<MilestoneTemplateLog>>) (cm => cm.AutoMap()));
