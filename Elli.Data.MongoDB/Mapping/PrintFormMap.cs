...
// Type: Elli.Data.MongoDB.Mapping.PrintFormMap
...
{
  public class PrintFormMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (PrintForm)))
        return;
      BsonClassMap.RegisterClassMap<PrintForm>((Action<BsonClassMap<PrintForm>>) (cm => cm.AutoMap()));
    }
  }
}
