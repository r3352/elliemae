...
// Type: Elli.Data.MongoDB.Mapping.RegistrationLogMap
...
{
  public class RegistrationLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (RegistrationLog)))
        return;
      BsonClassMap.RegisterClassMap<RegistrationLog>((Action<BsonClassMap<RegistrationLog>>) (cm => cm.AutoMap()));
