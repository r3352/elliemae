...
// Type: Elli.Data.MongoDB.Mapping.ContactMap
  ...
  public class ContactMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Contact)))
        return;
      BsonClassMap.RegisterClassMap<Contact>((Action<BsonClassMap<Contact>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Contact, Loan>>) (c => c.Loan));
      }));
    }
  }
}
