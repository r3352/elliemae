...
// Type: Elli.Data.MongoDB.Mapping.DownloadLogMap
...
{
  public class DownloadLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (DownloadLog)))
        return;
      BsonClassMap.RegisterClassMap<DownloadLog>((Action<BsonClassMap<DownloadLog>>) (cm => cm.AutoMap()));
