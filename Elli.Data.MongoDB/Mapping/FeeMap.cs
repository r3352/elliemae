...
// Type: Elli.Data.MongoDB.Mapping.FeeMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class FeeMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Fee)))
        return;
      BsonClassMap.RegisterClassMap<Fee>((Action<BsonClassMap<Fee>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Fee, Loan>>) (c => c.Loan));
      }));
    }
  }
}
