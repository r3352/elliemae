...
// Type: Elli.Data.MongoDB.Mapping.EntityReferenceMap
...
namespace Elli.Data.MongoDB.Mapping
{
  public class EntityReferenceMap
  {
    ...
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (EntityReference)))
        return;
      BsonClassMap.RegisterClassMap<EntityReference>((Action<BsonClassMap<EntityReference>>) (cm => cm.AutoMap()));
    }
  }
}
