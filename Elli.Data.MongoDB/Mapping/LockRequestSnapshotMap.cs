...
// Type: Elli.Data.MongoDB.Mapping.LockRequestSnapshotMap
...
{
  internal class LockRequestSnapshotMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (LockRequestSnapshot)))
        return;
      BsonClassMap.RegisterClassMap<LockRequestSnapshot>((Action<BsonClassMap<LockRequestSnapshot>>) (cm => cm.AutoMap()));
    }
  }
}
