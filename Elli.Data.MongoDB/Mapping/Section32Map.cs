...
// Type: Elli.Data.MongoDB.Mapping.Section32Map
...
{
  public class Section32Map
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Section32)))
        return;
      BsonClassMap.RegisterClassMap<Section32>((Action<BsonClassMap<Section32>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Section32, Loan>>) (c => c.Loan));
      }));
    }
  }
}
