...
// Type: Elli.Data.MongoDB.Mapping.MilestoneHistoryLogMap
...
{
  public class MilestoneHistoryLogMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (MilestoneHistoryLog)))
        return;
      BsonClassMap.RegisterClassMap<MilestoneHistoryLog>((Action<BsonClassMap<MilestoneHistoryLog>>) (cm => cm.AutoMap()));
