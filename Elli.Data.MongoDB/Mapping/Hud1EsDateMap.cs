...
// Type: Elli.Data.MongoDB.Mapping.Hud1EsDateMap
...
{
  public class Hud1EsDateMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Hud1EsDate)))
        return;
      BsonClassMap.RegisterClassMap<Hud1EsDate>((Action<BsonClassMap<Hud1EsDate>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Hud1Es>((Expression<Func<Hud1EsDate, Hud1Es>>) (c => c.Hud1Es));
      }));
    }
  }
}
