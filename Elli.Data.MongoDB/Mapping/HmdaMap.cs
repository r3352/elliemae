...
// Type: Elli.Data.MongoDB.Mapping.HmdaMap
...
{
  public class HmdaMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (Hmda)))
        return;
      BsonClassMap.RegisterClassMap<Hmda>((Action<BsonClassMap<Hmda>>) (cm =>
      {
        cm.AutoMap();
        cm.UnmapProperty<Loan>((Expression<Func<Hmda, Loan>>) (c => c.Loan));
      }));
    }
  }
}
