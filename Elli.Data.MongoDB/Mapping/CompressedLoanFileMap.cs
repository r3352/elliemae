...
// Type: Elli.Data.MongoDB.Mapping.CompressedLoanFileMap
...
{
  public class CompressedLoanFileMap
  {
    public static void Register()
    {
      if (BsonClassMap.IsClassMapRegistered(typeof (CompressedLoanFile)))
        return;
      BsonClassMap.RegisterClassMap<CompressedLoanFile>((Action<BsonClassMap<CompressedLoanFile>>) (cm => cm.AutoMap()));
    }
  }
}
