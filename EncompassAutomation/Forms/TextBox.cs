...
namespace EllieMae.Encompass.Forms
{
  ...
  public class TextBox : FieldControl, ISupportsChangeEvent, ISupportsEvents, ISupportsFormatEvent
  {
    ...
    /// <summary>Constructor for a new TextBox control.</summary>
    public TextBox()
    {
    }
    ...
    /// <summary>Gets/Sets the text displayed in the control.</summary>
    [Browsable(false)]
    ...
    public virtual int MaxLength
    {
      ...
      set
      {
        ...
        if (value <= 0)
        {
          this.FieldElement.removeAttribute("maxLength");
          this.maxLength = 0;
        }
        else
        {
          this.FieldElement.setAttribute("maxLength", (object) string.Concat((object) value));
    ...
    /// <summary>Returns the list of event supported by this control.</summary>
    ...
    /// <summary>Performs final tasks before displaying the control.</summary>
    ...
    /// <summary>Attaches a PickList control to the current TextBox.</summary>
    ...
    internal override void AttachToElement(Form form, IHTMLElement controlElement)
    {
      ...
      try
      {
        ...
        fieldElement.remove_onchange(new HTMLInputTextElementEvents2_onchangeEventHandler((object) this, (UIntPtr) __methodptr(onTextChanged)));
      }
      catch
      {
      }
      // ISSUE: method pointer
      fieldElement.add_onchange(new HTMLInputTextElementEvents2_onchangeEventHandler((object) this, (UIntPtr) __methodptr(onTextChanged)));
    }
