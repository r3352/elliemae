  ...
  public class DropdownOptionsDialog : System.Windows.Forms.Form
  {
    ...
    public DropdownOptionsDialog(DropdownOptionCollection options)
    {
      ...
      if (!options.AllowEditValues)
      {
        ...
        this.lvwOptions.Height = this.lvwOptions.Bottom - this.txtValue.Top;
        this.lvwOptions.Top = this.txtValue.Top;
      ...
      foreach (DropdownOption option in options)
      {
        if (option.Value == "" && option.Text == "")
          ...
          this.lvwOptions.Items.Add(new ListViewItem(new string[2]
          {
            option.Text,
            option.Value
          }));
    ...
    private void InitializeComponent()
    {
      ...
      this.lvwOptions.Location = new Point(14, 60);
      this.lvwOptions.MultiSelect = false;
      this.lvwOptions.Name = "lvwOptions";
      this.lvwOptions.Size = new Size(326, 148);
      this.lvwOptions.TabIndex = 4;
    ...
    {
      foreach (ListViewItem orFindItem in this.lvwOptions.Items)
      {
      ...
      this.lvwOptions.Items.Add(orFindItem1);
      return orFindItem1;
    }
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
      ...
      foreach (ListViewItem selectedItem in this.lvwOptions.SelectedItems)
        arrayList.Add((object) selectedItem);
      foreach (ListViewItem listViewItem in arrayList)
        this.lvwOptions.Items.Remove(listViewItem);
    }
    ...
    {
      if (this.lvwOptions.SelectedItems == null || this.lvwOptions.SelectedItems.Count <= 0)
        return;
      int index = this.lvwOptions.Items.IndexOf(this.lvwOptions.SelectedItems[0]);
      if (index <= 0)
        return;
      ListViewItem listViewItem = this.lvwOptions.Items[index - 1];
      this.lvwOptions.Items.Remove(listViewItem);
      this.lvwOptions.Items.Insert(index, listViewItem);
    }
    ...
    private void btnDown_Click(object sender, EventArgs e)
    {
      if (this.lvwOptions.SelectedItems == null || this.lvwOptions.SelectedItems.Count <= 0)
        return;
      int index = this.lvwOptions.Items.IndexOf(this.lvwOptions.SelectedItems[0]);
      if (index + 1 >= this.lvwOptions.Items.Count)
        return;
      ListViewItem listViewItem = this.lvwOptions.Items[index + 1];
      this.lvwOptions.Items.Remove(listViewItem);
      this.lvwOptions.Items.Insert(index, listViewItem);
    ...
    private void lvwOptions_SubItemEndEditing(object sender, SubItemEndEditingEventArgs e)
    {
      ...
      if (e.SubItem == 0 && e.DisplayText == "")
      {
        ...
        e.DisplayText = e.Item.SubItems[0].Text;
      }
      if (e.SubItem != 1 || !(e.DisplayText == "") || this.options.AllowEmptyValues)
        return;
      ...
      e.DisplayText = e.Item.SubItems[1].Text;
    }
