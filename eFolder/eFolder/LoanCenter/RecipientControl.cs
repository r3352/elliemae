...
// Type: EllieMae.EMLite.eFolder.LoanCenter.RecipientControl
...
namespace EllieMae.EMLite.eFolder.LoanCenter
{
  public class RecipientControl : UserControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.pnlRecipient.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      ...
      this.cbSelect.Location = new Point(3, 7);
      ...
      this.txtAuthenticationCode.Anchor = AnchorStyles.Top | AnchorStyles.Right;
