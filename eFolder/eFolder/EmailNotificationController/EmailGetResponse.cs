...
// Type: EllieMae.EMLite.eFolder.EmailNotificationController.EmailGetResponse
...
namespace EllieMae.EMLite.eFolder.EmailNotificationController
{
  ...
  public class EmailGetResponse
  {
    ...
    public EmailGetResponse(EmailSetting[] EmailSettings) => this.EmailSettings = EmailSettings;
  }
}
