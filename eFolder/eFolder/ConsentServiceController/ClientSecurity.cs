...
// Type: EllieMae.EMLite.eFolder.ConsentServiceController.ClientSecurity
...
namespace EllieMae.EMLite.eFolder.ConsentServiceController
{
  ...
  [Serializable]
  public class ClientSecurity : IExtensibleDataObject, INotifyPropertyChanged
  {
    [NonSerialized]
    ...
    public string ClientAuthCode
    {
      ...
      set
      {
        if ((object) this.ClientAuthCodeField == (object) value)
          return;
        this.ClientAuthCodeField = value;
        this.RaisePropertyChanged(nameof (ClientAuthCode));
      }
    }
