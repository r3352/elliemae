...
// Type: EllieMae.EMLite.eFolder.ConsentServiceController.IsConsentRequiredRequest
...
namespace EllieMae.EMLite.eFolder.ConsentServiceController
{
  ...
  public class IsConsentRequiredRequest
  {
    ...
    public IsConsentRequiredRequestIsConsentRequiredRequestBody IsConsentRequiredRequest1;
    ...
    public IsConsentRequiredRequest(
      Security Security,
      IsConsentRequiredRequestIsConsentRequiredRequestBody IsConsentRequiredRequest1)
    {
