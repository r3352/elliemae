...
// Type: EllieMae.EMLite.eFolder.ConsentServiceController.ConsentClientDataGetRequest
...
namespace EllieMae.EMLite.eFolder.ConsentServiceController
{
  ...
  public class ConsentClientDataGetRequest
  {
    ...
    public ConsentClientDataGetRequestConsentClientDataGetRequestBody ConsentClientDataGetRequest1;
    ...
    public ConsentClientDataGetRequest(
      Security Security,
      ConsentClientDataGetRequestConsentClientDataGetRequestBody ConsentClientDataGetRequest1)
    {
