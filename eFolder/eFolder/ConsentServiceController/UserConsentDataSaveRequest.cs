...
// Type: EllieMae.EMLite.eFolder.ConsentServiceController.UserConsentDataSaveRequest
...
namespace EllieMae.EMLite.eFolder.ConsentServiceController
{
  ...
  public class UserConsentDataSaveRequest
  {
    ...
    public UserConsentDataSaveRequestUserConsentDataSaveRequestBody UserConsentDataSaveRequest1;
    ...
    public UserConsentDataSaveRequest(
      Security Security,
      UserConsentDataSaveRequestUserConsentDataSaveRequestBody UserConsentDataSaveRequest1)
    {
