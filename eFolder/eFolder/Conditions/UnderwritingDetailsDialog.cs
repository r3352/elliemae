...
// Type: EllieMae.EMLite.eFolder.Conditions.UnderwritingDetailsDialog
...
{
  public class UnderwritingDetailsDialog : Form
  {
    private const string className = "UnderwritingDetailsDialog";
    private static readonly string sw = Tracing.SwEFolder;
    private static List<UnderwritingDetailsDialog> _instanceList = new List<UnderwritingDetailsDialog>();
    private LoanDataMgr loanDataMgr;
    private UnderwritingConditionLog cond;
    ...
    public static void ShowInstance(LoanDataMgr loanDataMgr, UnderwritingConditionLog cond)
    {
      if (Form.ActiveForm != null && Form.ActiveForm.Modal)
      {
        using (UnderwritingDetailsDialog underwritingDetailsDialog = new UnderwritingDetailsDialog(loanDataMgr, cond))
        {
          int num = (int) underwritingDetailsDialog.ShowDialog((IWin32Window) Form.ActiveForm);
        }
      }
      else
      {
        UnderwritingDetailsDialog underwritingDetailsDialog1 = (UnderwritingDetailsDialog) null;
        foreach (UnderwritingDetailsDialog instance in UnderwritingDetailsDialog._instanceList)
        {
          if (instance.Condition == cond)
            underwritingDetailsDialog1 = instance;
        }
        if (underwritingDetailsDialog1 == null)
        {
          UnderwritingDetailsDialog underwritingDetailsDialog2 = new UnderwritingDetailsDialog(loanDataMgr, cond);
          underwritingDetailsDialog2.FormClosing += new FormClosingEventHandler(UnderwritingDetailsDialog._instance_FormClosing);
          UnderwritingDetailsDialog._instanceList.Add(underwritingDetailsDialog2);
          underwritingDetailsDialog2.Show();
        }
        else
        {
          if (underwritingDetailsDialog1.WindowState == FormWindowState.Minimized)
            underwritingDetailsDialog1.WindowState = FormWindowState.Normal;
          underwritingDetailsDialog1.Activate();
        }
      }
    }
    ...
    {
      if (UnderwritingDetailsDialog._instanceList == null && UnderwritingDetailsDialog._instanceList.Count == 0)
        return;
      int num = UnderwritingDetailsDialog._instanceList.Count - 1;
      try
      {
        for (int index = num; index >= 0; --index)
          UnderwritingDetailsDialog._instanceList[index].Close();
      }
      catch
      {
      }
    ...
    {
      UnderwritingDetailsDialog underwritingDetailsDialog = (UnderwritingDetailsDialog) sender;
      UnderwritingDetailsDialog._instanceList.Remove(underwritingDetailsDialog);
    }

    private UnderwritingDetailsDialog(LoanDataMgr loanDataMgr, UnderwritingConditionLog cond)
    {
    ...
    public UnderwritingConditionLog Condition => this.cond;
    ...
    private void loadTitleField()
    {
      ...
      this.Text = "Underwriting Condition Details (" + this.cond.Title + ")";
    }
    ...
    private void cboTitle_SelectionChangeCommitted(object sender, EventArgs e)
    {
      ...
      this.Text = "Underwriting Condition Details (" + selectedItem + ")";
    ...
    private void loadFulfilledFields()
    {
      ...
      this.dateFulfilled.Visible = this.chkFulfilled.Checked && this.rights.CanChangeSignoffDate;
      this.txtDateFulfilled.Visible = this.chkFulfilled.Checked && !this.rights.CanChangeSignoffDate;
      this.txtFulfilledBy.Visible = this.chkFulfilled.Checked;
      this.btnFulfilledBy.Visible = this.chkFulfilled.Checked && this.rights.CanChangeSignoffName;
    }

    private void checkUnderwriterAccess()
    {
      if (this.underwriterRole == null || !this.rights.CanSetDocumentAccess)
        return;
    ...
    private void loadRequestedFields()
    {
      ...
      this.dateRequested.Visible = this.chkRequested.Checked && this.rights.CanEditUnderwritingCondition;
      this.txtDateRequested.Visible = this.chkRequested.Checked && !this.rights.CanEditUnderwritingCondition;
      this.txtRequestedBy.Visible = this.chkRequested.Checked;
      this.btnRequestedBy.Visible = this.chkRequested.Checked && this.rights.CanEditUnderwritingCondition;
    }
    ...
    private void loadRerequestedFields()
    {
      ...
      this.dateRerequested.Visible = this.chkRerequested.Checked && this.rights.CanEditUnderwritingCondition;
      this.txtDateRerequested.Visible = this.chkRerequested.Checked && !this.rights.CanEditUnderwritingCondition;
      this.txtRerequestedBy.Visible = this.chkRerequested.Checked;
      this.btnRerequestedBy.Visible = this.chkRerequested.Checked && this.rights.CanEditUnderwritingCondition;
    }
    ...
    private void loadReceivedFields()
    {
      ...
      this.dateReceived.Visible = this.chkReceived.Checked && this.rights.CanChangeSignoffDate;
      this.txtDateReceived.Visible = this.chkReceived.Checked && !this.rights.CanChangeSignoffDate;
      this.txtReceivedBy.Visible = this.chkReceived.Checked;
      this.btnReceivedBy.Visible = this.chkReceived.Checked && this.rights.CanChangeSignoffName;
    }
    ...
    private void loadReviewedFields()
    {
      ...
      this.dateReviewed.Visible = this.chkReviewed.Checked && this.rights.CanChangeSignoffDate;
      this.txtDateReviewed.Visible = this.chkReviewed.Checked && !this.rights.CanChangeSignoffDate;
      this.txtReviewedBy.Visible = this.chkReviewed.Checked;
      this.btnReviewedBy.Visible = this.chkReviewed.Checked && this.rights.CanChangeSignoffName;
    }
    ...
    private void loadRejectedFields()
    {
      ...
      this.dateRejected.Visible = this.chkRejected.Checked && this.rights.CanChangeSignoffDate;
      this.txtDateRejected.Visible = this.chkRejected.Checked && !this.rights.CanChangeSignoffDate;
      this.txtRejectedBy.Visible = this.chkRejected.Checked;
      this.btnRejectedBy.Visible = this.chkRejected.Checked && this.rights.CanChangeSignoffName;
    }
    ...
    private void loadClearedFields()
    {
      ...
      this.dateCleared.Visible = this.chkCleared.Checked && this.rights.CanChangeSignoffDate;
      this.txtDateCleared.Visible = this.chkCleared.Checked && !this.rights.CanChangeSignoffDate;
      this.txtClearedBy.Visible = this.chkCleared.Checked;
      this.btnClearedBy.Visible = this.chkCleared.Checked && this.rights.CanChangeSignoffName;
    }
    ...
    private void loadWaivedFields()
    {
      ...
      this.dateWaived.Visible = this.chkWaived.Checked && this.rights.CanChangeSignoffDate;
      this.txtDateWaived.Visible = this.chkWaived.Checked && !this.rights.CanChangeSignoffDate;
      this.txtWaivedBy.Visible = this.chkWaived.Checked;
      this.btnWaivedBy.Visible = this.chkWaived.Checked && this.rights.CanChangeSignoffName;
    }
    ...
    {
      this.cboTitle.Visible = this.rights.CanEditUnderwritingCondition;
      this.txtTitle.Visible = !this.rights.CanEditUnderwritingCondition;
      this.txtDescription.ReadOnly = !this.rights.CanEditUnderwritingCondition;
      this.cboBorrower.Visible = this.rights.CanEditUnderwritingCondition;
      this.txtBorrower.Visible = !this.rights.CanEditUnderwritingCondition;
      this.cboCategory.Visible = this.rights.CanEditUnderwritingCondition;
      this.txtCategory.Visible = !this.rights.CanEditUnderwritingCondition;
      this.cboPriorTo.Visible = this.rights.CanChangePriorTo;
      this.txtPriorTo.Visible = !this.rights.CanChangePriorTo;
      this.cboOwner.Visible = this.rights.CanEditUnderwritingCondition;
      this.txtOwner.Visible = !this.rights.CanEditUnderwritingCondition;
      this.chkAllowToClear.Enabled = this.rights.CanEditUnderwritingCondition;
      this.chkInternal.Enabled = this.rights.CanEditUnderwritingCondition;
      this.chkExternal.Enabled = this.rights.CanEditUnderwritingCondition;
      this.chkFulfilled.Enabled = this.rights.CanFulfillUnderwritingCondition;
      this.chkReceived.Enabled = this.rights.CanReceiveUnderwritingCondition;
      this.chkReviewed.Enabled = this.rights.CanReviewUnderwritingCondition;
      this.chkRejected.Enabled = this.rights.CanRejectUnderwritingCondition;
      this.chkCleared.Enabled = this.rights.CanClearUnderwritingCondition;
      this.chkWaived.Enabled = this.rights.CanWaiveUnderwritingCondition;
      this.commentCollection.CanAddComment = this.rights.CanAddUnderwritingConditionComments;
      this.commentCollection.CanDeleteComment = this.rights.CanDeleteUnderwritingConditionComments;
      this.btnAddDocument.Visible = this.rights.CanAddUnderwritingConditionDocuments;
      this.btnRemoveDocument.Visible = this.rights.CanRemoveUnderwritingConditionDocuments;
    ...
    {
      Tracing.Log(UnderwritingDetailsDialog.sw, TraceLevel.Verbose, nameof (UnderwritingDetailsDialog), "Checking InvokeRequired For LogRecordChanged");
      if (this.InvokeRequired)
      {
        LogRecordEventHandler method = new LogRecordEventHandler(this.logRecordChanged);
        Tracing.Log(UnderwritingDetailsDialog.sw, TraceLevel.Verbose, nameof (UnderwritingDetailsDialog), "Calling BeginInvoke For LogRecordChanged");
    ...
    {
      Tracing.Log(UnderwritingDetailsDialog.sw, TraceLevel.Verbose, nameof (UnderwritingDetailsDialog), "Checking InvokeRequired For LogRecordRemoved");
      if (this.InvokeRequired)
      {
        LogRecordEventHandler method = new LogRecordEventHandler(this.logRecordRemoved);
        Tracing.Log(UnderwritingDetailsDialog.sw, TraceLevel.Verbose, nameof (UnderwritingDetailsDialog), "Calling BeginInvoke For LogRecordRemoved");
        this.BeginInvoke((Delegate) method, source, (object) e);
      }
      else
      {
    ...
    {
      this.cond = (UnderwritingConditionLog) this.loanDataMgr.LoanData.GetLogList().GetRecordByID(this.cond.Guid);
      this.loadConditionDetails();
    }
    ...
    private void UnderwritingDetailsDialog_KeyDown(object sender, KeyEventArgs e)
    {
    ...
    private void UnderwritingDetailsDialog_Activated(object sender, EventArgs e)
    {
    ...
    private void UnderwritingDetailsDialog_FormClosing(object sender, FormClosingEventArgs e)
    {
      if (this.fileViewer.CanCloseViewer())
        return;
      e.Cancel = true;
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (UnderwritingDetailsDialog));
      ...
      this.pnlRight.Size = new Size(435, 657);
      ...
      this.pnlViewer.Size = new Size(435, 530);
      ...
      this.fileViewer.Size = new Size(433, 528);
      this.fileViewer.TabIndex = 67;
      ...
      this.btnRequestDocument.TabIndex = 63;
      ...
      this.btnWaivedBy.Location = new Point(297, 250);
      ...
      this.btnClearedBy.Location = new Point(297, 226);
      ...
      this.btnRejectedBy.Location = new Point(297, 202);
      ...
      this.btnReviewedBy.Location = new Point(297, 178);
      ...
      this.btnReceivedBy.Location = new Point(297, 154);
      ...
      this.btnRerequestedBy.Location = new Point(299, 132);
      ...
      this.btnRequestedBy.Location = new Point(298, 107);
      ...
      this.btnFulfilledBy.Location = new Point(297, 81);
      ...
      this.pnlLeft.Size = new Size(332, 657);
      ...
      this.gcTracking.Location = new Point(0, 319);
      this.gcTracking.Name = "gcTracking";
      this.gcTracking.Padding = new Padding(3, 3, 2, 2);
      this.gcTracking.Size = new Size(332, 338);
      ...
      this.tabTracking.Size = new Size(325, 306);
      ...
      this.pageStatus.Size = new Size(317, 279);
      ...
      this.txtFulfilledBy.Location = new Point(237, 79);
      ...
      this.dateFulfilled.Size = new Size(134, 20);
      ...
      this.txtDateFulfilled.Size = new Size(131, 20);
      ...
      this.txtRerequestedBy.Location = new Point(237, 129);
      ...
      this.dateRerequested.Size = new Size(134, 20);
      ...
      this.txtDateRerequested.Size = new Size(131, 20);
      ...
      this.txtRequestedBy.Location = new Point(237, 104);
      ...
      this.dateRequested.Size = new Size(136, 20);
      ...
      this.txtDateRequested.Size = new Size(131, 20);
      ...
      this.txtRequestedFrom.Size = new Size(199, 20);
      ...
      this.txtWaivedBy.Location = new Point(237, 248);
      ...
      this.dateWaived.Size = new Size(134, 20);
      ...
      this.txtDateWaived.Size = new Size(131, 20);
      ...
      this.txtClearedBy.Location = new Point(237, 224);
      ...
      this.dateCleared.Size = new Size(134, 20);
      ...
      this.txtDateCleared.Size = new Size(131, 20);
      ...
      this.txtRejectedBy.Location = new Point(237, 200);
      ...
      this.dateRejected.Size = new Size(134, 20);
      ...
      this.txtDateRejected.Size = new Size(131, 20);
      ...
      this.txtReviewedBy.Location = new Point(237, 176);
      ...
      this.dateReviewed.Size = new Size(134, 20);
      ...
      this.txtDateReviewed.Size = new Size(131, 20);
      ...
      this.txtReceivedBy.Location = new Point(237, 152);
      ...
      this.dateReceived.Size = new Size(134, 20);
      ...
      this.txtDateReceived.Size = new Size(131, 20);
      ...
      this.txtAddedBy.Location = new Point(237, 56);
      ...
      this.txtAddedDate.Size = new Size(134, 20);
      ...
      this.csDetails.Location = new Point(0, 312);
      ...
      this.gcDetails.Size = new Size(332, 312);
      ...
      this.pnlDetails.Size = new Size(330, 285);
      this.pnlDetails.TabIndex = 2;
      this.lblPrint.AutoSize = true;
      this.lblPrint.Location = new Point(8, 256);
      this.lblPrint.Name = "lblPrint";
      this.lblPrint.Size = new Size(28, 14);
      this.lblPrint.TabIndex = 24;
      this.lblPrint.Text = "Print";
      this.chkExternal.AutoSize = true;
      this.chkExternal.Location = new Point(156, (int) byte.MaxValue);
      ...
      this.chkInternal.Location = new Point(84, (int) byte.MaxValue);
      ...
      this.chkAllowToClear.Location = new Point(228, 227);
      ...
      this.cboOwner.Location = new Point(84, 224);
      ...
      this.txtOwner.Location = new Point(84, 224);
      this.txtOwner.Name = "txtOwner";
      this.txtOwner.ReadOnly = true;
      this.txtOwner.Size = new Size(136, 20);
      this.txtOwner.TabIndex = 22;
      this.lblOwner.AutoSize = true;
      this.lblOwner.Location = new Point(8, 228);
      ...
      this.cboPriorTo.Location = new Point(84, 196);
      ...
      this.txtPriorTo.Location = new Point(84, 196);
      ...
      this.cboCategory.Location = new Point(84, 168);
      ...
      this.txtCategory.Location = new Point(84, 168);
      ...
      this.txtSource.Location = new Point(84, 140);
      ...
      this.cboBorrower.Location = new Point(84, 112);
      ...
      this.txtBorrower.Location = new Point(84, 112);
      ...
      this.pnlClose.Location = new Point(0, 657);
      ...
      this.ClientSize = new Size(774, 697);
      ...
      this.Name = nameof (UnderwritingDetailsDialog);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Underwriting Condition Details";
      this.Activated += new EventHandler(this.UnderwritingDetailsDialog_Activated);
      this.FormClosing += new FormClosingEventHandler(this.UnderwritingDetailsDialog_FormClosing);
      this.KeyDown += new KeyEventHandler(this.UnderwritingDetailsDialog_KeyDown);
