...
// Type: EllieMae.EMLite.eFolder.Documents.RetrieveEpassDialog
...
{
  public class RetrieveEpassDialog : Form
  {
    ...
    public RetrieveEpassDialog(LoanDataMgr loanDataMgr, DocumentLog[] docList)
    {
    ...
    {
      this.btnRetrieve_Click(source, EventArgs.Empty);
    }
    ...
    private void RetrieveEpassDialog_KeyDown(object sender, KeyEventArgs e)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.gcEpass.Size = new Size(564, 432);
      this.gcEpass.TabIndex = 0;
      this.gcEpass.Text = "Retrieve from Service Providers";
      ...
      this.gvEpass.Size = new Size(562, 405);
      ...
      this.btnRetrieve.Location = new Point(422, 448);
      ...
      this.Name = nameof (RetrieveEpassDialog);
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = "Retrieve";
      this.KeyDown += new KeyEventHandler(this.RetrieveEpassDialog_KeyDown);
