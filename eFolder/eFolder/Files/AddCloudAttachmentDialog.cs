...
// Type: EllieMae.EMLite.eFolder.Files.AddCloudAttachmentDialog
...
{
  public class AddCloudAttachmentDialog : Form
  {
    ...
    public AddCloudAttachmentDialog(DocumentLog doc)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "AddImageAttachmentDialog";
