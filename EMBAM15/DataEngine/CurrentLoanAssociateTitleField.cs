...
// Type: EllieMae.EMLite.DataEngine.CurrentLoanAssociateTitleField
...
{
  public class CurrentLoanAssociateTitleField : VirtualField
  {
    internal CurrentLoanAssociateTitleField()
      : base("CurrentTeamMemberTitle", "Current Loan Team Member Title", FieldFormat.STRING)
    {
    }
