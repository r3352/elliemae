...
// Type: EllieMae.EMLite.DataEngine.PreviousLoanAssociateNameField
...
{
  public class PreviousLoanAssociateNameField : VirtualField
  {
    internal PreviousLoanAssociateNameField()
      : base("PreviousTeamMemberName", "Previous Loan Team Member Name", FieldFormat.STRING)
    {
    }
    ...
    protected override string Evaluate(LoanData loan)
    {
      ...
      return milestoneLog == null ? "" : milestoneLog.LoanAssociateName;
    }
  }
}
