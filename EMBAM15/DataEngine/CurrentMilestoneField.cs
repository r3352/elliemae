...
// Type: EllieMae.EMLite.DataEngine.CurrentMilestoneField
...
{
  public class CurrentMilestoneField : VirtualField
  {
    internal CurrentMilestoneField()
      : base("Log.MS.CurrentMilestone", "Current Milestone", FieldFormat.STRING)
    {
    }
