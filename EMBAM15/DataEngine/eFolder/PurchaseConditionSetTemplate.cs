...
// Type: EllieMae.EMLite.DataEngine.eFolder.PurchaseConditionSetTemplate
...
{
  [Serializable]
  public class PurchaseConditionSetTemplate : BinaryConvertibleObject, ITemplateSetting
  {
    private string name = "";
    ...
    public PurchaseConditionSetTemplate(ConditionType conditionType)
    {
      this.conditionType = conditionType;
      this.conditionIds = new XmlStringList();
    }

    public PurchaseConditionSetTemplate(XmlSerializationInfo info)
    {
      ...
      {
        this.conditionType = ConditionType.Purchase;
      }
    }
    ...
    public Hashtable GetProperties()
    {
      ...
      insensitiveHashtable.Add((object) "Number", (object) this.Number);
    ...
    public static explicit operator PurchaseConditionSetTemplate(BinaryObject obj)
    {
      return (PurchaseConditionSetTemplate) BinaryConvertibleObject.Parse(obj, typeof (PurchaseConditionSetTemplate));
    }
  }
}
