...
// Type: EllieMae.EMLite.DataEngine.CurrentConsumerStatusField
...
{
  public class CurrentConsumerStatusField : VirtualField
  {
    internal CurrentConsumerStatusField()
      : base("Log.MS.CurrentConsumerStatus", "Current Consumer Status", FieldFormat.STRING)
    {
    }
    ...
    protected override string Evaluate(LoanData loan)
    {
      ...
      return milestoneLog == null ? "" : milestoneLog.ConsumerStatus;
    }
  }
}
