...
// Type: EllieMae.EMLite.DataEngine.Log.MIServiceRadianLog
...
{
  public class MIServiceRadianLog : LogRecordBase
  {
    public static readonly string XmlType = nameof (MIServiceRadianLog);
    private string name = string.Empty;
    private string result = string.Empty;
    private string details = string.Empty;
    private bool showAlert;

    public MIServiceRadianLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public MIServiceRadianLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(60, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) MIServiceRadianLog.XmlType);
