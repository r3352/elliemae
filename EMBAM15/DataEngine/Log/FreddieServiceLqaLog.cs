...
// Type: EllieMae.EMLite.DataEngine.Log.FreddieServiceLqaLog
...
{
  public class FreddieServiceLqaLog : LogRecordBase
  {
    public static readonly string XmlType = "FreddieServiceLqa";
    private string name = string.Empty;
    private string result = string.Empty;
    private string details = string.Empty;
    private bool showAlert;

    public FreddieServiceLqaLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public FreddieServiceLqaLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(57, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) FreddieServiceLqaLog.XmlType);
