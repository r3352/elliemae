...
// Type: EllieMae.EMLite.DataEngine.Log.ComplianceTestLog
...
{
  public class ComplianceTestLog : LogRecordBase
  {
    public static readonly string XmlType = "ComplianceTest";
    ...
    public ComplianceTestLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public ComplianceTestLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(28, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) ComplianceTestLog.XmlType);
