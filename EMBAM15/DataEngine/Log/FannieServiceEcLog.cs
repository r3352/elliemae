...
// Type: EllieMae.EMLite.DataEngine.Log.FannieServiceEcLog
...
{
  public class FannieServiceEcLog : LogRecordBase
  {
    public static readonly string XmlType = "FannieServiceEc";
    private string name = string.Empty;
    private string result = string.Empty;
    private string details = string.Empty;
    private bool showAlert;

    public FannieServiceEcLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public FannieServiceEcLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(53, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) FannieServiceEcLog.XmlType);
