...
// Type: EllieMae.EMLite.DataEngine.Log.MIServiceArchLog
...
{
  public class MIServiceArchLog : LogRecordBase
  {
    public static readonly string XmlType = nameof (MIServiceArchLog);
    private string name = string.Empty;
    private string result = string.Empty;
    private string details = string.Empty;
    private bool showAlert;

    public MIServiceArchLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public MIServiceArchLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(59, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) MIServiceArchLog.XmlType);
