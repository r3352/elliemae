...
// Type: EllieMae.EMLite.DataEngine.Log.UnderwritingConditionLog
...
{
  public class UnderwritingConditionLog : StandardConditionLog
  {
    public static readonly string XmlType = "Condition";
    ...
    public UnderwritingConditionLog(string addedBy, string pairId)
      : base(addedBy, pairId)
    {
    }
    ...
    public UnderwritingConditionLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        PipelineInfo.Alert alert = new PipelineInfo.Alert(32, this.Title, "expected", this.DateExpected, this.Guid, this.Guid);
        alertList.Add(alert);
      }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) UnderwritingConditionLog.XmlType);
