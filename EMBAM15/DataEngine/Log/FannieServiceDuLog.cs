...
// Type: EllieMae.EMLite.DataEngine.Log.FannieServiceDuLog
...
{
  public class FannieServiceDuLog : LogRecordBase
  {
    public static readonly string XmlType = "FannieServiceDu";
    private string name = string.Empty;
    private string result = string.Empty;
    private string details = string.Empty;
    private bool showAlert;

    public FannieServiceDuLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public FannieServiceDuLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(52, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) FannieServiceDuLog.XmlType);
