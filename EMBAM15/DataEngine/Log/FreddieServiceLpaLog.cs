...
// Type: EllieMae.EMLite.DataEngine.Log.FreddieServiceLpaLog
...
{
  public class FreddieServiceLpaLog : LogRecordBase
  {
    public static readonly string XmlType = "FreddieServiceLpa";
    private string name = string.Empty;
    private string result = string.Empty;
    private string details = string.Empty;
    private bool showAlert;

    public FreddieServiceLpaLog(string name, string result, string details, bool showAlert)
    {
      this.name = name;
      this.result = result;
    ...
    public FreddieServiceLpaLog(LogList log, XmlElement e)
      : base(log, e)
    {
    ...
    public override PipelineInfo.Alert[] GetPipelineAlerts()
    {
      ...
      {
        new PipelineInfo.Alert(56, this.name, this.result, this.Date, this.Guid, this.Guid)
      };
    }
    ...
    public override void ToXml(XmlElement e)
    {
      ...
      attributeWriter.Write("Type", (object) FreddieServiceLpaLog.XmlType);
