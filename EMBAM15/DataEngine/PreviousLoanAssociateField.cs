...
// Type: EllieMae.EMLite.DataEngine.PreviousLoanAssociateField
...
{
  public class PreviousLoanAssociateField : VirtualField
  {
    internal PreviousLoanAssociateField()
      : base("PreviousTeamMember", "Previous Loan Team Member", FieldFormat.STRING)
    {
    }
