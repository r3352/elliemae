...
// Type: EllieMae.EMLite.DataEngine.NextMilestoneNameField
...
{
  public class NextMilestoneNameField : VirtualField
  {
    private FieldOptionCollection options = new FieldOptionCollection();

    internal NextMilestoneNameField()
      : base("Log.MS.StageName", "Next Expected Milestone Name", FieldFormat.STRING)
    {
    }
