...
// Type: EllieMae.EMLite.DataEngine.CurrentLoanAssociateNameField
...
{
  public class CurrentLoanAssociateNameField : VirtualField
  {
    internal CurrentLoanAssociateNameField()
      : base("CurrentTeamMemberName", "Current Loan Team Member Name", FieldFormat.STRING)
    {
    }
