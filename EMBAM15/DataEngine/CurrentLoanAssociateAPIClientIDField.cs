...
// Type: EllieMae.EMLite.DataEngine.CurrentLoanAssociateAPIClientIDField
...
{
  public class CurrentLoanAssociateAPIClientIDField : VirtualField
  {
    internal CurrentLoanAssociateAPIClientIDField()
      : base("CurrentTeamMemberAPIClientID", "Current Loan Team Member API Client ID", FieldFormat.STRING)
    {
    }
