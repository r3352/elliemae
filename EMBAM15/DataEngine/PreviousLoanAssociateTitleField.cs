...
// Type: EllieMae.EMLite.DataEngine.PreviousLoanAssociateTitleField
...
{
  public class PreviousLoanAssociateTitleField : VirtualField
  {
    internal PreviousLoanAssociateTitleField()
      : base("PreviousTeamMemberTitle", "Previous Loan Team Member Title", FieldFormat.STRING)
    {
    }
    ...
    protected override string Evaluate(LoanData loan)
    {
      ...
      return milestoneLog == null ? "" : milestoneLog.LoanAssociateTitle;
    }
  }
}
