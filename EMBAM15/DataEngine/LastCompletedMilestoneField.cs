...
// Type: EllieMae.EMLite.DataEngine.LastCompletedMilestoneField
...
{
  public class LastCompletedMilestoneField : VirtualField
  {
    private FieldOptionCollection options = new FieldOptionCollection();

    internal LastCompletedMilestoneField()
      : base("Log.MS.LastCompleted", "Last Finished Milestone", FieldFormat.STRING)
    {
    }
