...
// Type: JedScripts.EllieMae.EMLite.Script._RD_3555_21_PAGE_5CLASS
...
{
  public class _RD_3555_21_PAGE_5CLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("USDA_X184a", JS.GetStr(loan, "USDA.X184"));
      nameValueCollection.Add("USDA_X196", JS.GetStr(loan, "USDA.X196"));
      nameValueCollection.Add("USDA_X197", JS.GetStr(loan, "USDA.X197"));
      nameValueCollection.Add("1264", JS.GetStr(loan, "1264"));
      nameValueCollection.Add("USDA_X25", JS.GetStr(loan, "USDA.X25"));
