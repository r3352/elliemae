...
// Type: JedScripts.EllieMae.EMLite.Script._DIS___PMI_LPMICLASS
...
{
  public class _DIS___PMI_LPMICLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("12_14", str7);
      string str8 = JS.GetStr(loan, "36") + " " + JS.GetStr(loan, "37");
      nameValueCollection.Add("36_37_a", str8);
      string str9 = JS.GetStr(loan, "68") + " " + JS.GetStr(loan, "69");
      nameValueCollection.Add("68_69_a", str9);
