...
// Type: JedScripts.EllieMae.EMLite.Script._FUNDING_BALANCING_WORKSHEETCLASS
...
{
  public class _FUNDING_BALANCING_WORKSHEETCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      string str2 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "1999"), "", false) != 0 & Operators.CompareString(JS.GetStr(loan, "1999"), "//", false) != 0, JS.GetStr(loan, "1999"), Jed.BF(Operators.CompareString(JS.GetStr(loan, "1997"), "", false) != 0 & Operators.CompareString(JS.GetStr(loan, "1997"), "//", false) != 0, JS.GetStr(loan, "1997"), ""));
      nameValueCollection.Add("1999", str2);
