...
// Type: JedScripts.EllieMae.EMLite.Script._GFE_CA___RE885_P2CLASS
...
{
  public class _GFE_CA___RE885_P2CLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("608_Variable", Jed.BF(Operators.CompareString(JS.GetStr(loan, "608"), "AdjustableRate", false) == 0, "X"));
      nameValueCollection.Add("696_b", JS.GetStr(loan, "696"));
      nameValueCollection.Add("1827_c", JS.GetStr(loan, "1827"));
      nameValueCollection.Add("2625_c", JS.GetStr(loan, "2625"));
      nameValueCollection.Add("5_c", JS.GetStr(loan, "5"));
      nameValueCollection.Add("697_c", JS.GetStr(loan, "697"));
      nameValueCollection.Add("696_c", JS.GetStr(loan, "696"));
      nameValueCollection.Add("1713", JS.GetStr(loan, "1713"));
      nameValueCollection.Add("698", JS.GetStr(loan, "698"));
      nameValueCollection.Add("1712", JS.GetStr(loan, "1712"));
      nameValueCollection.Add("RE88395X325", JS.GetStr(loan, "RE88395.X325"));
      nameValueCollection.Add("698_1109", Jed.NF(Jed.S2N(JS.GetStr(loan, "698")) / 100.0 * Jed.S2N(JS.GetStr(loan, "1109")), (byte) 18, 0));
