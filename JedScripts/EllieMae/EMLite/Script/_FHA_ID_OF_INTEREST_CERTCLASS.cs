...
// Type: JedScripts.EllieMae.EMLite.Script._FHA_ID_OF_INTEREST_CERTCLASS
...
{
  public class _FHA_ID_OF_INTEREST_CERTCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("7575", str5);
      string str6 = JS.GetStr(loan, "319");
      nameValueCollection.Add("7577", str6);
      ...
      nameValueCollection.Add("7578_7580_7587", str7);
      string str8 = JS.GetStr(loan, "36") + " " + JS.GetStr(loan, "37");
      nameValueCollection.Add("100_101_A", str8);
      string str9 = JS.GetStr(loan, "68") + " " + JS.GetStr(loan, "69");
      nameValueCollection.Add("150_151_A", str9);
