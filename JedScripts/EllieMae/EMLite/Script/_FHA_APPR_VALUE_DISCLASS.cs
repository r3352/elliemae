...
// Type: JedScripts.EllieMae.EMLite.Script._FHA_APPR_VALUE_DISCLASS
...
{
  public class _FHA_APPR_VALUE_DISCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("7575", str3);
      string str4 = JS.GetStr(loan, "319");
      nameValueCollection.Add("7577", str4);
      ...
      nameValueCollection.Add("7578_7580_7587", str5);
      ...
      nameValueCollection.Add("1", str8);
      string str9 = Jed.NF(Jed.Num(JS.GetNum(loan, "356")), (byte) 2, 0);
      nameValueCollection.Add("801", str9);
      string str10 = JS.GetStr(loan, "36") + " " + JS.GetStr(loan, "37");
      nameValueCollection.Add("100_101_A", str10);
      string str11 = JS.GetStr(loan, "68") + " " + JS.GetStr(loan, "69");
      nameValueCollection.Add("150_151_A", str11);
