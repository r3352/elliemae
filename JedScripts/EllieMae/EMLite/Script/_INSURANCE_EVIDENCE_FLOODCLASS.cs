...
// Type: JedScripts.EllieMae.EMLite.Script._INSURANCE_EVIDENCE_FLOODCLASS
...
{
  public class _INSURANCE_EVIDENCE_FLOODCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      NameValueCollection nameValueCollection = new NameValueCollection();
      string empty = string.Empty;
      string str1 = JS.GetStr(loan, "1500");
      nameValueCollection.Add("VENDX156", str1);
      string str2 = JS.GetStr(loan, "VEND.X13");
      nameValueCollection.Add("VENDX162", str2);
      string str3 = JS.GetStr(loan, "VEND.X14");
      nameValueCollection.Add("VENDX157", str3);
      string str4 = JS.GetStr(loan, "VEND.X15") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "VEND.X15"), "", false) != 0, ",") + " " + JS.GetStr(loan, "VEND.X16") + " " + JS.GetStr(loan, "VEND.X17");
      nameValueCollection.Add("VENDX158_VENDX159_VENDX160", str4);
      string str5 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "VEND.X19"), "", false) != 0, "(P) ") + JS.GetStr(loan, "VEND.X19") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "VEND.X19"), "", false) != 0, " / ") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "VEND.X20"), "", false) != 0, "(F) ") + JS.GetStr(loan, "VEND.X20");
      nameValueCollection.Add("VENDX718_VENDX1255", str5);
      string str6 = JS.GetStr(loan, "VEND.X21");
      ...
      string str37 = JS.GetStr(loan, "REQUEST.X6");
      ...
      string str51 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "REQUEST.X7"), "Y", false) == 0, "X");
      nameValueCollection.Add("REQUESTX7_Y", str51);
      string str52 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "REQUEST.X7"), "N", false) == 0, "X");
      nameValueCollection.Add("REQUESTX7_N", str52);
      string str53 = JS.GetStr(loan, "REQUEST.X8");
      nameValueCollection.Add("REQUESTX8", str53);
      string str54 = JS.GetStr(loan, "REQUEST.X9");
      nameValueCollection.Add("REQUESTX9", str54);
      string str55 = JS.GetStr(loan, "REQUEST.X10");
      nameValueCollection.Add("REQUESTX10", str55);
