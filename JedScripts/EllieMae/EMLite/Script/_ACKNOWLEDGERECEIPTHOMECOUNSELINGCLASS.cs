...
// Type: JedScripts.EllieMae.EMLite.Script._ACKNOWLEDGERECEIPTHOMECOUNSELINGCLASS
...
{
  public class _ACKNOWLEDGERECEIPTHOMECOUNSELINGCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("315_VEND_X293", str5);
      ...
      string str8 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "1264"), "", false) != 0, JS.GetStr(loan, "1264"), Jed.BF(Operators.CompareString(JS.GetStr(loan, "VEND.X293"), "", false) != 0, JS.GetStr(loan, "VEND.X293"), Jed.BF(Operators.CompareString(JS.GetStr(loan, "315"), "", false) != 0, JS.GetStr(loan, "315"), "")));
      nameValueCollection.Add("315_VEND_X293_a", str8);
      string str9 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "1264"), "", false) != 0, JS.GetStr(loan, "1264"), Jed.BF(Operators.CompareString(JS.GetStr(loan, "VEND.X293"), "", false) != 0, JS.GetStr(loan, "VEND.X293"), Jed.BF(Operators.CompareString(JS.GetStr(loan, "315"), "", false) != 0, JS.GetStr(loan, "315"), "")));
      nameValueCollection.Add("315_VEND_X293_b", str9);
      string str10 = "X";
      nameValueCollection.Add("CFPB", str10);
      ...
      nameValueCollection.Add("68_69_a", str12);
