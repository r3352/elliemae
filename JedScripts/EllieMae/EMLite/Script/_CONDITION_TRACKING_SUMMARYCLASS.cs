...
// Type: JedScripts.EllieMae.EMLite.Script._CONDITION_TRACKING_SUMMARYCLASS
...
{
  public class _CONDITION_TRACKING_SUMMARYCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      string str4 = JS.GetStr(loan, "317");
      nameValueCollection.Add("317", str4);
      string str5 = JS.GetStr(loan, "363");
      nameValueCollection.Add("363", str5);
      string str6 = JS.GetStr(loan, "11");
      nameValueCollection.Add("11_11", str6);
      ...
      string str9 = JS.GetStr(loan, "2574");
      nameValueCollection.Add("2574", str9);
