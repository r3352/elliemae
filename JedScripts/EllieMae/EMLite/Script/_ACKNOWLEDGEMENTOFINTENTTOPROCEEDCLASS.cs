...
// Type: JedScripts.EllieMae.EMLite.Script._ACKNOWLEDGEMENTOFINTENTTOPROCEEDCLASS
...
{
  public class _ACKNOWLEDGEMENTOFINTENTTOPROCEEDCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("BORROWER_a_1", str11);
      string str12 = JS.GetStr(loan, "68") + " " + JS.GetStr(loan, "69");
      nameValueCollection.Add("BORROWER_a_2", str12);
