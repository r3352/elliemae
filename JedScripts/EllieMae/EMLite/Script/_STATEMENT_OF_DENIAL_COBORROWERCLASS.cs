...
// Type: JedScripts.EllieMae.EMLite.Script._STATEMENT_OF_DENIAL_COBORROWERCLASS
...
{
  public class _STATEMENT_OF_DENIAL_COBORROWERCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      string str3 = JS.GetStr(loan, "DENIAL.X87");
      nameValueCollection.Add("102", str3);
      string str4 = JS.GetStr(loan, "DENIAL.X88") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "DENIAL.X89"), "", false) != 0, ", ") + JS.GetStr(loan, "DENIAL.X89") + " " + JS.GetStr(loan, "DENIAL.X90");
