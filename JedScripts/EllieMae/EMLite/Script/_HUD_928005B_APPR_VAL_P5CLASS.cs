...
// Type: JedScripts.EllieMae.EMLite.Script._HUD_928005B_APPR_VAL_P5CLASS
...
{
  public class _HUD_928005B_APPR_VAL_P5CLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      string str30 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "1342"), "", false) == 0, " X");
