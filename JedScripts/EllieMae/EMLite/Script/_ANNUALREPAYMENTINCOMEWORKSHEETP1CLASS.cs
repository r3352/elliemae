...
// Type: JedScripts.EllieMae.EMLite.Script._ANNUALREPAYMENTINCOMEWORKSHEETP1CLASS
...
{
  public class _ANNUALREPAYMENTINCOMEWORKSHEETP1CLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("USDA_X51", JS.GetStr(loan, "USDA.X51"));
      nameValueCollection.Add("USDA_X52", Jed.BF(Operators.CompareString(JS.GetStr(loan, "USDA.X52"), "", false) != 0 | Operators.CompareString(JS.GetStr(loan, "USDA.X54"), "", false) != 0, "Y"));
      ...
      nameValueCollection.Add("USDA_X60", Jed.BF(Operators.CompareString(JS.GetStr(loan, "USDA.X60"), "", false) != 0 | Operators.CompareString(JS.GetStr(loan, "USDA.X62"), "", false) != 0, "Y"));
      ...
      nameValueCollection.Add("USDA_X68", Jed.BF(Operators.CompareString(JS.GetStr(loan, "USDA.X68"), "", false) != 0 | Operators.CompareString(JS.GetStr(loan, "USDA.X70"), "", false) != 0, "Y"));
      ...
      nameValueCollection.Add("USDA_X76", Jed.BF(Operators.CompareString(JS.GetStr(loan, "USDA.X76"), "", false) != 0 | Operators.CompareString(JS.GetStr(loan, "USDA.X78"), "", false) != 0, "Y"));
      ...
      nameValueCollection.Add("USDA_X84", Jed.BF(Operators.CompareString(JS.GetStr(loan, "USDA.X84"), "", false) != 0 | Operators.CompareString(JS.GetStr(loan, "USDA.X86"), "", false) != 0, "Y"));
      ...
      nameValueCollection.Add("USDA_X92", Jed.BF(Operators.CompareString(JS.GetStr(loan, "USDA.X92"), "", false) != 0 | Operators.CompareString(JS.GetStr(loan, "USDA.X94"), "", false) != 0, "Y"));
