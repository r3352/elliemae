...
// Type: JedScripts.EllieMae.EMLite.Script._ACKNOWLEDGMENTOFRECEIPTOFGOODFAITHESTIMATECLASS
...
{
  public class _ACKNOWLEDGMENTOFRECEIPTOFGOODFAITHESTIMATECLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("BORROWER_1", str1);
      string str2 = JS.GetStr(loan, "68") + " " + JS.GetStr(loan, "69");
      nameValueCollection.Add("BORROWER_2", str2);
      ...
      nameValueCollection.Add("315_a", str8);
      string str9 = JS.GetStr(loan, "3140");
      nameValueCollection.Add("3140", str9);
      string str10 = JS.GetStr(loan, "319");
      nameValueCollection.Add("319", str10);
      string str11 = JS.GetStr(loan, "313") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "321"), "", false) != 0, ", ") + JS.GetStr(loan, "321") + " " + JS.GetStr(loan, "323");
      nameValueCollection.Add("313_321_323", str11);
      string str12 = JS.GetStr(loan, "36") + " " + JS.GetStr(loan, "37");
      nameValueCollection.Add("BORROWER_a_1", str12);
      string str13 = JS.GetStr(loan, "68") + " " + JS.GetStr(loan, "69");
      nameValueCollection.Add("BORROWER_a_2", str13);
