...
// Type: JedScripts.EllieMae.EMLite.Script._ECOAAPPNOTICECLASS
...
{
  public class _ECOAAPPNOTICECLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      string str8 = JS.GetStr(loan, "1612");
      nameValueCollection.Add("1612", str8);
