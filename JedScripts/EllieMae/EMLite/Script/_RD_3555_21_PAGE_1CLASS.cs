...
// Type: JedScripts.EllieMae.EMLite.Script._RD_3555_21_PAGE_1CLASS
...
{
  public class _RD_3555_21_PAGE_1CLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      string str100 = JS.GetStr(loan, "1018");
      nameValueCollection.Add("1018", str100);
      string str101 = JS.GetStr(loan, "1144");
      nameValueCollection.Add("1144", str101);
      string str102 = JS.GetStr(loan, "3069");
      nameValueCollection.Add("3069", str102);
      string str103 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "3026"), "Yes", false) == 0 & (Operators.CompareString(JS.GetStr(loan, "3027"), "No", false) == 0 | Operators.CompareString(JS.GetStr(loan, "3027"), "", false) == 0), "X", Jed.BF(Operators.CompareString(JS.GetStr(loan, "3026"), "No", false) == 0 & Operators.CompareString(JS.GetStr(loan, "3027"), "Yes", false) == 0, "X", Jed.BF(Operators.CompareString(JS.GetStr(loan, "3026"), "Yes", false) == 0 & Operators.CompareString(JS.GetStr(loan, "3027"), "Yes", false) == 0, "X", "")));
      nameValueCollection.Add("GSA_Y", str103);
      string str104 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "3026"), "No", false) == 0 & (Operators.CompareString(JS.GetStr(loan, "3027"), "No", false) == 0 | Operators.CompareString(JS.GetStr(loan, "3027"), "", false) == 0), "X", "");
      nameValueCollection.Add("GSA_N", str104);
