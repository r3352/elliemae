...
// Type: JedScripts.EllieMae.EMLite.Script._STATEMENT_OF_DENIAL_P3CLASS
...
{
  public class _STATEMENT_OF_DENIAL_P3CLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      NameValueCollection nameValueCollection = new NameValueCollection();
      string empty = string.Empty;
      string str1 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, JS.GetStr(loan, "DISCLOSURE.X41"));
      nameValueCollection.Add("DISCLOSURE_X41", str1);
      string str2 = Jed.BF((Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0 ? 1 : 0) != 0, JS.GetStr(loan, "DISCLOSURE.X42") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X42"), "", false) != 0, ", ") + JS.GetStr(loan, "DISCLOSURE.X43") + Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X43"), "", false) != 0, ", ") + JS.GetStr(loan, "DISCLOSURE.X44") + " " + JS.GetStr(loan, "DISCLOSURE.X45"));
      nameValueCollection.Add("DISCLOSURE_X42_X43_X44_X45", str2);
      string str3 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, JS.GetStr(loan, "DISCLOSURE.X46"));
      nameValueCollection.Add("DISCLOSURE_X46", str3);
      string str4 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, JS.GetStr(loan, "DISCLOSURE.X49"));
      nameValueCollection.Add("DISCLOSURE_X49", str4);
      string str5 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, JS.GetStr(loan, "DISCLOSURE.X50"));
      nameValueCollection.Add("DISCLOSURE_X50", str5);
      string str6 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, JS.GetStr(loan, "DISCLOSURE.X51"));
      nameValueCollection.Add("DISCLOSURE_X51", str6);
      string str7 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, JS.GetStr(loan, "1414"));
      nameValueCollection.Add("1414", str7);
      string str8 = Jed.BF(Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X175"), "Y", false) == 0 & Operators.CompareString(JS.GetStr(loan, "DISCLOSURE.X629"), "Y", false) == 0, "X");
      nameValueCollection.Add("DISCLOSURE_X175", str8);
