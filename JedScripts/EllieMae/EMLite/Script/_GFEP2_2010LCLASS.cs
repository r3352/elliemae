...
// Type: JedScripts.EllieMae.EMLite.Script._GFEP2_2010LCLASS
...
{
  public class _GFEP2_2010LCLASS
  {
    public NameValueCollection RunScript(LoanData loan)
    {
      ...
      nameValueCollection.Add("NEWHUD_X13", Jed.BF(Operators.CompareString(JS.GetStr(loan, "NEWHUD.X13"), "", false) == 0, "0.00", Jed.NF(Jed.Num(JS.GetNum(loan, "NEWHUD.X13")), (byte) 2, 0)));
      ...
      nameValueCollection.Add("NEWHUD_X16", Jed.BF(Operators.CompareString(JS.GetStr(loan, "NEWHUD.X16"), "", false) == 0, "0.00", Jed.NF(Jed.Num(JS.GetNum(loan, "NEWHUD.X16")), (byte) 2, 0)));
      nameValueCollection.Add("NEWHUD_X17", JS.GetStr(loan, "NEWHUD.X17"));
      nameValueCollection.Add("NEWHUD_X38", JS.GetStr(loan, "NEWHUD.X38"));
      nameValueCollection.Add("NEWHUD_X39", JS.GetStr(loan, "NEWHUD.X39"));
      nameValueCollection.Add("NEWHUD_X40", JS.GetStr(loan, "NEWHUD.X40"));
      ...
      nameValueCollection.Add("NEWHUD_X92", JS.GetStr(loan, "NEWHUD.X92"));
      nameValueCollection.Add("NEWHUD_X93", JS.GetStr(loan, "NEWHUD.X93"));
