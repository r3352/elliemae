...
// Type: EllieMae.EMLite.WebServices.LoanUtils.ePackage
...
namespace EllieMae.EMLite.WebServices.LoanUtils
{
  ...
  public class ePackage : SoapHttpClientProtocol
  {
    ...
    private SendOrPostCallback SendLoanStatusEmailNoEmailOperationCompleted;
    ...
    private SendOrPostCallback GetDisclosureTrackingDetailsforCCLoansOperationCompleted;
    private SendOrPostCallback GetOAPIAccessTokenOperationCompleted;
    private string _ssoToken;
    private string _oapiToken;
    ...
    protected override WebRequest GetWebRequest(Uri uri)
    {
      ...
      if (!string.IsNullOrWhiteSpace(this._oapiToken))
        webRequest.Headers.Add("AccessToken", this._oapiToken);
      return (WebRequest) webRequest;
    }

    public ePackage(string ssoToken = null, string oapiToken = null)
    {
      this._ssoToken = ssoToken;
      this._oapiToken = oapiToken;
      this.Url = "https://loancenter.elliemae.com/ePackageWS/ePackage.asmx";
    }

    public ePackage(string ssoToken = null, string oapiToken = null, string epackageServiceUrl = null)
    {
    ...
    public event SendLoanStatusEmailNoEmailCompletedEventHandler SendLoanStatusEmailNoEmailCompleted;
    ...
    public event GetDisclosureTrackingDetailsforCCLoansCompletedEventHandler GetDisclosureTrackingDetailsforCCLoansCompleted;
    ...
    [SoapDocumentMethod("http://loancenter.elliemae.com/ePackageWS/SendLoanStatusEmailNoEmail", RequestNamespace = "http://loancenter.elliemae.com/ePackageWS/", ResponseNamespace = "http://loancenter.elliemae.com/ePackageWS/", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Wrapped)]
    public void SendLoanStatusEmailNoEmail(string serverLoanGUID, string to)
    {
      this.Invoke(nameof (SendLoanStatusEmailNoEmail), new object[2]
      {
        (object) serverLoanGUID,
        (object) to
      });
    ...
    public IAsyncResult BeginSendLoanStatusEmailNoEmail(
      string serverLoanGUID,
      string to,
      AsyncCallback callback,
      object asyncState)
    {
      return this.BeginInvoke("SendLoanStatusEmailNoEmail", new object[2]
      {
        (object) serverLoanGUID,
        (object) to
      }, callback, asyncState);
    ...
    public void EndSendLoanStatusEmailNoEmail(IAsyncResult asyncResult)
    {
      this.EndInvoke(asyncResult);
    }

    public void SendLoanStatusEmailNoEmailAsync(string serverLoanGUID, string to)
    {
      this.SendLoanStatusEmailNoEmailAsync(serverLoanGUID, to, (object) null);
    }

    public void SendLoanStatusEmailNoEmailAsync(string serverLoanGUID, string to, object userState)
    {
      if (this.SendLoanStatusEmailNoEmailOperationCompleted == null)
        this.SendLoanStatusEmailNoEmailOperationCompleted = new SendOrPostCallback(this.OnSendLoanStatusEmailNoEmailOperationCompleted);
      this.InvokeAsync("SendLoanStatusEmailNoEmail", new object[2]
      {
        (object) serverLoanGUID,
        (object) to
      }, this.SendLoanStatusEmailNoEmailOperationCompleted, userState);
    }

    private void OnSendLoanStatusEmailNoEmailOperationCompleted(object arg)
    {
      if (this.SendLoanStatusEmailNoEmailCompleted == null)
        return;
      InvokeCompletedEventArgs completedEventArgs = (InvokeCompletedEventArgs) arg;
      this.SendLoanStatusEmailNoEmailCompleted((object) this, new AsyncCompletedEventArgs(completedEventArgs.Error, completedEventArgs.Cancelled, completedEventArgs.UserState));
    }
    ...
    [SoapDocumentMethod("http://loancenter.elliemae.com/ePackageWS/GetDisclosureTrackingDetailsforCCLoans", RequestNamespace = "http://loancenter.elliemae.com/ePackageWS/", ResponseNamespace = "http://loancenter.elliemae.com/ePackageWS/", Use = SoapBindingUse.Literal, ParameterStyle = SoapParameterStyle.Wrapped)]
    public string GetDisclosureTrackingDetailsforCCLoans(DisclosureModelInput input)
    {
      return (string) this.Invoke(nameof (GetDisclosureTrackingDetailsforCCLoans), new object[1]
      {
        (object) input
      })[0];
    }

    public IAsyncResult BeginGetDisclosureTrackingDetailsforCCLoans(
      DisclosureModelInput input,
      AsyncCallback callback,
      object asyncState)
    {
      return this.BeginInvoke("GetDisclosureTrackingDetailsforCCLoans", new object[1]
      {
        (object) input
      }, callback, asyncState);
    }

    public string EndGetDisclosureTrackingDetailsforCCLoans(IAsyncResult asyncResult)
    {
      return (string) this.EndInvoke(asyncResult)[0];
    }

    public void GetDisclosureTrackingDetailsforCCLoansAsync(DisclosureModelInput input)
    {
      this.GetDisclosureTrackingDetailsforCCLoansAsync(input, (object) null);
    }

    public void GetDisclosureTrackingDetailsforCCLoansAsync(
      DisclosureModelInput input,
      object userState)
    {
      if (this.GetDisclosureTrackingDetailsforCCLoansOperationCompleted == null)
        this.GetDisclosureTrackingDetailsforCCLoansOperationCompleted = new SendOrPostCallback(this.OnGetDisclosureTrackingDetailsforCCLoansOperationCompleted);
      this.InvokeAsync("GetDisclosureTrackingDetailsforCCLoans", new object[1]
      {
        (object) input
      }, this.GetDisclosureTrackingDetailsforCCLoansOperationCompleted, userState);
    }

    private void OnGetDisclosureTrackingDetailsforCCLoansOperationCompleted(object arg)
    {
      if (this.GetDisclosureTrackingDetailsforCCLoansCompleted == null)
        return;
      InvokeCompletedEventArgs completedEventArgs = (InvokeCompletedEventArgs) arg;
      this.GetDisclosureTrackingDetailsforCCLoansCompleted((object) this, new GetDisclosureTrackingDetailsforCCLoansCompletedEventArgs(completedEventArgs.Results, completedEventArgs.Error, completedEventArgs.Cancelled, completedEventArgs.UserState));
    }
    ...
    public string GetOAPIAccessToken(string sessionId, string scope)
    {
      return (string) this.Invoke(nameof (GetOAPIAccessToken), new object[2]
      {
        (object) sessionId,
        (object) scope
      })[0];
    ...
    public IAsyncResult BeginGetOAPIAccessToken(
      ...
      object asyncState)
    {
      return this.BeginInvoke("GetOAPIAccessToken", new object[2]
      {
        (object) sessionId,
        (object) scope
      }, callback, asyncState);
    ...
    public void GetOAPIAccessTokenAsync(string sessionId, string scope)
    {
      this.GetOAPIAccessTokenAsync(sessionId, scope, (object) null);
    }

    public void GetOAPIAccessTokenAsync(string sessionId, string scope, object userState)
    {
