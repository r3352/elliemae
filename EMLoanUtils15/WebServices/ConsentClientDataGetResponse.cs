...
// Type: EllieMae.EMLite.WebServices.ConsentClientDataGetResponse
...
namespace EllieMae.EMLite.WebServices
{
  ...
  public class ConsentClientDataGetResponse
  {
    ...
    public Security.ConsentClientDataGetResponseConsentClientDataGetResponseBody ConsentClientDataGetResponse1;
    ...
    public ConsentClientDataGetResponse(
      Security.ConsentClientDataGetResponseConsentClientDataGetResponseBody ConsentClientDataGetResponse1)
    {
