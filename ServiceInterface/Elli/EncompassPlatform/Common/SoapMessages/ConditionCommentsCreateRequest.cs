...
// Type: Elli.EncompassPlatform.Common.SoapMessages.ConditionCommentsCreateRequest
...
namespace Elli.EncompassPlatform.Common.SoapMessages
{
  ...
  public class ConditionCommentsCreateRequest : Request
  {
    [MessageHeader(Namespace = "http://www.elliemae.com/encompass/platform")]
    public SecurityContextContract SecurityContext { get; set; }

    [MessageBodyMember(Name = "ConditionCommentsCreateRequest", Namespace = "http://www.elliemae.com/encompass/platform")]
    public ConditionCommentsCreateRequest.ConditionCommentsCreateRequestBody Payload { get; set; }

    [DataContract(Namespace = "http://www.elliemae.com/encompass/platform")]
    public class ConditionCommentsCreateRequestBody
    {
