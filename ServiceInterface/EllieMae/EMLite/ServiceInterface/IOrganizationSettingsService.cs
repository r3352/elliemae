...
// Type: EllieMae.EMLite.ServiceInterface.IOrganizationSettingsService
...
namespace EllieMae.EMLite.ServiceInterface
{
  ...
  {
    OrgInfo GetOrganizationInfo(int orgId);

    OrgInfo GetFirstAvailableOrganization(int orgId, bool getInstalledInfoIfNotFound);
