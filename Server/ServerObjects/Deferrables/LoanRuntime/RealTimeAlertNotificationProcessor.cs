...
// Type: EllieMae.EMLite.Server.ServerObjects.Deferrables.LoanRuntime.RealTimeAlertNotificationProcessor
...
{
  internal sealed class RealTimeAlertNotificationProcessor(DeferrableLoanTransaction transaction) : 
