...
// Type: EllieMae.EMLite.Server.ServerObjects.Deferrables.LoanRuntime.RealTimePreProcessor
...
{
  internal sealed class RealTimePreProcessor(DeferrableLoanTransaction transaction) : 
    ProcessorBase(transaction),
    IPreProcessor,
    IDeferrableProcessor
  {
    private const string className = "RealTimePreProcessor�";
