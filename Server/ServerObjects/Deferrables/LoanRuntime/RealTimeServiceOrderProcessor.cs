...
// Type: EllieMae.EMLite.Server.ServerObjects.Deferrables.LoanRuntime.RealTimeServiceOrderProcessor
...
{
  internal sealed class RealTimeServiceOrderProcessor(DeferrableLoanTransaction transaction) : 
