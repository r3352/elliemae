...
// Type: EllieMae.EMLite.Server.ServerObjects.Deferrables.LoanRuntime.DeferredReportingDbProcessor
...
{
  internal sealed class DeferredReportingDbProcessor(DeferrableLoanTransaction transaction) : 
