...
// Type: EllieMae.EMLite.Server.ServerObjects.eFolder.BothPostgresFileSystemMasterAttachmentXmlProvider
...
{
  public sealed class BothPostgresFileSystemMasterAttachmentXmlProvider : 
    AttachmentXmlBase,
    IAttachmentXmlProvider,
    IAttachmentProviderBase
  {
    public XmlDocument GetAttachmentXml(Loan loan) => FileAttachmentStore.getAttachmentXml(loan);
