...
// Type: EllieMae.EMLite.Server.LoanServerInfo
...
{
  public class LoanServerInfo : ICloneable
  {
    ...
    public LoanServerInfo(string guid)
    {
      this.loanGUID = guid;
    ...
    public LoanServerInfo(LoanServerInfo source)
    {
    ...
    public object Clone() => (object) new LoanServerInfo(this);
  }
}
