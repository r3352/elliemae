...
// Type: EllieMae.EMLite.Server.Query.TradeFieldTranslator
...
{
  internal class TradeFieldTranslator : ICriterionTranslator
  {
    ...
    public TradeFieldTranslator() => this.loanTranslator = new LoanFieldTranslator();
    ...
    public CriterionName TranslateName(string fieldName)
    {
      ...
      if (criterionName.FieldSource == "")
        criterionName = new CriterionName("Trades", criterionName.FieldName);
