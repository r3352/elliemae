...
// Type: EllieMae.EMLite.Server.Query.MasterContractFieldTranslator
...
{
  internal class MasterContractFieldTranslator : ICriterionTranslator
  {
    ...
    public MasterContractFieldTranslator() => this.loanTranslator = new LoanFieldTranslator();
    ...
    public CriterionName TranslateName(string fieldName)
    {
      ...
      if (criterionName.FieldSource == "")
        criterionName = new CriterionName("MasterContracts", criterionName.FieldName);
