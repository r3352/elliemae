...
// Type: Elli.SQE.IQueryableFieldSourceBuilder
...
namespace Elli.SQE
{
  public interface IQueryableFieldSourceBuilder : IBuilder<QueryableField, QueryableFieldSource>
  {
    new QueryableFieldSource Build(QueryableField field);
  }
}
