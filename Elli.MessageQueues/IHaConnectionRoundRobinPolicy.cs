...
// Type: Elli.MessageQueues.IHaConnectionRoundRobinPolicy
...
{
  public interface IHaConnectionRoundRobinPolicy
  {
    bool UseSingleRoundRobinListPerApplicationDomain { get; set; }
  }
}
