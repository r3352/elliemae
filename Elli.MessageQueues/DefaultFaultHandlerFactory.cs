...
// Type: Elli.MessageQueues.DefaultFaultHandlerFactory
...
namespace Elli.MessageQueues
{
  ...
  public class DefaultFaultHandlerFactory : IServiceFactory<IFaultHandler>
  {
    private DefaultFaultHandler faultHandler;

    public DefaultFaultHandlerFactory() => this.faultHandler = new DefaultFaultHandler();

    public IFaultHandler CreateInstance() => (IFaultHandler) this.faultHandler;
  }
}
