...
// Type: Elli.MessageQueues.Rmq.RouteProvisionerFactory
...
namespace Elli.MessageQueues.Rmq
{
  ...
  public class RouteProvisionerFactory : IServiceFactory<IRouteProvisioner>
  {
    public IRouteProvisioner CreateInstance() => (IRouteProvisioner) new RouteProvisioner();
  }
}
