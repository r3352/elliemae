...
// Type: Elli.MessageQueues.PlainTextPasswordPolicyFactory
...
namespace Elli.MessageQueues
{
  ...
  public class PlainTextPasswordPolicyFactory : IServiceFactory<IPasswordPolicy>
  {
    public IPasswordPolicy CreateInstance() => (IPasswordPolicy) new PlainTextPasswordPolicy();
  }
}
