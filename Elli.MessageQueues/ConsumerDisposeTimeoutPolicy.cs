...
// Type: Elli.MessageQueues.ConsumerDisposeTimeoutPolicy
...
namespace Elli.MessageQueues
{
  ...
  public class ConsumerDisposeTimeoutPolicy : IConsumerDisposeTimeoutPolicy
  {
    public ConsumerDisposeTimeoutPolicy(int timoutInSeconds)
    {
      this.TimeoutInSeconds = timoutInSeconds;
    }
