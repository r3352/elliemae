...
// Type: Elli.MessageQueues.Metrics.SignalFxPolicy
...
namespace Elli.MessageQueues.Metrics
{
  ...
  public class SignalFxPolicy : ISignalFxPolicy
  {
    public SignalFxPolicy(bool enabled) => this.MetricsCollectionEnabled = enabled;

    public bool MetricsCollectionEnabled { get; private set; }
  }
}
