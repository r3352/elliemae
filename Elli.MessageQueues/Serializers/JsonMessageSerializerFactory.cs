...
// Type: Elli.MessageQueues.Serializers.JsonMessageSerializerFactory
...
namespace Elli.MessageQueues.Serializers
{
  ...
  public class JsonMessageSerializerFactory : IServiceFactory<ISerializer>
  {
    public ISerializer CreateInstance() => (ISerializer) new JsonMessageSerializer();
  }
}
