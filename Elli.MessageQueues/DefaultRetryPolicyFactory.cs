...
// Type: Elli.MessageQueues.DefaultRetryPolicyFactory
...
{
  public class DefaultRetryPolicyFactory : IServiceFactory<IRetryPolicy>
  {
    public IRetryPolicy CreateInstance() => (IRetryPolicy) new DefaultRetryPolicy();
  }
}
