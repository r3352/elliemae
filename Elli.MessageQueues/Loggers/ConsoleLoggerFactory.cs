...
// Type: Elli.MessageQueues.Loggers.ConsoleLoggerFactory
...
namespace Elli.MessageQueues.Loggers
{
  ...
  public class ConsoleLoggerFactory : IServiceFactory<ILogger>
  {
    public ILogger CreateInstance() => (ILogger) new ConsoleLogger();
  }
}
