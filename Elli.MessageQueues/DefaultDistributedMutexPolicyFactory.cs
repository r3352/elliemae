...
// Type: Elli.MessageQueues.DefaultDistributedMutexPolicyFactory
...
namespace Elli.MessageQueues
{
  ...
  public class DefaultDistributedMutexPolicyFactory : IServiceFactory<IDistributedMutexPolicy>
  {
    public IDistributedMutexPolicy CreateInstance()
    {
      return (IDistributedMutexPolicy) new DefaultDistributedMutexPolicy();
    }
  }
}
