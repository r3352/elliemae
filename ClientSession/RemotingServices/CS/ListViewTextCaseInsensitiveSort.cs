...
// Type: EllieMae.EMLite.RemotingServices.CS.ListViewTextCaseInsensitiveSort
...
{
  internal class ListViewTextCaseInsensitiveSort : ListViewTextSort
  {
    ...
    protected override int OnCompare(string lhs, string rhs) => string.Compare(lhs, rhs, true);
  }
}
