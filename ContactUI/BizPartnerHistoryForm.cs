...
// Type: EllieMae.EMLite.ContactUI.BizPartnerHistoryForm
...
{
  public class BizPartnerHistoryForm : Form, IBindingForm
  {
    ...
    private GroupContainer gcEventDetail;
    ...
    private void InitializeComponent()
    {
      ...
      this.gcEvents.Controls.Add((Control) this.lvwHistory);
      this.gcEvents.Controls.Add((Control) this.btnDelete);
      this.gcEvents.Dock = DockStyle.Left;
      this.gcEvents.Location = new Point(1, 1);
      this.gcEvents.Name = "gcEvents";
      this.gcEvents.Size = new Size(207, 420);
      this.gcEvents.TabIndex = 10;
      this.gcEvents.Text = "Events";
      ...
      this.collapsibleSplitter1.ControlToHide = (Control) this.gcEvents;
      ...
      this.gcEventDetail.Controls.Add((Control) this.panel1);
      this.gcEventDetail.Dock = DockStyle.Fill;
      this.gcEventDetail.Location = new Point(215, 1);
      this.gcEventDetail.Name = "gcEventDetail";
      this.gcEventDetail.Size = new Size(476, 420);
      this.gcEventDetail.TabIndex = 12;
      this.gcEventDetail.Text = "Event Details";
      ...
      this.panel1.Size = new Size(474, 393);
      ...
      this.txtDetails.Size = new Size(468, 387);
      this.txtDetails.TabIndex = 10;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.BackColor = Color.White;
      this.ClientSize = new Size(692, 422);
      this.Controls.Add((Control) this.gcEventDetail);
      this.Controls.Add((Control) this.collapsibleSplitter1);
      this.Controls.Add((Control) this.gcEvents);
    ...
    public int CurrentContactID
    {
      ...
      set
      {
        ...
        this.clearHistory();
        this.gcEvents.Text = "Events (" + (object) this.lvwHistory.Items.Count + ")";
        if (value < 0)
          return;
        ContactHistoryItem[] historyForContact = Session.ContactManager.GetHistoryForContact(value, ContactType.BizPartner);
    ...
    public object CurrentContact
    {
      ...
      set
      {
        ...
        ContactHistoryItem[] historyForContact = Session.ContactManager.GetHistoryForContact(this.currentContactId, ContactType.BizPartner);
        for (int index = 0; index < historyForContact.Length; ++index)
        {
          string[] items = new string[2];
          DateTime timestamp = historyForContact[index].Timestamp;
    ...
    private void showCallHistory(ContactHistoryItem item)
    {
      ...
      else
      {
        try
        {
          ContactNote contactNote = Session.ContactManager.GetContactNote(item.LoanID, ContactType.BizPartner);
          if (contactNote != null)
            this.txtDetails.Lines = new List<string>()
            {
    ...
    private void btnDelete_Click(object sender, EventArgs e)
    {
      if (this.lvwHistory.SelectedItems.Count > 0)
      {
        if (DialogResult.Cancel == MessageBox.Show("Are you sure you want to delete the selected history?", "Delete History", MessageBoxButtons.OKCancel))
          return;
        Session.ContactManager.DeleteHistoryItemForContact(this.currentContactId, ContactType.BizPartner, ((ContactHistoryItem) this.lvwHistory.SelectedItems[0].Tag).HistoryItemID);
