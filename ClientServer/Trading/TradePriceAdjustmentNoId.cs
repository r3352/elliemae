...
// Type: EllieMae.EMLite.Trading.TradePriceAdjustmentNoId
...
{
  [Serializable]
  public class TradePriceAdjustmentNoId : TradeNoIdEntity, IXmlSerializable
  {
    private FieldFilterList criterionList;
    private Decimal adjustment;

    public TradePriceAdjustmentNoId()
    {
      this.criterionList = new FieldFilterList();
      this.adjustment = 0M;
    }

    public TradePriceAdjustmentNoId(FieldFilterList criterionList, Decimal adjustment)
    {
      this.criterionList = criterionList;
      this.adjustment = adjustment;
    }

    public TradePriceAdjustmentNoId(FieldFilter criterion, Decimal adjustment)
    ...
    public TradePriceAdjustmentNoId(XmlSerializationInfo info)
    {
      this.ReadId(info);
      try
      {
    ...
    public TradePriceAdjustmentNoId(TradePriceAdjustmentNoId source)
    {
