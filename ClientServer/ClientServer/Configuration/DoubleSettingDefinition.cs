...
// Type: EllieMae.EMLite.ClientServer.Configuration.DoubleSettingDefinition
...
{
  public class DoubleSettingDefinition : SettingDefinition
  {
    private double defaultValue;
    private int roundingDecimalPlaces;

    public DoubleSettingDefinition(
      string path,
      string displayName,
      string description,
    ...
    public override object Parse(string value)
    {
      ...
      try
      {
        return (object) Utils.ParseDouble((object) value);
      }
      catch
      {
        return (object) this.defaultValue;
