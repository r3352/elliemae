...
// Type: EllieMae.EMLite.ClientServer.AutomatedCondition
...
{
  [Serializable]
  public class AutomatedCondition : IXmlSerializable
  {
    public readonly string ConditionName;
    public readonly ConditionType ConditionType;

    public AutomatedCondition(ConditionType conditionType, string conditionName)
    {
      this.ConditionType = conditionType;
      this.ConditionName = conditionName;
    }

    public AutomatedCondition(XmlSerializationInfo info)
    {
