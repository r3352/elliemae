...
// Type: EllieMae.EMLite.ClientServer.Trading.MasterCommitmentViewModelBase
...
{
  [Serializable]
  public class MasterCommitmentViewModelBase : IPropertyDictionary
  {
    private Hashtable data;

    public MasterCommitmentViewModelBase() => this.data = new Hashtable();

    public MasterCommitmentViewModelBase(
      int contractId,
    ...
    public MasterCommitmentViewModelBase(Hashtable data) => this.data = data;
