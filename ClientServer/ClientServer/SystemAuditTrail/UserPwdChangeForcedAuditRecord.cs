...
// Type: EllieMae.EMLite.ClientServer.SystemAuditTrail.UserPwdChangeForcedAuditRecord
...
{
  [Serializable]
  public class UserPwdChangeForcedAuditRecord : SystemAuditRecord
  {
    private string userAccountID = "";
    private string userAccountName = "";

    public UserPwdChangeForcedAuditRecord(
      string loginUserID,
