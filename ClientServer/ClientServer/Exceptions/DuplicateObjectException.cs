...
// Type: EllieMae.EMLite.ClientServer.Exceptions.DuplicateObjectException
...
{
  [Serializable]
  public class DuplicateObjectException : ServerException
  {
    private const uint innerHResult = 2147754247;
    private ObjectType type;
    private object objectId;

    public DuplicateObjectException(string message, ObjectType type, object objectId)
      : base(message)
    {
      this.type = type;
      this.objectId = objectId;
      this.HResult = this.HRESULT(2147754247U);
    }
