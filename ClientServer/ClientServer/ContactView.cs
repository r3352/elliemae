...
// Type: EllieMae.EMLite.ClientServer.ContactView
...
{
  [Serializable]
  public class ContactView : BinaryConvertible<ContactView>, ITemplateSetting
  {
    private string name;
    ...
    public ContactView(string name) => this.name = name;

    public ContactView(XmlSerializationInfo info)
    {
    ...
    public static explicit operator ContactView(BinaryObject binaryObject)
    {
      return BinaryConvertible<ContactView>.Parse(binaryObject);
    }
  }
}
