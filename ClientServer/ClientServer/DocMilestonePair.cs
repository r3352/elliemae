...
// Type: EllieMae.EMLite.ClientServer.DocMilestonePair
...
namespace EllieMae.EMLite.ClientServer
{
  ...
  public class DocMilestonePair : MilestoneBase
  {
    ...
    public DocMilestonePair(XmlSerializationInfo info)
      : base(info)
    {
      this.DocGuid = info.GetString(nameof (DocGuid));
      this.AttachedRequired = info.GetBoolean("AttachRequired");
    }
