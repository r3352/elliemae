...
// Type: Elli.Metrics.IMongoUtilityMetricsRecorder
...
{
  public interface IMongoUtilityMetricsRecorder
  {
    IDisposable RecordsMongoUtilityApiTime(string apiName);

    void IncrementLoanLoadCount();

    void IncrementReadPipelineCount();

    void IncrementLoanGetCount();

    void IncrementLoanUpdateCount();
  }
}
