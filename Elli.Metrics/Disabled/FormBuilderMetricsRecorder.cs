...
// Type: Elli.Metrics.Disabled.FormBuilderMetricsRecorder
...
{
  public class FormBuilderMetricsRecorder : IFormBuilderMetricsRecorder, IDisposable
  {
    public void Dispose()
    {
    }

    public IDisposable RecordInputFormServiceTime(string apiName) => (IDisposable) this;
