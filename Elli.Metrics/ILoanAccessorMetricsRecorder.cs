...
// Type: Elli.Metrics.ILoanAccessorMetricsRecorder
...
{
  public interface ILoanAccessorMetricsRecorder
  {
    IDisposable RecordLoanAccessorTime(LoanAccessorOperationType loanOp);

    void IncrementLoanSaveCount();
