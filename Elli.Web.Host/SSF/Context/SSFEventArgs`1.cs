...
// Type: Elli.Web.Host.SSF.Context.SSFEventArgs`1
...
{
  public class SSFEventArgs<T> : SSFEventArgs
  {
    private T _eventFeedback;

    public SSFEventArgs(string objectName, string eventName)
      : base(objectName, eventName)
    {
    }

    public SSFEventArgs(string objectName, string eventName, object eventPayload)
      : base(objectName, eventName, eventPayload)
    {
    }

    public T EventFeedback
    {
      get => this._eventFeedback;
