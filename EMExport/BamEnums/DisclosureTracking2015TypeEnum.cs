...
// Type: EllieMae.EMLite.Export.BamEnums.DisclosureTracking2015TypeEnum
...
#nullable disable
namespace EllieMae.EMLite.Export.BamEnums
{
  public enum DisclosureTracking2015TypeEnum
  {
    None = 0,
    LE = 1,
    CD = 2,
