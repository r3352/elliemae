...
// Type: EllieMae.EMLite.Export.IInvestor
...
{
  public interface IInvestor : IService
  {
    bool ExportData(string[] loanGuids);

    bool ValidateData(string loanGuid);

    void Edit(string loanGuid);
  }
}
