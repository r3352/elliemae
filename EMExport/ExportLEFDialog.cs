...
// Type: EllieMae.EMLite.Export.ExportLEFDialog
...
{
  public class ExportLEFDialog : Form
  {
    ...
    public ExportLEFDialog()
    {
      this.InitializeComponent();
      this.savedPath = Path.GetTempPath() + "LicenseeExamFolderName.txt";
      ...
      this.txtFileName.Text = "LicenseeExam.lef";
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (ExportLEFDialog);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Export LEF";
