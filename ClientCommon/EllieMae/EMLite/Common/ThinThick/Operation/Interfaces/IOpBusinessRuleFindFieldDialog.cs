...
// Type: EllieMae.EMLite.Common.ThinThick.Operation.Interfaces.IOpBusinessRuleFindFieldDialog
...
{
  public interface IOpBusinessRuleFindFieldDialog : IOperation, IDisposable
  {
    OpFieldDialogResponse ShowDialog(
