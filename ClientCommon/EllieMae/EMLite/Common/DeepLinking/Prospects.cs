...
// Type: EllieMae.EMLite.Common.DeepLinking.Prospects
...
{
  public class Prospects : BaseDeepLink
  {
    private PipelineContext _context;

    public Prospects(DeepLinkType applicationName, IDeepLinkContext deepLinkApplicationContext)
    ...
    public override string URL => DeepLinkURLHelper.Prospects;

    public override string KPIDescription
    {
      get => this.DeepLinkApplicationContext.Source + " --> Prospects";
    }
  }
}
