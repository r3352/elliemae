...
// Type: EllieMae.EMLite.Common.UI.ReportFieldDefinitions.TradeAssignedSecurityTradeFieldDefs
...
{
  public class TradeAssignedSecurityTradeFieldDefs : ReportFieldDefs
  {
    private TradeAssignedSecurityTradeFieldDefs(Sessions.Session session)
      : base(session)
    {
      foreach (ReportFieldDef fieldDef in (ReportFieldDefContainer) SecurityTradeReportFieldDefs.GetFieldDefs())
        this.Add(fieldDef);
    }
    ...
    public static TradeAssignedSecurityTradeFieldDefs GetFieldDefs()
    {
      return new TradeAssignedSecurityTradeFieldDefs(Session.DefaultInstance);
    }
  }
}
