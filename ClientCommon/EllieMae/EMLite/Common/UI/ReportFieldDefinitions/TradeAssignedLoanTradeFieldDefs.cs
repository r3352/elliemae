...
// Type: EllieMae.EMLite.Common.UI.ReportFieldDefinitions.TradeAssignedLoanTradeFieldDefs
...
{
  public class TradeAssignedLoanTradeFieldDefs : ReportFieldDefs
  {
    private TradeAssignedLoanTradeFieldDefs(Sessions.Session session)
      : base(session)
    {
      foreach (ReportFieldDef fieldDef in (ReportFieldDefContainer) TradeReportFieldDefs.GetFieldDefs())
        this.Add(fieldDef);
    }
    ...
    public static TradeAssignedLoanTradeFieldDefs GetFieldDefs()
    {
      return new TradeAssignedLoanTradeFieldDefs(Session.DefaultInstance);
    }
  }
}
