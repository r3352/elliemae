...
// Type: EllieMae.EMLite.Common.UI.CompileExceptionDialog
...
{
  public class CompileExceptionDialog : Form
  {
    ...
    public CompileExceptionDialog(CompileException e)
    {
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (CompileExceptionDialog));
      ...
      this.label1.Text = "An error has occurred attempting to compile your advanced code. You must correct the error below in order to save yor changes.";
      ...
      this.label7.Text = "Custom Code Compilation Error!";
      ...
      this.Name = nameof (CompileExceptionDialog);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = "Encompass Compilation Error";
    ...
    private void createRegionCodeDisplay(CompilerError error)
    {
      ...
      {
        string[] strArray = CompileExceptionDialog.splitIntoLines(error.Region.SourceCode);
