...
// Type: EllieMae.EMLite.Common.UI.ContactInfoEditorH
...
{
  public class ContactInfoEditorH : UserControl
  {
    ...
    public event ContactInfoEditorH.EntityNameTextChangeEventHandlerH EntityNameTextChanged;

    public ContactInfoEditorH()
    {
    ...
    private void showRolodex()
    {
      ...
      using (RxBusinessContact rxBusinessContact = new RxBusinessContact(this.rolodexCategory, rxContactInfo.CompanyName, rxContactInfo.LastName, rxContactInfo, CRMRoleType.NotFound, false, ""))
      {
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlEntity.Location = new Point(3, 3);
      this.pnlEntity.Margin = new Padding(3, 3, 3, 0);
      ...
      this.flowLayoutPanel1.Size = new Size(650, (int) sbyte.MaxValue);
      ...
      this.Name = nameof (ContactInfoEditorH);
    ...
    public delegate void EntityNameTextChangeEventHandlerH(object sender, string newName);
  }
}
