...
// Type: RestApiProxy.GatewayApiRestProxy
...
{
  internal class GatewayApiRestProxy : ProxyBase, IRestApiProxy
  {
    private readonly IDirectoryService _directoryService;

    internal GatewayApiRestProxy(string sessionId, string mediaContentType)
