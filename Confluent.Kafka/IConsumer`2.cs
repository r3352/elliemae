...
// Type: Confluent.Kafka.IConsumer`2
...
namespace Confluent.Kafka
{
  ...
  public interface IConsumer<TKey, TValue> : IClient, IDisposable
  {
    ...
    /// <summary>Commit all offsets for the current assignment.</summary>
    /// <exception cref="T:Confluent.Kafka.KafkaException">
    ///     Thrown if the request failed.
    /// </exception>
    /// <exception cref="T:Confluent.Kafka.TopicPartitionOffsetException">
    ...
    /// <summary>Commit an explicit list of offsets.</summary>
    /// <param name="offsets">The topic/partition offsets to commit.</param>
    /// <exception cref="T:Confluent.Kafka.KafkaException">
    ///     Thrown if the request failed.
    /// </exception>
    /// <exception cref="T:Confluent.Kafka.TopicPartitionOffsetException">
