...
// Type: Confluent.Kafka.TopicPartitionOffsetException
...
namespace Confluent.Kafka
{
  ...
  public class TopicPartitionOffsetException : KafkaException
  {
    ...
    public TopicPartitionOffsetException(List<TopicPartitionOffsetError> results)
      : base(new Error(ErrorCode.Local_Partial, "An error occurred retrieving offsets for: [" + string.Join<TopicPartition>(", ", results.Where<TopicPartitionOffsetError>((Func<TopicPartitionOffsetError, bool>) (r => r.Error.IsError)).Select<TopicPartitionOffsetError, TopicPartition>((Func<TopicPartitionOffsetError, TopicPartition>) (r => r.TopicPartition))) + "]."))
    {
