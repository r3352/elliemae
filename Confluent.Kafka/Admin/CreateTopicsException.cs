...
// Type: Confluent.Kafka.Admin.CreateTopicsException
...
namespace Confluent.Kafka.Admin
{
  ...
  public class CreateTopicsException : KafkaException
  {
    ...
    public CreateTopicsException(List<CreateTopicReport> results)
      : base(new Confluent.Kafka.Error(ErrorCode.Local_Partial, "An error occurred creating topics: [" + string.Join(", ", results.Where<CreateTopicReport>((Func<CreateTopicReport, bool>) (r => r.Error.IsError)).Select<CreateTopicReport, string>((Func<CreateTopicReport, string>) (r => r.Topic))) + "]: [" + string.Join<Confluent.Kafka.Error>(", ", results.Where<CreateTopicReport>((Func<CreateTopicReport, bool>) (r => r.Error.IsError)).Select<CreateTopicReport, Confluent.Kafka.Error>((Func<CreateTopicReport, Confluent.Kafka.Error>) (r => r.Error))) + "]."))
    {
