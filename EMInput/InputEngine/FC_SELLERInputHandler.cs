...
// Type: EllieMae.EMLite.InputEngine.FC_SELLERInputHandler
...
{
  public class FC_SELLERInputHandler : InputHandlerBase
  {
      ...
      bool skipButtonFieldLockRules)
    {
      ...
      {
        bool flag = this.GetField("4680") == "Y";
