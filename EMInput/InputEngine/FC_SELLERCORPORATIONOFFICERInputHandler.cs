...
// Type: EllieMae.EMLite.InputEngine.FC_SELLERCORPORATIONOFFICERInputHandler
...
{
  public class FC_SELLERCORPORATIONOFFICERInputHandler : InputHandlerBase
  {
    ...
    public FC_SELLERCORPORATIONOFFICERInputHandler(
    ...
    internal override void CreateControls()
    {
      try
      {
        ...
        this.selectCountryButtons.Add((StandardButton) this.currentForm.FindControl("selectcountry_4893"));
      }
      catch
      {
      }
      ...
      bool skipButtonFieldLockRules)
    {
      ...
      {
        bool flag = this.GetField("4880") == "Y";
