...
// Type: EllieMae.EMLite.InputEngine.WireForm
...
{
  public class WireForm : UserControl, IPaymentMethod
  {
    ...
    public DatePicker textBox1;
    public TextBox textBox5;
    private Label label8;
    private Label label9;

    public WireForm() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.textBox1 = new DatePicker();
      this.textBox5 = new TextBox();
      this.label8 = new Label();
      this.label9 = new Label();
      this.SuspendLayout();
      this.label7.AutoSize = true;
      this.label7.Location = new Point(-1, 115);
      this.label7.Name = "label7";
      this.label7.Size = new Size(61, 13);
      this.label7.TabIndex = 62;
      this.label7.Text = "Wired Date";
      this.label1.AutoSize = true;
      this.label1.Location = new Point(140, 69);
      this.label1.Name = "label1";
      this.label1.Size = new Size(13, 13);
      this.label1.TabIndex = 61;
      this.label1.Text = "$";
      this.textBox6.Location = new Point(156, 88);
      this.textBox6.Name = "textBox6";
      this.textBox6.Size = new Size(112, 20);
      this.textBox6.TabIndex = 4;
      this.textBox6.Tag = (object) "Reference";
      this.textBoxAmount.Location = new Point(156, 66);
      this.textBoxAmount.Name = "textBoxAmount";
      this.textBoxAmount.Size = new Size(112, 20);
      this.textBoxAmount.TabIndex = 3;
      this.textBoxAmount.Tag = (object) "WireAmount";
      ...
      this.label6.Location = new Point(-1, 93);
      this.label6.Name = "label6";
      this.label6.Size = new Size(67, 13);
      this.label6.TabIndex = 55;
      this.label6.Text = "Reference #";
      this.label5.AutoSize = true;
      this.label5.Location = new Point(-1, 71);
      this.label5.Name = "label5";
      this.label5.Size = new Size(68, 13);
      this.label5.TabIndex = 54;
      this.label5.Text = "Wire Amount";
      this.label4.AutoSize = true;
      this.label4.Location = new Point(-1, 49);
      ...
      this.textBox1.Location = new Point(156, 110);
      this.textBox1.MaxValue = new DateTime(2100, 1, 1, 0, 0, 0, 0);
      this.textBox1.MinValue = new DateTime(1900, 1, 1, 0, 0, 0, 0);
      this.textBox1.Name = "textBox1";
      this.textBox1.Size = new Size(112, 21);
      this.textBox1.TabIndex = 5;
      this.textBox1.Tag = (object) "WireDate";
      this.textBox1.Value = new DateTime(0L);
      this.textBox5.Location = new Point(156, 133);
      this.textBox5.Name = "textBox5";
      this.textBox5.ReadOnly = true;
      this.textBox5.Size = new Size(112, 20);
      this.textBox5.TabIndex = 63;
      this.textBox5.Tag = (object) "BuydownSubsidyAmount";
