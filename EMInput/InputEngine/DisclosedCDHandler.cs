...
// Type: EllieMae.EMLite.InputEngine.DisclosedCDHandler
...
{
  public class DisclosedCDHandler : IHtmlInput
  {
    private IDisclosureTracking2015Log log;
    private LoanReportFieldDefs fieldDef;

    public DisclosedCDHandler(IDisclosureTracking2015Log log, LoanReportFieldDefs fieldDef)
    {
      this.log = log;
