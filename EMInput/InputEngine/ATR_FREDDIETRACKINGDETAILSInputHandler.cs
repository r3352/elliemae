...
// Type: EllieMae.EMLite.InputEngine.ATR_FREDDIETRACKINGDETAILSInputHandler
...
{
  public class ATR_FREDDIETRACKINGDETAILSInputHandler : InputHandlerBase
  {
    private IWin32Window owner;
    private bool dataIsReadOnly;

    public ATR_FREDDIETRACKINGDETAILSInputHandler(
