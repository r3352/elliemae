...
// Type: EllieMae.EMLite.InputEngine.IncomeAllowancesForm
...
{
  public class IncomeAllowancesForm : Form, IOnlineHelpTarget, IHelp
  {
    private const string className = "IncomeAllowenceForm";
    ...
    public IncomeAllowancesForm(IHtmlInput inputData, Sessions.Session session)
    {
    ...
    private void btnOK_Click(object sender, EventArgs e)
    {
      ...
      this.inputData.SetField("QM.X180", this.txtOtherBorTotal.Text.Trim());
      this.inputData.SetField("QM.X189", this.txtOtherCobTotal.Text.Trim());
    ...
    public string GetHelpTargetName() => "IncomeAllowenceForm";
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (IncomeAllowancesForm));
      ...
      this.pboxDownArrow.Location = new Point(173, 227);
      ...
      this.pboxAsterisk.Location = new Point(138, 229);
      ...
      this.btnCancel.Location = new Point(315, 222);
      this.btnCancel.Name = "btnCancel";
      this.btnCancel.Size = new Size(75, 23);
      this.btnCancel.TabIndex = 15;
      this.btnCancel.Text = "&Cancel";
      this.btnCancel.UseVisualStyleBackColor = true;
      this.btnOK.Location = new Point(234, 222);
      ...
      this.groupContainer1.Controls.Add((Control) this.txtOther);
      ...
      this.label1.Text = "Clothing Allowance";
      this.emHelpLink1.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.emHelpLink1.BackColor = Color.Transparent;
      this.emHelpLink1.Cursor = Cursors.Hand;
      this.emHelpLink1.Font = new Font("Arial", 8.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      this.emHelpLink1.HelpTag = "IncomeAllowenceForm";
      this.emHelpLink1.Location = new Point(12, 225);
      ...
      this.Name = "IncomeAllowenceForm";
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Calculate Military Allowances Income";
