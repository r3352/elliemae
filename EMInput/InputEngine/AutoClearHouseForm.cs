...
// Type: EllieMae.EMLite.InputEngine.AutoClearHouseForm
...
{
  public class AutoClearHouseForm : UserControl, IPaymentMethod
  {
    ...
    public DatePicker boxDate;
    public TextBox textBox1;
    private Label label8;
    private Label label9;

    public AutoClearHouseForm() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.textBoxAmount.Tag = (object) "TransactionAmount";
      ...
      this.boxDate.Location = new Point(156, 110);
      ...
      this.boxDate.Size = new Size(112, 21);
      this.boxDate.TabIndex = 5;
      this.boxDate.Tag = (object) "TransactionDate";
      ...
      this.Controls.Add((Control) this.boxDate);
      ...
      this.Name = nameof (AutoClearHouseForm);
