...
// Type: EllieMae.EMLite.InputEngine.FC_SELLER3InputHandler
...
{
  public class FC_SELLER3InputHandler : InputHandlerBase
  {
    ...
    internal override void CreateControls()
    {
      try
      {
        ...
        this.selectCountryButtons.Add((StandardButton) this.currentForm.FindControl("selectcountry_Seller3_Country"));
      ...
      bool skipButtonFieldLockRules)
    {
      ...
      {
        bool flag = this.GetField("Seller3.ForeignAddressIndicator") == "Y";
    ...
    internal override ControlState GetControlState(RuntimeControl ctrl, string id)
    {
      ...
      if (id == "Seller3.Country")
      {
        if (this.loan.GetField("Seller3.ForeignAddressIndicator") != "Y")
