...
// Type: EllieMae.EMLite.InputEngine.DisclosedLEHandler
...
{
  public class DisclosedLEHandler : IHtmlInput
  {
    private IDisclosureTracking2015Log log;
    private LoanReportFieldDefs fieldDef;

    public DisclosedLEHandler(IDisclosureTracking2015Log log, LoanReportFieldDefs fieldDef)
    {
      this.log = log;
