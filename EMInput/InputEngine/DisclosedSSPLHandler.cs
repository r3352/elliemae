...
// Type: EllieMae.EMLite.InputEngine.DisclosedSSPLHandler
...
{
  public class DisclosedSSPLHandler : IHtmlInput
  {
    private IDisclosureTracking2015Log log;
    private LoanReportFieldDefs fieldDef;

    public DisclosedSSPLHandler(IDisclosureTracking2015Log log, LoanReportFieldDefs fieldDef)
    {
      this.log = log;
    ...
    {
      int result = 0;
      int.TryParse(this.log.GetDisclosedField("SSPLcount"), out result);
      return result;
    }
