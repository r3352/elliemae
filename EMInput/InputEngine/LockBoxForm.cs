...
// Type: EllieMae.EMLite.InputEngine.LockBoxForm
...
{
  public class LockBoxForm : UserControl, IPaymentMethod
  {
    ...
    public LockBoxForm() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.label1.Location = new Point(140, 48);
      this.label1.Name = "label1";
      this.label1.Size = new Size(13, 13);
      this.label1.TabIndex = 48;
      this.label1.Text = "$";
      this.textBoxAmount.Location = new Point(156, 44);
      this.textBoxAmount.Name = "textBoxAmount";
      this.textBoxAmount.Size = new Size(112, 20);
      this.textBoxAmount.TabIndex = 2;
      this.textBoxAmount.Tag = (object) "LockBoxAmount";
      ...
      this.textBox6.Tag = (object) "CreditDate";
      this.textBox6.Value = new DateTime(0L);
      this.textBox1.Location = new Point(156, 89);
      ...
      this.label2.Location = new Point(-1, 93);
      this.label2.Name = "label2";
      this.label2.Size = new Size(130, 13);
      this.label2.TabIndex = 51;
      this.label2.Text = "Buydown Subsidy Amount";
      this.label7.AutoSize = true;
      this.label7.Location = new Point(140, 93);
