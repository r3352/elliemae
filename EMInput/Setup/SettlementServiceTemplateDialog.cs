...
// Type: EllieMae.EMLite.Setup.SettlementServiceTemplateDialog
...
{
  public class SettlementServiceTemplateDialog : Form, IOnlineHelpTarget, IHelp
  {
    private SettlementServiceForm serviceForm;
    private SettlementServiceTemplate template;
    ...
    public SettlementServiceTemplateDialog(
      SettlementServiceTemplate template,
      bool isPublic,
      bool readOnly,
      Sessions.Session session)
    {
      ...
      this.serviceForm = new SettlementServiceForm((IHtmlInput) this.template, readOnly, this.session);
    ...
    private void initForm()
    {
      ...
      this.additionalInfo.Text = this.template.AdditionalInfo;
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      this.template.AdditionalInfo = this.additionalInfo.Text.Trim();
      this.template.Description = this.descTxt.Text.Trim();
      this.template.IgnoreBusinessRules = this.chkIgnore.Checked;
      this.template.SetCurrentField("SP.ADDITIONALINFO", this.template.AdditionalInfo);
      if (!this.serviceForm.SetTemplate(this.template))
      {
        int num = (int) Utils.Dialog((IWin32Window) this, "Please add a Settlement Service Provider first.", MessageBoxButtons.OK, MessageBoxIcon.Hand);
      }
      else
        this.DialogResult = DialogResult.OK;
    }

    public string GetHelpTargetName() => "Setup\\Settlement Service Providers";
    ...
    private void InitializeComponent()
    {
      ...
      this.additionalInfo = new TextBox();
      this.SuspendLayout();
      ...
      this.panelExDetail.Location = new Point(3, 191);
      this.panelExDetail.Name = "panelExDetail";
      this.panelExDetail.Size = new Size(847, 371);
      this.panelExDetail.TabIndex = 14;
      this.btnCancel.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
      this.btnCancel.DialogResult = DialogResult.Cancel;
      this.btnCancel.Location = new Point(767, 568);
      ...
      this.btnSave.Location = new Point(686, 568);
      ...
      this.chkIgnore.Location = new Point(215, 572);
      ...
      this.emHelpLink1.HelpTag = "Setup\\Settlement Service Providers";
      this.emHelpLink1.Location = new Point(3, 573);
      ...
      this.additionalInfo.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
      this.additionalInfo.Location = new Point(101, 110);
      this.additionalInfo.Multiline = true;
      this.additionalInfo.Name = "additionalInfo";
      this.additionalInfo.ScrollBars = ScrollBars.Both;
      this.additionalInfo.Size = new Size(749, 66);
      this.additionalInfo.TabIndex = 36;
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.BackColor = Color.WhiteSmoke;
      this.ClientSize = new Size(854, 603);
      this.Controls.Add((Control) this.additionalInfo);
      ...
      this.Name = nameof (SettlementServiceTemplateDialog);
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Settlement Service Provider Details";
