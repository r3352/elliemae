...
// Type: EllieMae.EMLite.DashBoard.UltraGridBase
...
{
  public class UltraGridBase : SnapshotBaseControl
  {
    ...
    private UltraGridProvider ultraGridProvider;
    ...
    private UltraGridBase()
    {
    }

    public UltraGridBase(
      ...
      : base(frmDashboard, snapshotHandle, dashboardReport, dashboardTemplate, dashboardTemplate.ChartType)
    {
      ...
      this.ultraGridProvider = new UltraGridProvider(frmDashboard, snapshotHandle, dashboardReport, dashboardTemplate);
      this.pnlSnapshot.Controls.Add((Control) this.ultraGridProvider);
      this.ultraGridProvider.Dock = DockStyle.Fill;
      this.ultraGridProvider.ChartDataClickedHandler += new UltraControlBase.ChartDataClicked(this.ultraGridProvider_ChartDataClickedHandler);
      this.ultraGridProvider.UpdateZoomInBtnHandler += new UltraControlBase.UpdateZoomInIconButton(((SnapshotBaseControl) this).setZoomInIconButton);
      this.ultraGridProvider.UpdateExcelBtnHandler += new UltraControlBase.UpdateExcelIconButton(((SnapshotBaseControl) this).setExcelIconButton);
      this.ultraGridProvider.UpdatePrintBtnHandler += new UltraControlBase.UpdatePrintIconButton(((SnapshotBaseControl) this).setPrintIconButton);
      if (this.dashboardTemplate.ChartType != DashboardChartType.LoanTable)
      {
        ...
        this.disableDrilldownView();
    }

    private void ultraGridProvider_ChartDataClickedHandler(string filterValue1, string filterValue2)
    {
      if (this.dashboardTemplate.ChartType == DashboardChartType.LoanTable)
      {
    ...
    private void refreshDrilldownView()
    {
      ...
      {
        if (this.ultraGridProvider.NoDataFound())
    ...
    {
      this.cboTimeFrame.DataSource = SelectionOptions.TimeFrameOptions.Clone();
    ...
    {
      this.ultraGridProvider.RefreshData(this.getReportDataCriteria(this.dashboardTemplate, false));
      if (this.dashboardTemplate.ChartType == DashboardChartType.LoanTable)
        return;
    ...
    private void resetDrilldownViewFilters()
    {
      ...
      if (this.ultraGridProvider.Filter1FieldName != "")
      {
        this.lblSubFilter1.Visible = true;
        this.cmbFilter1.Visible = true;
        this.lblSubFilter1.Text = this.ultraGridProvider.Filter1FieldName;
        this.lblSubFilter1.Tag = (object) this.ultraGridProvider.Filter1FieldID;
        if (this.ultraGridProvider.Filter1ValueList != null && this.ultraGridProvider.Filter1ValueList.Length != 0)
        {
          this.cmbFilter1.Items.Add((object) "All");
          this.cmbFilter1.Items.AddRange(this.ultraGridProvider.Filter1ValueList);
          this.cmbFilter1.SelectedIndex = 0;
        }
        else
          flag = true;
      }
      if (this.ultraGridProvider.Filter2FieldName != "" && this.ultraGridProvider.Filter2FieldID.ToLower() != "dashboard.nogroupby")
      {
        this.cmbFilter2.Visible = true;
        this.lblSubFilter2.Visible = true;
        this.lblSubFilter2.Text = this.ultraGridProvider.Filter2FieldName;
        this.lblSubFilter2.Tag = (object) this.ultraGridProvider.Filter2FieldID;
        if (this.ultraGridProvider.Filter2ValueList != null && this.ultraGridProvider.Filter2ValueList.Length != 0)
        {
          this.cmbFilter2.Items.Add((object) "All");
          this.cmbFilter2.Items.AddRange(this.ultraGridProvider.Filter2ValueList);
    ...
    {
      base.Zoom(zoomIn);
      this.ultraGridProvider.Zoom(zoomIn);
    ...
    private TrendChartDataCriteria translateToTrendChart(DashboardDataCriteria drilldownView)
    {
      ...
      criteria.TimePeriodType = this.dashboardTemplate.ChartType != DashboardChartType.TrendChart ? TimeFrameUtility.GetTimePeriodTypeFromTimeFrameType((DashboardTimeFrameType) this.timeFrameId) : (DashboardTimePeriodType) this.timeFrameId;
    ...
    protected override void ExportToExcel() => this.ultraGridProvider.ExportToExcel();

    protected override void PrintSnapshot() => this.ultraGridProvider.PrintSnapshot();

    protected virtual void cboTimeFrame_SelectionChangeCommitted(object sender, EventArgs e)
    {
      if (this.timeFrameId == (int) this.cboTimeFrame.SelectedValue)
        return;
      this.timeFrameId = (int) this.cboTimeFrame.SelectedValue;
      this.ultraGridProvider.SetTimeFrameID = this.timeFrameId;
      this.dashboardReport.ReportParameters[0] = this.timeFrameId.ToString();
    ...
    private void InitializeComponent()
    {
      ...
      this.lblNoDataFound.Location = new Point(0, 68);
      this.lblNoDataFound.Size = new Size(292, 33);
      ...
      this.lblSubFilter1.BackColor = Color.Transparent;
      ...
      this.cmbFilter1.Font = new Font("Arial", 8.25f);
      ...
      this.lblSubFilter2.Font = new Font("Arial", 8.25f);
      ...
      this.cmbFilter2.Font = new Font("Arial", 8.25f);
