...
// Type: EllieMae.EMLite.MainUI.TrialExpiredForm
...
namespace EllieMae.EMLite.MainUI
{
  ...
  {
    private const string className = "TrialExpiredForm";
    ...
    public TrialExpiredForm(LicenseInfo license)
    {
    ...
    {
      ResourceManager resourceManager = new ResourceManager(typeof (TrialExpiredForm));
      ...
      this.SuspendLayout();
      this.lblTrialInfo.Location = new Point(78, 41);
      this.lblTrialInfo.Name = "lblTrialInfo";
      this.lblTrialInfo.Size = new Size(394, 21);
      this.lblTrialInfo.TabIndex = 0;
      this.lblTrialInfo.Text = "Your trial version of Encompass has expired.";
      ...
      this.btnExit.Location = new Point(397, 109);
      this.btnExit.Name = "btnExit";
      this.btnExit.TabIndex = 1;
      this.btnExit.Text = "&Exit";
      this.btnRegister.Location = new Point(261, 109);
      this.btnRegister.Name = "btnRegister";
      this.btnRegister.Size = new Size(128, 23);
      this.btnRegister.TabIndex = 0;
      this.btnRegister.Text = "&Order Now";
      this.btnRegister.Click += new EventHandler(this.btnRegister_Click);
      this.lblButtonInfo.Location = new Point(78, 64);
      this.lblButtonInfo.Name = "lblButtonInfo";
      this.lblButtonInfo.Size = new Size(394, 32);
      ...
      this.label1.Location = new Point(78, 17);
      this.label1.Name = "label1";
      this.label1.Size = new Size(358, 17);
      this.label1.TabIndex = 5;
      this.label1.Text = "Thank you for trying Encompass!";
      this.btnCDKey.Location = new Point(125, 109);
      this.btnCDKey.Name = "btnCDKey";
      this.btnCDKey.Size = new Size(128, 23);
      this.btnCDKey.TabIndex = 7;
      ...
      this.ClientSize = new Size(488, 142);
      ...
      this.Name = nameof (TrialExpiredForm);
    ...
    private void btnRegister_Click(object sender, EventArgs e)
    {
      ...
      {
        Tracing.Log(Tracing.SwOutsideLoan, TraceLevel.Error, nameof (TrialExpiredForm), "Error launching server config: " + (object) ex);
