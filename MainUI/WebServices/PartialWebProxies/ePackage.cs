...
// Type: EllieMae.EMLite.WebServices.PartialWebProxies.ePackage
...
namespace EllieMae.EMLite.WebServices.PartialWebProxies
{
  ...
  public class ePackage : SoapHttpClientProtocol
  {
    ...
    public ePackage() => this.Url = "https://loancenter.elliemae.com/ePackageWS/ePackage.asmx";

    public ePackage(string epackageServiceUrl)
    {
