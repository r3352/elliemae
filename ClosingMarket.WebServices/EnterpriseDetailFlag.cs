...
// Type: ClosingMarket.WebServices.EnterpriseDetailFlag
...
{
  [SoapType("EnterpriseDetailFlag", "http://www.closingmarket.com")]
  public class EnterpriseDetailFlag
  {
    public int EnterpriseAddress;
    public int EnterpriseService;
    public int EnterpriseUsers;
