...
// Type: ClosingMarket.WebServices.EnterpriseServiceInterfaceType
...
{
  [SoapType("EnterpriseServiceInterfaceType", "http://www.closingmarket.com")]
  public enum EnterpriseServiceInterfaceType
  {
    None,
    CompleteClosing,
    Strasburger,
    ...
    PatriotSearch,
    RealEC,
    CompleteClosingService,
    Require_LienReleaseTracking,
    RealtyData_TitleSearch,
  }
}
