...
// Type: ClosingMarket.WebServices.EnterpriseServiceCategory
...
{
  [SoapType("EnterpriseServiceCategory", "http://www.closingmarket.com")]
  public enum EnterpriseServiceCategory
  {
    Undefined,
    Appraisal,
    BusinessCredit,
