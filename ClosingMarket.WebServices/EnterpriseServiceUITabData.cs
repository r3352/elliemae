...
// Type: ClosingMarket.WebServices.EnterpriseServiceUITabData
...
{
  [SoapType("EnterpriseServiceUITabData", "http://www.closingmarket.com")]
  [SoapInclude(typeof (EnterpriseServiceUITabChildData))]
  public class EnterpriseServiceUITabData : SerializableObject
  {
    public int EnterpriseServiceUITabID;
    public int EnterpriseServiceUIDefinitionID;
    public string TabName;
    public string DisplayText;
    public ServiceUITabType TabType;
