...
// Type: ClosingMarket.WebServices.OrderTaskUpdateData
...
{
  [SoapType("OrderTaskUpdateData", "http://www.closingmarket.com")]
  public class OrderTaskUpdateData : SerializableObject
  {
    public int TaskID;
    public OrderTaskAction TaskAction;
