...
// Type: Elli.Identity.TokenValidator
...
namespace Elli.Identity
{
  public class TokenValidator : ITokenValidator
  {
    ...
    public TokenValidator(ITokenProvider tokenProvider)
      : this()
    {
      this._tokenProvider = tokenProvider;
    }

    public TokenValidator() => this._keyFactory = (ITokenKeyFactory) new X509StoreKeyFactory();
