...
{
  /// <summary>Represents Lock-Desk settings service.</summary>
  public class LockDeskSettingsService : ILockDeskSettings
  {
    ...
    /// <summary>Get Retail Branch ONRP Setting</summary>
    ...
    /// <summary>Get Wholesale Branch ONRP Setting</summary>
    ...
    /// <summary>Get Correspondent Branch ONRP Setting</summary>
    ...
    /// <summary>Gets Global Retail setting.</summary>
    /// <returns></returns>
    public BranchGlobalSettings GetGlobalRetailSetting()
    {
      ...
      LockDeskGlobalSettings deskGlobalSettings = new LockDeskGlobalSettings(serverSettings, LoanChannel.BankedRetail);
    ...
    /// <summary>Get Global Wholesale setting.</summary>
    /// <returns></returns>
    public BranchGlobalSettings GetGlobalWholesaleSetting()
    {
      BranchGlobalSettings wholesaleSetting = new BranchGlobalSettings();
      IDictionary serverSettings = ((IServerManager) this.session.GetObject("ServerManager")).GetServerSettings("Policies");
      LockDeskGlobalSettings deskGlobalSettings = new LockDeskGlobalSettings(serverSettings, LoanChannel.BankedWholesale);
    ...
    /// <summary>Gets global correspondent setting.</summary>
    /// <returns></returns>
    public BranchGlobalSettings GetGlobalCorrespondentSetting()
    {
      ...
      IDictionary serverSettings = ((IServerManager) this.session.GetObject("ServerManager")).GetServerSettings("Policies");
      LockDeskGlobalSettings deskGlobalSettings = new LockDeskGlobalSettings(serverSettings, LoanChannel.Correspondent);
    ...
    /// <summary>Sets Correspondent ONRP setting for TPO.</summary>
    /// <param name="tpoId"></param>
    ...
    /// <summary>Gets Broker ONRP setting for TPO.</summary>
    /// <param name="tpoId"></param>
    /// <returns></returns>
    ...
    /// <summary>Gets Correspondent ONRP setting for TPO</summary>
    /// <param name="tpoId"></param>
    /// <returns></returns>
    ...
    /// <summary>Sets Onrp Setting for Broker Channel.</summary>
    /// <param name="tpoId"></param>
    /// <param name="setting"></param>
    public void SetOnrpSettingForBrokerChannel(string tpoId, ONRPTPOBranchSetting setting)
    {
      ...
      if (originatorManagementData.entityType != ExternalOriginatorEntityType.Broker && originatorManagementData.entityType != ExternalOriginatorEntityType.Both)
      ...
      placeHolder.Add((object) "[HEADER]", (object) ("Channel: Brokered, TPO: " + tpoId));
      placeHolder.Add((object) "[BRANCH]", (object) "Broker");
      ...
      ExternalOrgOnrpSettings externalOrgOnrpSettings = this.mngr.GetExternalOrgOnrpSettings(originatorManagementData.oid);
      ExternalOrgOnrpSettings onrpSettingsOld = externalOrgOnrpSettings.Clone();
      wholesaleSdkSetting.MessageHandler = (IONRPRuleHandler) new SDKMessageHandler(placeHolder);
      externalOrgOnrpSettings.Broker = this.SetTPOSettingsFromSDK(setting, wholesaleSdkSetting);
      ONRPUtils.ValidateSettings(externalOrgOnrpSettings.Broker.MessageHandler, externalOrgOnrpSettings.Broker, out bool _);
      this.mngr.UpdateOnrpSettings(externalOrgOnrpSettings, originatorManagementData.oid, onrpSettingsOld);
    }

    /// <summary>Get ONRP Setting for Broker entity.</summary>
    /// <param name="tpoId">TPO Id/Company ID</param>
    /// <remarks>Gets Broker ONRP Setting using TPO ID/Company ID</remarks>
    public ONRPTPOBranchSetting GetOnrpSettingForBrokerChannel(string tpoId)
    {
      ...
      IDictionary serverSettings = ((IServerManager) this.session.GetObject("ServerManager")).GetServerSettings("Policies");
      externalOrgOnrpSettings.Broker.SetRules((IONRPRuleHandler) null, new ONRPBaseRule(), new LockDeskGlobalSettings(serverSettings, LoanChannel.BankedWholesale), externalOrgOnrpSettings.Broker.UseChannelDefault);
    ...
    /// <summary>Sets Onrp Setting for Correspondent Channel</summary>
    /// <param name="tpoId"></param>
    /// <param name="setting"></param>
    public void SetOnrpSettingForCorrespondentChannel(string tpoId, ONRPTPOBranchSetting setting)
    {
      ...
      if (originatorManagementData == null)
        throw new Exception(str + " from SDK no match.");
      if (originatorManagementData.entityType != ExternalOriginatorEntityType.Correspondent && originatorManagementData.entityType != ExternalOriginatorEntityType.Both)
      ...
      Hashtable placeHolder = new Hashtable();
      placeHolder.Add((object) "[HEADER]", (object) ("Channel: Correspondent, TPO: " + tpoId));
      placeHolder.Add((object) "[BRANCH]", (object) "Correspondent");
      ...
      ExternalOrgOnrpSettings externalOrgOnrpSettings = this.mngr.GetExternalOrgOnrpSettings(originatorManagementData.oid);
      ExternalOrgOnrpSettings onrpSettingsOld = externalOrgOnrpSettings.Clone();
      correspondentSdkSetting.MessageHandler = (IONRPRuleHandler) new SDKMessageHandler(placeHolder);
      externalOrgOnrpSettings.Correspondent = this.SetTPOSettingsFromSDK(setting, correspondentSdkSetting);
      ONRPUtils.ValidateSettings(externalOrgOnrpSettings.Correspondent.MessageHandler, externalOrgOnrpSettings.Correspondent, out bool _);
      this.mngr.UpdateOnrpSettings(externalOrgOnrpSettings, originatorManagementData.oid, onrpSettingsOld);
    }

    /// <summary>Get ONRP Setting for Correspondent entity.</summary>
    /// <param name="tpoId">TPO Id/Company ID</param>
    /// <remarks>Gets Correspondent ONRP Setting using TPO ID/Company ID</remarks>
    public ONRPTPOBranchSetting GetOnrpSettingForCorrespontChannel(string tpoId)
    {
      ...
      IDictionary serverSettings = ((IServerManager) this.session.GetObject("ServerManager")).GetServerSettings("Policies");
      externalOrgOnrpSettings.Correspondent.SetRules((IONRPRuleHandler) null, new ONRPBaseRule(), new LockDeskGlobalSettings(serverSettings, LoanChannel.Correspondent), externalOrgOnrpSettings.Correspondent.UseChannelDefault);
    ...
    public void SetOnrpSettingForRetailChannel(int orgId, ONRPRetailBranchSetting setting)
    {
      ...
      if (!this.mngr.IsRetailBranchExist(orgId))
        throw new Exception(str + " from SDK no match. ");
      Hashtable placeHolder = new Hashtable();
      placeHolder.Add((object) "[HEADER]", (object) ("Channel: Retail, Organization: " + (object) orgId));
      placeHolder.Add((object) "[BRANCH]", (object) "Retail");
      ...
      ONRPEntitySettings setting1 = LockDeskSettingsService.OrgInfoToOrgOnrpSettings(organization);
      ...
      branchSdkSetting.MessageHandler = (IONRPRuleHandler) new SDKMessageHandler(placeHolder);
      setting1.UseParentInfo = setting.UseParentInfo;
      ...
      {
        setting1 = this.SetSettingsFromSDK(setting, branchSdkSetting);
        ONRPUtils.ValidateSettings(setting1.MessageHandler, setting1, out bool _);
      }
      organization.ONRPRetailBranchSettings = setting1;
    ...
    public ONRPRetailBranchSetting GetOnrpSettingForRetailChannel(int orgId)
    {
      ...
      orgOnrpSettings.SetRules((IONRPRuleHandler) null, (ONRPBaseRule) new ONRPSettingRules(), new LockDeskGlobalSettings(serverSettings, LoanChannel.BankedRetail), orgOnrpSettings.UseChannelDefault);
    ...
    /// <summary>Get Retail Lock Desk Setting</summary>
    ...
    /// <summary>Get Wholesale Lock Desk Setting</summary>
    ...
    /// <summary>Get Correspondent Lock Desk Setting</summary>
