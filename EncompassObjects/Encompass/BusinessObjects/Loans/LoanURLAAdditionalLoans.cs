...
{
  /// <summary>
  /// Provides access to the set of Additional Loan associated with a loan.
  /// </summary>
  ...
  public class LoanURLAAdditionalLoans : ILoanURLAAdditionalLoans
  {
    ...
    /// <summary>
    /// Gets the number of Additional Loans defined for the current loan.
    /// </summary>
    public int Count => this.loan.LoanData.GetNumberOfAdditionalLoans();

    /// <summary>Adds a new additional loan to the loan.</summary>
    /// <returns>The function returns the index of the newly created additional loan.
    /// This value should be used to access additional-loan-related loan fields
    ...
    /// <summary>Removes an additional loan from the current loan.</summary>
    /// <param name="index">The 1-based index of the additional loan to remove.</param>
