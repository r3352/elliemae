...
// Type: EllieMae.Encompass.Collections.PersonaList
...
namespace EllieMae.Encompass.Collections
{
  ...
  /// objects.
  /// </summary>
  public class PersonaList : ListBase, IPersonaList
  {
    /// <summary>Constructs a new, empty list.</summary>
    public PersonaList()
      : base(typeof (EllieMae.Encompass.BusinessObjects.Users.Persona))
    {
    }
    ...
    public PersonaList(IList source)
      : base(typeof (EllieMae.Encompass.BusinessObjects.Users.Persona), source)
    {
    }
    ...
    /// </summary>
    public EllieMae.Encompass.BusinessObjects.Users.Persona this[int index]
    {
      get => (EllieMae.Encompass.BusinessObjects.Users.Persona) this.List[index];
      set => this.List[index] = (object) value;
    }

    /// <summary>Adds an item to the list.</summary>
    /// <param name="value">The item to be added.</param>
    public void Add(EllieMae.Encompass.BusinessObjects.Users.Persona value)
    {
    ...
    public bool Contains(EllieMae.Encompass.BusinessObjects.Users.Persona value)
    {
    ...
    public int IndexOf(EllieMae.Encompass.BusinessObjects.Users.Persona value)
    {
    ...
    public void Insert(int index, EllieMae.Encompass.BusinessObjects.Users.Persona value)
    {
    ...
    public void Remove(EllieMae.Encompass.BusinessObjects.Users.Persona value)
    {
    ...
    public EllieMae.Encompass.BusinessObjects.Users.Persona[] ToArray()
    {
      EllieMae.Encompass.BusinessObjects.Users.Persona[] array = new EllieMae.Encompass.BusinessObjects.Users.Persona[this.List.Count];
