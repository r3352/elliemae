...
// Type: EllieMae.Encompass.Collections.RoleList
...
namespace EllieMae.Encompass.Collections
{
  ...
  /// objects.
  /// </summary>
  public class RoleList : ListBase, IRoleList
  {
    ...
    public RoleList(IList source)
      : base(typeof (Role), source)
    {
    }
    ...
    {
      get => (Role) this.List[index];
      set => this.List[index] = (object) value;
    }

    /// <summary>Adds an item to the list.</summary>
    /// <param name="value">The item to be added.</param>
    public void Add(Role value) => this.List.Add((object) value);
    ...
    public bool Contains(Role value) => this.List.Contains((object) value);
    ...
    public int IndexOf(Role value) => this.List.IndexOf((object) value);
