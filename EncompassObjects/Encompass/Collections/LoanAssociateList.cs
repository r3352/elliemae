...
// Type: EllieMae.Encompass.Collections.LoanAssociateList
...
namespace EllieMae.Encompass.Collections
{
  ...
  /// objects.
  /// </summary>
  public class LoanAssociateList : ListBase, ILoanAssociateList
  {
    /// <summary>Constructs a new, empty list.</summary>
    public LoanAssociateList()
      : base(typeof (LoanAssociate))
    {
    }
    ...
    public LoanAssociateList(IList source)
      : base(typeof (LoanAssociate), source)
    {
    }
    ...
    /// </summary>
    public LoanAssociate this[int index]
    {
      get => (LoanAssociate) this.List[index];
      set => this.List[index] = (object) value;
    }

    /// <summary>Adds an item to the list.</summary>
    /// <param name="value">The item to be added.</param>
    public void Add(LoanAssociate value) => this.List.Add((object) value);
    ...
    public bool Contains(LoanAssociate value) => this.List.Contains((object) value);
    ...
    public int IndexOf(LoanAssociate value) => this.List.IndexOf((object) value);
    ...
    public void Insert(int index, LoanAssociate value) => this.List.Insert(index, (object) value);

    /// <summary>Removes an item from the list.</summary>
    /// <param name="value">The item to be removed from the list.</param>
    public void Remove(LoanAssociate value) => this.List.Remove((object) value);

    /// <summary>Converts the list to an Array.</summary>
    /// <returns>An array containing the items from the list.</returns>
    public LoanAssociate[] ToArray()
    {
      LoanAssociate[] array = new LoanAssociate[this.List.Count];
