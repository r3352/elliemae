...
// Type: EllieMae.EMLite.Setup.ExportServices
...
{
  public class ExportServices : Form
  {
    private ExportServicesAclManager exportServiceMgr;
    ...
    private List<ExportServiceAclInfo> availableServices = new List<ExportServiceAclInfo>();
    private ExportServiceAclInfo.ExportServicesDefaultSetting previousSettings = ExportServiceAclInfo.ExportServicesDefaultSetting.NotSpecified;
      ...
      int option)
    {
      ...
      this.exportServiceMgr = (ExportServicesAclManager) this.session.ACL.GetAclManager(AclCategory.ExportServices);
      this.availableServices = ExportServiceAclInfo.GetExportServicesList(ServicesMapping.Categories.ToArray(), 229);
    ...
    private void selectAll(bool custom)
    {
      ...
      foreach (ListViewItem listViewItem in this.lsvCategory.Items)
      {
        ...
        if (custom)
        {
          ((ExportServiceAclInfo) listViewItem.Tag).CustomAccess = AclResourceAccess.ReadWrite;
          listViewItem.ImageIndex = 0;
        }
        else
          ((ExportServiceAclInfo) listViewItem.Tag).PersonaAccess = AclResourceAccess.ReadWrite;
      }
      this.dirty = true;
    }
    ...
    private void deselectAll(bool custom)
    {
      ...
      foreach (ListViewItem listViewItem in this.lsvCategory.Items)
      {
        ...
        if (custom)
        {
          ((ExportServiceAclInfo) listViewItem.Tag).CustomAccess = AclResourceAccess.ReadOnly;
          listViewItem.ImageIndex = 0;
        }
        else
          ((ExportServiceAclInfo) listViewItem.Tag).PersonaAccess = AclResourceAccess.ReadOnly;
      }
      this.dirty = true;
    }
    ...
    private void loadCategoryForPersona()
    {
      this.initial = true;
      this.dirty = false;
      ExportServiceAclInfo.ExportServicesDefaultSetting servicesDefaultSetting = this.exportServiceMgr.GetExportServicesDefaultSetting(this.feature, this.personaID);
      this.previousSettings = servicesDefaultSetting;
      ExportServiceAclInfo[] permissions = this.exportServiceMgr.GetPermissions(this.feature, this.personaID, this.availableServices.ToArray());
      this.lsvCategory.Items.Clear();
      foreach (ExportServiceAclInfo exportServiceAclInfo in permissions)
        this.lsvCategory.Items.Add(new ListViewItem(exportServiceAclInfo.ExportGroup)
        {
          Tag = (object) exportServiceAclInfo,
          Checked = exportServiceAclInfo.PersonaAccess == AclResourceAccess.ReadWrite
        });
    ...
    private void loadCategoryForUser()
    {
      this.initial = true;
      this.dirty = false;
      ExportServiceAclInfo.ExportServicesDefaultSetting servicesDefaultSetting = this.exportServiceMgr.GetUserSpecificExportServicesDefaultSetting(this.feature, this.userID, this.personaList);
      ExportServiceAclInfo[] permissions = this.exportServiceMgr.GetPermissions(this.feature, this.userID, this.personaList, this.availableServices.ToArray());
      this.lsvCategory.Items.Clear();
      foreach (ExportServiceAclInfo exportServiceAclInfo in permissions)
      {
        ListViewItem listViewItem = new ListViewItem(exportServiceAclInfo.ExportGroup);
        listViewItem.Tag = (object) exportServiceAclInfo;
        if (exportServiceAclInfo.CustomAccess != AclResourceAccess.None)
        {
          listViewItem.Checked = exportServiceAclInfo.CustomAccess == AclResourceAccess.ReadWrite;
          listViewItem.ImageIndex = 0;
        }
        else
        {
          listViewItem.Checked = exportServiceAclInfo.PersonaAccess == AclResourceAccess.ReadWrite;
      ...
      if (servicesDefaultSetting == ExportServiceAclInfo.ExportServicesDefaultSetting.NotSpecified)
      {
        ...
        servicesDefaultSetting = this.exportServiceMgr.GetExportServicesDefaultSetting(this.feature, this.userID, this.personaList);
      }
      else
    ...
    private void btnOk_Click(object sender, EventArgs e)
    {
      if (this.rdbAll.Checked)
        this.previousSettings = ExportServiceAclInfo.ExportServicesDefaultSetting.All;
      else if (this.rdbCustom.Checked)
        this.previousSettings = ExportServiceAclInfo.ExportServicesDefaultSetting.Custom;
      else if (this.rdbNone.Checked)
        this.previousSettings = ExportServiceAclInfo.ExportServicesDefaultSetting.None;
    ...
    private void btnCancel_Click(object sender, EventArgs e)
    {
      this.initial = true;
      this.lsvCategory.Items.Clear();
      if (this.previousSettings != ExportServiceAclInfo.ExportServicesDefaultSetting.NotSpecified)
      {
    ...
    public void SaveData()
    {
      ...
      foreach (object obj in this.lsvCategory.Items)
        exportServiceAclInfoList.Add((ExportServiceAclInfo) ((ListViewItem) obj).Tag);
      ExportServiceAclInfo.ExportServicesDefaultSetting defaultValue = ExportServiceAclInfo.ExportServicesDefaultSetting.All;
      if (this.rdbCustom.Checked)
        defaultValue = ExportServiceAclInfo.ExportServicesDefaultSetting.Custom;
      else if (this.rdbNone.Checked)
        defaultValue = ExportServiceAclInfo.ExportServicesDefaultSetting.None;
      if (!this.isPersonal)
      {
        this.exportServiceMgr.SetPermissions(this.feature, exportServiceAclInfoList.ToArray(), this.personaID);
        this.exportServiceMgr.SetDefaultValue(this.feature, this.personaID, defaultValue);
      }
      else
      {
        if (this.lblDefaultSetting.ImageIndex == 1)
          defaultValue = ExportServiceAclInfo.ExportServicesDefaultSetting.NotSpecified;
        this.exportServiceMgr.SetPermissions(this.feature, exportServiceAclInfoList.ToArray(), this.userID);
        this.exportServiceMgr.SetDefaultValue(this.feature, this.userID, defaultValue);
      }
      this.dirty = false;
    }
    ...
    private void lsvCategory_ItemChecked(object sender, ItemCheckedEventArgs e)
    {
      if (this.initial || this.readOnly)
        return;
      this.dirty = true;
      ExportServiceAclInfo tag = (ExportServiceAclInfo) e.Item.Tag;
      if (!this.isPersonal)
      {
    ...
    private void miLinkTo_Click(object sender, EventArgs e)
    {
      ...
      if (selectedItem != null && selectedItem.ImageIndex < 1)
      {
        ...
        ExportServiceAclInfo tag = (ExportServiceAclInfo) selectedItem.Tag;
        if (tag != null)
    ...
    private void miDefaultLinkTo_Click(object sender, EventArgs e)
    {
      this.dirty = true;
      this.initial = true;
      switch (this.exportServiceMgr.GetPersonasExportServicesDefaultSetting(this.feature, this.userID, this.personaList))
      {
        case ExportServiceAclInfo.ExportServicesDefaultSetting.None:
          this.rdbNone.Checked = true;
          break;
      ...
      {
        listViewItem.ImageIndex = 1;
        ExportServiceAclInfo tag = (ExportServiceAclInfo) listViewItem.Tag;
        if (tag != null)
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (ExportServices));
      ...
      this.lsvCategory.Size = new Size(241, 227);
      ...
      this.Name = nameof (ExportServices);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = "Pipeline Service Categories";
