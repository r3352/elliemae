...
// Type: EllieMae.EMLite.Setup.TrackingHelp
...
{
  public class TrackingHelp : SetupHelp
  {
    ...
    public TrackingHelp(SetUpContainer setUpContainer)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.labItemTitle.Text = "Tracking Setup";
      this.labItemSummary.Location = new Point(8, 28);
      this.labItemSummary.Name = "labItemSummary";
      this.labItemSummary.Size = new Size(460, 32);
      this.labItemSummary.TabIndex = 1;
      this.labItemSummary.Text = "Use the Tracking Setup options to create custom loan fields and define default tracking information for documents, verifications and milestones.";
      this.labSubitem1Title.Cursor = Cursors.Hand;
      this.labSubitem1Title.Location = new Point(16, 72);
      this.labSubitem1Title.Name = "labSubitem1Title";
      this.labSubitem1Title.Size = new Size(168, 16);
      this.labSubitem1Title.TabIndex = 2;
      this.labSubitem1Title.Text = "Custom Fields";
      this.labSubitem1Title.Click += new EventHandler(this.labelHeader_Click);
      this.labSubitem1Summary.Location = new Point(16, 88);
      ...
      this.labSubitem1Summary.Text = "Create custom loan fields that are unique to the requirements of your business.";
      this.labSubitem2Summary.Location = new Point(16, 160);
      this.labSubitem2Summary.Name = "labSubitem2Summary";
      this.labSubitem2Summary.Size = new Size(176, 48);
      this.labSubitem2Summary.TabIndex = 5;
      this.labSubitem2Summary.Text = "Define documents, milestones, and default tracking information presented in the Log.";
      this.labSubitem2Title.Cursor = Cursors.Hand;
      this.labSubitem2Title.Location = new Point(16, 144);
      this.labSubitem2Title.Name = "labSubitem2Title";
      this.labSubitem2Title.Size = new Size(176, 16);
      this.labSubitem2Title.TabIndex = 4;
      this.labSubitem2Title.Text = "Log Setup";
