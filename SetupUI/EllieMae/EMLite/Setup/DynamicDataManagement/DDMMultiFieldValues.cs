...
// Type: EllieMae.EMLite.Setup.DynamicDataManagement.DDMMultiFieldValues
...
{
  public class DDMMultiFieldValues : FieldValueBase
  {
    private string[] values;

    public DDMMultiFieldValues(string FieldID, DDMCriteria criteria, string[] vals)
