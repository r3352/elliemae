...
// Type: EllieMae.EMLite.Setup.DynamicDataManagement.DDM_STRING_NonNumericFieldValues
...
{
  public class DDM_STRING_NonNumericFieldValues : FieldValueBase
  {
    private string[] values;

    public DDM_STRING_NonNumericFieldValues(string FieldID, DDMCriteria criteria, string[] vals)
