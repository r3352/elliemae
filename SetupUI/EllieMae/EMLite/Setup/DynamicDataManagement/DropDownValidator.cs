...
// Type: EllieMae.EMLite.Setup.DynamicDataManagement.DropDownValidator
...
{
  public class DropDownValidator : IValidator
  {
      ...
      string[] options)
    {
      ...
      try
      {
        Utils.FormatInput(cellData.Data, FieldFormat.DROPDOWN, ref needsUpdate);
      }
      catch (Exception ex)
      {
