...
// Type: EllieMae.EMLite.Setup.DynamicDataManagement.DDM_Phone_NonNumericFieldValues
...
{
  public class DDM_Phone_NonNumericFieldValues : FieldValueBase
  {
    private string[] values;

    public DDM_Phone_NonNumericFieldValues(string FieldID, DDMCriteria criteria, string[] vals)
