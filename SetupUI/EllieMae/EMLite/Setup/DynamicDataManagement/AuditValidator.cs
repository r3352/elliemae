...
// Type: EllieMae.EMLite.Setup.DynamicDataManagement.AuditValidator
...
{
  public class AuditValidator : IValidator
  {
      ...
      string[] options)
    {
      ...
      try
      {
        Utils.FormatInput(cellData.Data, FieldFormat.AUDIT, ref needsUpdate);
      }
      catch (Exception ex)
      {
