...
// Type: EllieMae.EMLite.Setup.ExportToLocalDialog
...
namespace EllieMae.EMLite.Setup
{
  public class ExportToLocalDialog : Form
  {
    ...
    public ExportToLocalDialog(string dialogTitle, string defaultFileName)
    {
      ...
      this.savedPath = Path.GetTempPath() + "ExportSetupDataToLocal" + new FileInfo(defaultFileName).Name.Replace(new FileInfo(defaultFileName).Extension, string.Empty) + ".txt";
