...
// Type: EllieMae.EMLite.Setup.UserGroupLegend
...
{
  public class UserGroupLegend : UserControl
  {
    private IContainer components;
    private Label label3;
    private Label label2;
    private Label label1;
    private PictureBox picBoxThisGroup;
    private PictureBox picBoxThisGroupAndBelow;
    private PictureBox picBoxThisUser;

    public UserGroupLegend() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.picBoxThisGroup = new PictureBox();
      this.picBoxThisGroupAndBelow = new PictureBox();
      this.picBoxThisUser = new PictureBox();
      ((ISupportInitialize) this.picBoxThisGroup).BeginInit();
      ((ISupportInitialize) this.picBoxThisGroupAndBelow).BeginInit();
      ((ISupportInitialize) this.picBoxThisUser).BeginInit();
      this.SuspendLayout();
      this.label3.AutoSize = true;
      this.label3.Location = new Point(29, 47);
      this.label3.Name = "label3";
      this.label3.Size = new Size(169, 13);
      this.label3.TabIndex = 11;
      this.label3.Text = "This user is a member of the group";
      this.label2.AutoSize = true;
      this.label2.Location = new Point(29, 27);
      this.label2.Name = "label2";
      this.label2.Size = new Size(324, 13);
      this.label2.TabIndex = 10;
      this.label2.Text = "All users in this level and the levels below are members of the group";
      this.label1.AutoSize = true;
      this.label1.Location = new Point(29, 7);
      this.label1.Name = "label1";
      this.label1.Size = new Size(224, 13);
      this.label1.TabIndex = 9;
      this.label1.Text = "All users in this level are members of the group";
      this.picBoxThisGroup.Image = (Image) Resources.members_this_group;
      this.picBoxThisGroup.Location = new Point(7, 4);
      this.picBoxThisGroup.Name = "picBoxThisGroup";
      this.picBoxThisGroup.Size = new Size(16, 16);
      this.picBoxThisGroup.TabIndex = 8;
      this.picBoxThisGroup.TabStop = false;
      this.picBoxThisGroupAndBelow.Image = (Image) Resources.members_this_group_and_below;
      this.picBoxThisGroupAndBelow.Location = new Point(7, 24);
      ...
      this.picBoxThisUser.Location = new Point(7, 44);
      ...
      this.Controls.Add((Control) this.picBoxThisGroup);
      this.Controls.Add((Control) this.picBoxThisGroupAndBelow);
      this.Controls.Add((Control) this.picBoxThisUser);
      this.Name = nameof (UserGroupLegend);
      this.Size = new Size(360, 65);
      ((ISupportInitialize) this.picBoxThisGroup).EndInit();
