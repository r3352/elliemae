...
// Type: EllieMae.EMLite.Setup.FileItemProvider
...
namespace EllieMae.EMLite.Setup
{
  public class FileItemProvider
  {
    ...
    public FileItemProvider(ArrayList checkedEntryIds, object entryToSelect)
    {
    ...
    private void setNodeImageIndex(TreeNode node)
    {
