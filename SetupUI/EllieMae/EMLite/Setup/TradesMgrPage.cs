...
// Type: EllieMae.EMLite.Setup.TradesMgrPage
...
{
  public class TradesMgrPage : PersonaTreePageBase
  {
    private IContainer components;

    public TradesMgrPage(Sessions.Session session, int personaId, EventHandler dirtyFlagChanged)
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new TradesSecurityHelper(this.session, personaId);
      this.init();
    }

    public TradesMgrPage(
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new TradesSecurityHelper(this.session, userId, personas);
      this.init();
    }
