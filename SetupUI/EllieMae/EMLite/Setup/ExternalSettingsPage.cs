...
// Type: EllieMae.EMLite.Setup.ExternalSettingsPage
...
{
  public class ExternalSettingsPage : PersonaTreePageBase
  {
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ExternalSettingsSecurityHelper(this.session, personaId);
      this.init();
    }
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ExternalSettingsSecurityHelper(this.session, userId, personas);
      this.userID = userId;
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (ExternalSettingsPage);
