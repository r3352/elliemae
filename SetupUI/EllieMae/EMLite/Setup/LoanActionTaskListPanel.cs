...
// Type: EllieMae.EMLite.Setup.LoanActionTaskListPanel
...
{
  public class LoanActionTaskListPanel : UserControl
  {
    ...
    public LoanActionTaskListPanel(Sessions.Session session, bool isReadOnly)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "MilestoneTaskListPanel";
