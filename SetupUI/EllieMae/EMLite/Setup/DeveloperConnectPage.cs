...
// Type: EllieMae.EMLite.Setup.DeveloperConnectPage
...
{
  public class DeveloperConnectPage : Form, IPersonaSecurityPage
  {
    private IContainer components;
    private DeveloperConnectSettingsPage developerConnectPage;
    private ImageList imgListTv;
    private ContextMenu contextMenu1;
    private MenuItem menuItemLinkWithPersona;
    private MenuItem menuItemDisconnectFromPersona;
    private Panel panelDeveloperConnectPage;
    private Sessions.Session session;

    public event EventHandler DirtyFlagChanged;

    public DeveloperConnectPage(
      ...
      EventHandler dirtyFlagChanged)
    {
      ...
      this.developerConnectPage = new DeveloperConnectSettingsPage(session, personaId, this.DirtyFlagChanged);
      ...
      this.panelDeveloperConnectPage.Controls.Add((Control) this.developerConnectPage);
    }
      ...
      EventHandler dirtyFlagChanged)
    {
      this.InitializeComponent();
      this.DirtyFlagChanged += dirtyFlagChanged;
      this.developerConnectPage = new DeveloperConnectSettingsPage(session, userId, personas, this.DirtyFlagChanged);
      this.developerConnectPage.TopLevel = false;
      this.developerConnectPage.Visible = true;
      this.developerConnectPage.Dock = DockStyle.Fill;
      this.panelDeveloperConnectPage.Controls.Add((Control) this.developerConnectPage);
    ...
    {
      this.developerConnectPage.SetPersona(personaId);
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (DeveloperConnectPage));
      ...
      this.panelDeveloperConnectPage = new Panel();
      this.SuspendLayout();
      ...
      this.panelDeveloperConnectPage.Dock = DockStyle.Fill;
      this.panelDeveloperConnectPage.Location = new Point(0, 0);
      this.panelDeveloperConnectPage.Name = "panelDeveloperConnectPage";
      this.panelDeveloperConnectPage.Size = new Size(574, 410);
      this.panelDeveloperConnectPage.TabIndex = 13;
      this.AutoScaleBaseSize = new Size(8, 19);
      this.ClientSize = new Size(574, 410);
      this.Controls.Add((Control) this.panelDeveloperConnectPage);
      this.FormBorderStyle = FormBorderStyle.None;
      this.Name = nameof (DeveloperConnectPage);
    ...
    public void SaveData() => this.developerConnectPage.Save();

    public void ResetData() => this.developerConnectPage.Reset();

    public bool NeedToSaveData() => this.developerConnectPage.NeedToSaveData();
