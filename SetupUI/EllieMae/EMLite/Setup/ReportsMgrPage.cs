...
// Type: EllieMae.EMLite.Setup.ReportsMgrPage
...
{
  public class ReportsMgrPage : PersonaTreePageBase
  {
    private IContainer components;

    public ReportsMgrPage(Sessions.Session session, int personaId, EventHandler dirtyFlagChanged)
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ReportsSecurityHelper(this.session, personaId);
      this.init();
      this.myInit();
    }

    public ReportsMgrPage(
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ReportsSecurityHelper(this.session, userId, personas);
      this.init();
      this.myInit();
    }
    ...
    {
      this.Title = "Reports";
      this.AfterCheckedEvent += new PersonaTreeNodeAfterChecked(((ReportsSecurityHelper) this.securityHelper).AfterChekcedEventHandler);
    }
