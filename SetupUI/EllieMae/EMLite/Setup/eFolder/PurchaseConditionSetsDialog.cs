...
// Type: EllieMae.EMLite.Setup.eFolder.PurchaseConditionSetsDialog
...
{
  public class PurchaseConditionSetsDialog : UserControl
  {
    private IContainer components;
    private ThinThickBrowser Browser;

    public PurchaseConditionSetsDialog()
    {
      this.InitializeComponent();
      new ThinThickBrowserManager(Session.DefaultInstance, this.Browser, (IWin32Window) this).NavigateToThinClient(PageRegistry.PurchaseConditionSets);
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "PurchaseConditionSets";
