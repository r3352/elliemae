...
// Type: EllieMae.EMLite.Setup.eFolder.PurchaseConditions
...
{
  public class PurchaseConditions : UserControl
  {
    ...
    public PurchaseConditions()
    {
      ...
      new ThinThickBrowserManager(Session.DefaultInstance, this.Browser, (IWin32Window) this).NavigateToThinClient(PageRegistry.PurchaseConditions);
    }
