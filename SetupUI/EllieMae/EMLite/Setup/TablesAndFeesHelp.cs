...
// Type: EllieMae.EMLite.Setup.TablesAndFeesHelp
...
{
  public class TablesAndFeesHelp : SetupHelp
  {
    ...
    public TablesAndFeesHelp(SetUpContainer setUpContainer)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.labSubitem1Summary.Size = new Size(168, 44);
      this.labSubitem1Summary.TabIndex = 3;
      this.labSubitem1Summary.Text = "Create formulas that calculate the government recording and transfer fees for a loan.";
      this.labSubitem2Summary.Location = new Point(16, 144);
      this.labSubitem2Summary.Name = "labSubitem2Summary";
      this.labSubitem2Summary.Size = new Size(168, 44);
      this.labSubitem2Summary.TabIndex = 5;
      this.labSubitem2Summary.Text = "Create escrow and title tables for the companies with which you do business.";
      ...
      this.labSubitem2Title.Text = "Table List";
      ...
      this.Name = nameof (TablesAndFeesHelp);
