...
// Type: EllieMae.EMLite.Setup.AddAdvCode
...
namespace EllieMae.EMLite.Setup
{
  public class AddAdvCode : Form
  {
    ...
    public AddAdvCode(string sourceCode)
    {
    ...
    private bool validateCode(string sourceCode)
    {
      try
      {
        using (RuntimeContext context = RuntimeContext.Create())
          new RuleBuilder().CreateValidatorImpl((CodedBusinessRule) new MilestoneRule("Validator", (RuleCondition) PredefinedCondition.Empty, new AdvancedCodeMilestonePair("1", sourceCode)), context);
        return true;
      }
    ...
    private void AddAdvCode_FormClosing(object sender, FormClosingEventArgs e)
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (AddAdvCode);
      this.ShowIcon = false;
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = "Advanced Coding";
      this.FormClosing += new FormClosingEventHandler(this.AddAdvCode_FormClosing);
