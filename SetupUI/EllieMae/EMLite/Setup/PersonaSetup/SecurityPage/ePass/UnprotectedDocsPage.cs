...
// Type: EllieMae.EMLite.Setup.PersonaSetup.SecurityPage.ePass.UnprotectedDocsPage
...
{
  public class UnprotectedDocsPage : PersonaTreePageBase
  {
    private PipelineConfiguration pipelineConfiguration;
    private AccessToDocumentTabPage accessToTabPage;
    private IContainer components;

    public UnprotectedDocsPage(
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.Title = "Unprotected Documents";
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ePassUnprotectedDocsHelper(this.session, personaId);
      this.init();
      this.myInit();
    }
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ePassUnprotectedDocsHelper(this.session, userId, personas);
      this.init();
      this.myInit();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.ClientSize = new Size(490, 384);
      this.Name = nameof (UnprotectedDocsPage);
