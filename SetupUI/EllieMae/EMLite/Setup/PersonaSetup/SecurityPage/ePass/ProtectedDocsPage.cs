...
// Type: EllieMae.EMLite.Setup.PersonaSetup.SecurityPage.ePass.ProtectedDocsPage
...
{
  public class ProtectedDocsPage : PersonaTreePageBase
  {
    private PipelineConfiguration pipelineConfiguration;
    private AccessToDocumentTabPage accessToTabPage;
    private IContainer components;

    public ProtectedDocsPage(
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.Title = "Protected Documents";
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ePassProtectedDocsHelper(this.session, personaId);
      this.init();
      this.myInit();
    }
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ePassProtectedDocsHelper(this.session, userId, personas);
      this.init();
      this.myInit();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.ClientSize = new Size(536, 429);
      this.Name = nameof (ProtectedDocsPage);
