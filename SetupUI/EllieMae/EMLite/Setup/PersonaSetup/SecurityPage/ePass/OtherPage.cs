...
// Type: EllieMae.EMLite.Setup.PersonaSetup.SecurityPage.ePass.OtherPage
...
{
  public class OtherPage : PersonaTreePageBase
  {
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ePassOtherHelper(this.session, personaId);
      this.init();
      this.myInit();
    }
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new ePassOtherHelper(this.session, userId, personas);
      this.init();
      this.myInit();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.ClientSize = new Size(452, 385);
      this.Name = nameof (OtherPage);
