...
// Type: EllieMae.EMLite.Setup.PersonaSetup.FeatureSecurity.ePass.ePassProtectedDocsHelper
...
{
  public class ePassProtectedDocsHelper : FeatureSecurityHelperBase
  {
    ...
    public ePassProtectedDocsHelper(Sessions.Session session, string userId, Persona[] personas)
      : base(session)
    {
    ...
    public ePassProtectedDocsHelper(Sessions.Session session, int personaId)
      : base(session)
    {
    ...
    public override void BuildNodes(TreeView treeView)
    {
      ...
      this.nodeToFeature.Add((object) this.editDocNode, (object) AclFeature.eFolder_PD_EditDoc);
      this.nodeToFeature.Add((object) this.editDocDetailNode, (object) AclFeature.eFolder_PD_ED_EditDocDetails);
      this.nodeToFeature.Add((object) this.createNewDocNameNode, (object) AclFeature.eFolder_PD_ED_EDD_CreateNewDocName);
      this.nodeToFeature.Add((object) this.addCommentNode, (object) AclFeature.eFolder_PD_ED_AddComment);
      this.nodeToFeature.Add((object) this.deleteCommentNode, (object) AclFeature.eFolder_PD_ED_DeleteComment);
      this.nodeToFeature.Add((object) this.browseAndAttachNode, (object) AclFeature.eFolder_PD_ED_BrowseAndAttach);
      this.nodeToFeature.Add((object) this.scanAndAttachNode, (object) AclFeature.eFolder_PD_ED_ScanAndAttach);
      this.nodeToFeature.Add((object) this.attachEncompassFormsNode, (object) AclFeature.eFolder_PD_ED_AttachEncompassForms);
      this.nodeToFeature.Add((object) this.attachUnassignedFilesNode, (object) AclFeature.eFolder_PD_ED_AttachUnassignedFiles);
      this.nodeToFeature.Add((object) this.moveFileUpDownNode, (object) AclFeature.eFolder_PD_ED_MoveFileUpDown);
      this.nodeToFeature.Add((object) this.editFileNode, (object) AclFeature.eFolder_PD_ED_EditFile);
      this.nodeToFeature.Add((object) this.deletePagePermanentlyNode, (object) AclFeature.eFolder_PD_ED_EF_DeletePagePermanently);
      this.nodeToFeature.Add((object) this.mergeFilesNode, (object) AclFeature.eFolder_PD_ED_MergeFiles);
      this.nodeToFeature.Add((object) this.splitFileUpNode, (object) AclFeature.eFolder_PD_ED_SplitFileUp);
      this.nodeToFeature.Add((object) this.deleteNotesNode, (object) AclFeature.eFolder_PD_ED_AN_DeleteNotes);
      this.nodeToFeature.Add((object) this.addNotesToFileNode, (object) AclFeature.eFolder_PD_ED_AddNotesToFile);
      this.nodeToFeature.Add((object) this.removeFileFromDocNode, (object) AclFeature.eFolder_PD_ED_RemoveFileFromDoc);
      this.nodeToFeature.Add((object) this.markFileAsCurrentVersionNode, (object) AclFeature.eFolder_PD_ED_MarkFileAsCurrentVersion);
      this.nodeToFeature.Add((object) this.markStatusAsReviewedNode, (object) AclFeature.eFolder_PD_ED_MarkStatusASReviewed);
      this.nodeToFeature.Add((object) this.deleteDocsNode, (object) AclFeature.eFolder_PD_DeleteDoc);
      this.featureToNodeTbl = new Hashtable(FeatureSets.Features.Length);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_EditDoc, (object) this.editDocNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_EditDocDetails, (object) this.editDocDetailNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_EDD_CreateNewDocName, (object) this.createNewDocNameNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_AddComment, (object) this.addCommentNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_DeleteComment, (object) this.deleteCommentNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_BrowseAndAttach, (object) this.browseAndAttachNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_ScanAndAttach, (object) this.scanAndAttachNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_AttachEncompassForms, (object) this.attachEncompassFormsNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_AttachUnassignedFiles, (object) this.attachUnassignedFilesNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_MoveFileUpDown, (object) this.moveFileUpDownNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_EditFile, (object) this.editFileNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_EF_DeletePagePermanently, (object) this.deletePagePermanentlyNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_MergeFiles, (object) this.mergeFilesNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_SplitFileUp, (object) this.splitFileUpNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_AN_DeleteNotes, (object) this.deleteNotesNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_AddNotesToFile, (object) this.addNotesToFileNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_RemoveFileFromDoc, (object) this.removeFileFromDocNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_MarkFileAsCurrentVersion, (object) this.markFileAsCurrentVersionNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_DeleteDoc, (object) this.deleteDocsNode);
      this.featureToNodeTbl.Add((object) AclFeature.eFolder_PD_ED_MarkStatusASReviewed, (object) this.markStatusAsReviewedNode);
