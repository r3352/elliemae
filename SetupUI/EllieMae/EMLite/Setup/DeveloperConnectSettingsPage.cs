...
// Type: EllieMae.EMLite.Setup.DeveloperConnectSettingsPage
...
{
  public class DeveloperConnectSettingsPage : PersonaTreePageBase
  {
    private IContainer components;

    public DeveloperConnectSettingsPage(
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.Title = "Developer Connect Settings";
      ...
      this.securityHelper = (IFeatureSecurityHelper) new DeveloperConnectSecurityHelper(this.session, personaId);
      this.bInit = true;
      this.init();
    }
      ...
      : base(session, dirtyFlagChanged)
    {
      ...
      this.securityHelper = (IFeatureSecurityHelper) new DeveloperConnectSecurityHelper(this.session, userId, personas);
      this.bInit = true;
      this.init();
    }
    ...
    {
      if (node.Tag == null || (AclFeature) node.Tag != AclFeature.DeveloperConnectTab_SubscribetoWebhooks)
        return true;
      this.bInit = true;
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (DeveloperConnectSettingsPage);
      this.Text = "DeveloperConnectPage";
