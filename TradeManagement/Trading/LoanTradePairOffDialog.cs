...
// Type: EllieMae.EMLite.Trading.LoanTradePairOffDialog
...
{
  public class LoanTradePairOffDialog : Form
  {
    private LoanTradePairOff pairOff;
    ...
    public LoanTradePairOffDialog(LoanTradePairOff pairOff)
    {
    ...
    public LoanTradePairOff PairOff => this.pairOff;
    ...
    private void loadPairOffData(LoanTradePairOff pairOffInfo, object sender)
    {
    ...
    private LoanTradePairOff constructTempPairOff()
    {
      LoanTradePairOff loanTradePairOff = new LoanTradePairOff()
      {
        Date = this.dtDate.Value,
        TradeAmount = Utils.ParseDecimal((object) this.txtTradeAmount.Text)
      };
      loanTradePairOff.PairOffFeePercentage = !(loanTradePairOff.TradeAmount == 0M) ? Utils.ParseDecimal((object) this.txtPairOffPercentage.Text) : 0M;
      return loanTradePairOff;
    }
    ...
    private void txtGainLoss_TextChanged(object sender, EventArgs e)
    {
      if (this.ignoreEvent)
        return;
      LoanTradePairOff pairOffInfo = this.constructTempPairOff();
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (LoanTradePairOffDialog);
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterParent;
      this.Text = "Loan Trade Pair-Off";
