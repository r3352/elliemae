...
// Type: EllieMae.EMLite.Trading.MSRPricingEditor
...
{
  public class MSRPricingEditor : UserControl
  {
    ...
    public MSRPricingEditor() => this.InitializeComponent();
    ...
    {
      AddMSRItemDialog addMsrItemDialog = new AddMSRItemDialog();
      switch (addMsrItemDialog.ShowDialog((IWin32Window) this))
      {
        case DialogResult.OK:
          this.addPricingItem(addMsrItemDialog.PricingItem);
          this.modified = true;
          break;
    ...
    private void InitializeComponent()
    {
      ...
      gvColumn2.Text = "MSR Value";
      gvColumn2.TextAlignment = ContentAlignment.MiddleRight;
      gvColumn2.Width = 100;
      this.gvPricing.Columns.AddRange(new GVColumn[2]
      {
        gvColumn1,
        gvColumn2
      });
      ...
      this.toolTip1.SetToolTip((Control) this.btnRemove, "Remove MSR Value");
      ...
      this.toolTip1.SetToolTip((Control) this.btnAdd, "Add MSR Value");
      ...
      this.Name = nameof (MSRPricingEditor);
