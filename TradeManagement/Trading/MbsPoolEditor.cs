...
// Type: EllieMae.EMLite.Trading.MbsPoolEditor
...
{
  public class MbsPoolEditor : UserControl, IMenuProvider, ITradeEditor, ITradeEditorBase
  {
    private string className = nameof (MbsPoolEditor);
    ...
    public bool LoanUpdatesRequired
    {
      get
      {
        if (this.readOnly)
          return false;
        return this.loanUpdatesRequired || this.ctlContactInfo.DataModified || this.ctlAdvancedPricing.DataModified || this.ctlAdjustments.DataModified || this.ctlFieldEditor.LoanUpdatableFieldChanged || this.msrPricingEditor1.DataModified;
      }
    ...
    private void commitChanges()
    {
      ...
      {
        this.poolTrade.ContractID = -1;
        this.poolTrade.ContractNumber = "";
      }
      else
      {
        MasterContractSummaryInfo selectedItem = (MasterContractSummaryInfo) this.cboContract.SelectedItem;
        this.poolTrade.ContractID = selectedItem.ContractID;
        this.poolTrade.ContractNumber = selectedItem.ContractNumber;
      }
    ...
    private void saveTradeInfo()
    {
      ...
      List<TradeAssignmentByTradeBase> dealocatedTrades = this.ctlSecurityTradeList.DealocatedTrades;
      if (dealocatedTrades.Count > 0)
      {
        foreach (TradeAssignmentByTradeBase assignmentByTradeBase in dealocatedTrades)
        {
          assigneeTradeId = assignmentByTradeBase.AssigneeTradeID;
          if (assigneeTradeId.HasValue)
          {
            ISecurityTradeManager securityTradeManager = Session.SecurityTradeManager;
            assigneeTradeId = assignmentByTradeBase.AssigneeTradeID;
            int tradeId3 = assigneeTradeId.Value;
            Session.SecurityTradeManager.UpdateTradeAfterAssignLoanTrade(securityTradeManager.GetTrade(tradeId3));
          }
        }
      }
    ...
    private bool commitTradeAssignments(bool forceUpdateOfAllLoans, bool selectedLoans)
    {
      try
      {
        ...
        if (selectedLoans)
        {
          ...
          assignments.loans = ((IEnumerable<MbsPoolLoanAssignment>) assignments.GetAllAssignedPendingLoans()).Where<MbsPoolLoanAssignment>((Func<MbsPoolLoanAssignment, bool>) (t => guids.Contains(t.Guid))).ToDictionary<MbsPoolLoanAssignment, string, MbsPoolLoanAssignment>((Func<MbsPoolLoanAssignment, string>) (t => t.Guid), (Func<MbsPoolLoanAssignment, MbsPoolLoanAssignment>) (t => t));
      ...
      {
        Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Error, "Error applying loan status: " + (object) ex);
    ...
    {
      return this.ctlFieldEditor.ValidateChanges(true) && this.ctlSecurityTradeList.ValidateChanges() && this.ctlBuyUpDownEditor.ValidateBuyUpDown();
    }
    ...
    private void loadFieldEditor(PipelineInfo[] currentInTradeLoans)
    {
      ...
      MbsPoolFieldsEditorBase fieldsEditorBase = this.defaultMortgageType != MbsPoolMortgageType.FannieMae ? (this.defaultMortgageType != MbsPoolMortgageType.FreddieMac ? (this.defaultMortgageType != MbsPoolMortgageType.GinnieMae ? new MbsPoolFieldsEditorBase(currentInTradeLoans) : (MbsPoolFieldsEditorBase) new MBSPoolGinnieMaeFieldsEditor(currentInTradeLoans)) : (MbsPoolFieldsEditorBase) new MbsPoolFreddieMacFieldsEditor(currentInTradeLoans)) : (MbsPoolFieldsEditorBase) new MbsPoolFannieMaeFieldsEditor(currentInTradeLoans, this.defaultMortgageType);
      ...
      if (value)
      {
        ...
        else
        {
          if (this.refreshTimer.Enabled)
            return;
          Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Info, "Starting timer for loan trade");
    ...
    private void BuyUpDown_OnModified(object sender, EventArgs e) => this.refreshPricing();
    ...
    private void loadContractData()
    {
      ...
      if (this.poolTrade.ContractID <= 0)
        return;
      for (int index = 1; index < this.cboContract.Items.Count; ++index)
      {
        ...
        if (contractSummaryInfo.ContractID == this.poolTrade.ContractID)
        {
    ...
    private void refreshConfigurableFieldOptions()
    {
      ...
      ArrayList secondaryFields1 = Session.ConfigurationManager.GetSecondaryFields(SecondaryFieldTypes.MortgageType);
      ...
      ArrayList secondaryFields2 = Session.ConfigurationManager.GetSecondaryFields(SecondaryFieldTypes.AmortizationType);
      ...
      ArrayList secondaryFields3 = Session.ConfigurationManager.GetSecondaryFields(SecondaryFieldTypes.CommitmentTypeOption);
      if (secondaryFields3 != null)
      {
        foreach (string str in secondaryFields3)
          this.cmbCommitmentType.Items.Add((object) str);
      }
      this.cmbTradeDesc.Items.Clear();
      ArrayList secondaryFields4 = Session.ConfigurationManager.GetSecondaryFields(SecondaryFieldTypes.TradeDescriptionOption);
      if (secondaryFields4 != null)
      {
        foreach (string str in secondaryFields4)
    ...
    {
      this.commitChanges();
      this.poolTrade.Pricing.AdvancedPricingInfo = MbsPoolCalculation.CalculateTradeAdvancedPricing(this.poolTrade.Coupon, this.poolTrade.PoolMortgageType != MbsPoolMortgageType.GinnieMae ? this.poolTrade.BaseGuarantyFee : this.poolTrade.GuaranteeFee, this.poolTrade.FixedServicingFeePercent, this.poolTrade.MinServicingFee, this.poolTrade.MaxBU, this.poolTrade.BuyUpDownItems, this.poolTrade.Pricing.AdvancedPricingInfo, this.poolTrade.PoolMortgageType);
      this.LoadPricingData();
    ...
    private void applyInvestor(Investor investor)
    {
      ...
      {
        this.investorTemplateName = investor.Name;
        if (this.dtCommitment.Value != DateTime.MinValue && investor.DeliveryTimeFrame > 0)
    ...
    public string GetTradeStatusDescription(LoanToTradeAssignmentBase assignmentInfo)
    {
      ...
      string name = MbsPoolEditor.tradeStatusNameProvider.GetName((object) poolLoanAssignment.Status);
    ...
    {
      return MbsPoolEditor.tradeStatusNameProvider.GetName((object) (MbsPoolLoanStatus) Utils.ParseInt(value, 1));
    }
    ...
    public bool SaveTrade(bool forceUpdateOfLoans, bool updatedSelectedLoans)
    {
      ...
      try
      {
        ...
        else if (flag2 && Utils.Dialog((IWin32Window) this, "The MBS Pool has been saved successfully." + Environment.NewLine + "Would you like to update the loan files with these recent changes?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
          flag1 = this.commitTradeAssignments(true, updatedSelectedLoans);
        this.loadTradeData();
        return flag1;
      }
      ...
      {
        Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Error, ex.ToString());
    ...
    {
      return this.poolTrade.CalculatePriceIndex(info, true, securityPrice);
    }
    ...
    public List<TradeLoanUpdateError> AssignLoanToTrade(PipelineInfo[] pinfos)
    {
      ...
      foreach (PipelineInfo pinfo in pinfos)
      {
        try
        {
          this.assignments.AssignLoan(pinfo, "", "");
        }
        catch (Exception ex)
        {
    ...
    private void tpPricing_Resize(object sender, EventArgs e)
    {
      ...
      this.ctlAdvancedPricing.Height = Math.Max(num1 / 2, this.ctlBuyUpDownEditor.MinimumSize.Height);
      this.ctlAdjustments.Height = Math.Max(0, num1 - this.ctlAdvancedPricing.Height);
      this.ctlAdjustments.Top = this.ctlAdvancedPricing.Bottom + 5;
      int val2 = Math.Max(0, this.pnlPricing.Width);
      int num2 = Math.Max(0, (val2 - 5) / 2);
      if (this.poolTrade.PoolMortgageType == MbsPoolMortgageType.GinnieMae)
      {
        this.ctlBuyUpDownEditor.Width = 0;
        this.ctlAdvancedPricing.Width = Math.Max(0, val2);
        this.ctlAdjustments.Width = this.ctlAdvancedPricing.Width;
        this.ctlBuyUpDownEditor.Visible = false;
      }
      else
      {
        this.ctlBuyUpDownEditor.Width = Math.Max(num2, this.ctlBuyUpDownEditor.MinimumSize.Width);
        this.ctlAdvancedPricing.Width = Math.Max(0, num2);
        this.ctlAdjustments.Width = this.ctlAdvancedPricing.Width;
    ...
    private void btnExportHistory_Click(object sender, EventArgs e)
    {
      ...
      {
        Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Error, "Error during export: " + (object) ex);
    ...
    private void LoadPricingData()
    {
      ...
      this.ctlAdvancedPricing.GuaranteeFee = this.ctlAdvancedPricing.PoolType != MbsPoolMortgageType.GinnieMae ? this.poolTrade.BaseGuarantyFee : this.poolTrade.GuaranteeFee;
      this.ctlAdvancedPricing.ServiceFee = this.poolTrade.FixedServicingFeePercent;
      this.ctlAdvancedPricing.PricingInfo = this.poolTrade.Pricing.AdvancedPricingInfo;
      this.ctlAdvancedPricing.BuyUpDownItems = this.ctlBuyUpDownEditor.BuyUpDownItems;
      this.ctlAdjustments.Adjustments = this.poolTrade.PriceAdjustments;
      this.ctlBuyUpDownEditor.BuyUpDownItems = this.poolTrade.BuyUpDownItems;
    ...
    {
      if (!this.reloadInvestor)
        return;
      string text = this.txtInvestor.Text;
      ...
      if (this.investorTemplateName != string.Empty)
      {
        ...
        {
          this.txtInvestor.Text = text;
          this.poolTrade.InvestorName = this.txtInvestor.Text;
        }
      }
      this.reloadInvestor = false;
    }
    ...
    private void cboContract_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (this.loading)
        return;
      this.onLoanUpdatableFieldValueChanged(sender, e);
      if (this.cboContract.SelectedIndex <= 0 || Utils.Dialog((IWin32Window) this, "Apply the selected contract's investor data to the current MBS Pool?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
        return;
      this.commitChanges();
    ...
    {
      int val2 = Math.Max(0, this.tpSetup.Width - 5);
      Control control = this.tpSetup.Controls[0].Controls[0];
      switch (control)
      {
        case MBSPoolGinnieMaeFieldsEditor _:
          control.Controls[0].Controls[0].Width = Math.Min(731, val2);
          break;
        case MbsPoolFannieMaeFieldsEditor _:
        case MbsPoolFreddieMacFieldsEditor _:
          control.Controls[0].Controls[0].Width = Math.Min(981, val2);
          break;
      }
    }
    ...
    private void txtInvestor_TextChanged(object sender, KeyEventArgs e)
    {
      this.reloadInvestor = true;
      this.investorTemplateName = this.txtInvestor.Text;
    }
    ...
    private void subscribeEventHandler()
    {
      if (this.poolTrade.status != TradeStatus.Pending || this.subscribed)
        return;
      Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Info, "Subscribe onTradeLoanUpdateNotification for MBS Pool");
    ...
    private void unSubscribeEventHandler()
    {
      if (!this.subscribed)
        return;
      Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Info, "UnSubscribe onTradeLoanUpdateNotification for MBS Pool");
      TradeLoanUpdateNotificationClientListener.TradeLoanUpdateNotificationActivity -= new TradeLoanUpdateNotificationEventHandler(this.onTradeLoanUpdateNotification);
    ...
    {
      Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Info, "In onTradeLoanUpdateNotification for " + this.className);
      ...
      {
        Tracing.Log(MbsPoolEditor.sw, this.className, TraceLevel.Info, string.Format("Do not need to refresh MBS Pool. Current TradeId: {0}, Received TradeId: {1}, CorrelationId: {2}, Date: {3}", (object) this.poolTrade.TradeID, (object) eventArgs.TradeId, (object) eventArgs.CorrelationId, (object) eventArgs.Timestamp.ToString()));
      }
      else
      {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (MbsPoolEditor));
      ...
      this.standardIconButton1.Location = new Point(246, 446);
      ...
      this.btnInvestorTemplate.Location = new Point(253, 280);
      ...
      this.pnlRightBottom.Controls.Add((Control) this.pnlSecurityTrades);
      ...
      this.pnlSecurityTrades.Location = new Point(0, 0);
      this.pnlSecurityTrades.Name = "pnlSecurityTrades";
      this.pnlSecurityTrades.Padding = new Padding(0, 0, 0, 4);
      this.pnlSecurityTrades.Size = new Size(731, 142);
      this.pnlSecurityTrades.TabIndex = 3;
      ...
      this.grpAddress.Location = new Point(0, 142);
      this.grpAddress.Name = "grpAddress";
      this.grpAddress.Size = new Size(731, 183);
      ...
      this.ctlContactInfo.Size = new Size(729, 156);
      ...
      this.panel3.Controls.Add((Control) this.cboContract);
      ...
      this.panel3.Controls.Add((Control) this.label20);
      ...
      this.panel3.Location = new Point(1, 58);
      this.panel3.Name = "panel3";
      this.panel3.Size = new Size(301, 560);
      this.panel3.TabIndex = 25;
      this.lbtnWeightedAvgprice.Location = new Point(129, 491);
      ...
      this.txtServicer.Location = new Point(131, 444);
      ...
      this.label11.Location = new Point(8, 446);
      ...
      this.label3.Size = new Size(89, 14);
      this.label3.TabIndex = 221;
      this.label3.Text = "Commitment Date";
      this.dtCommitment.BackColor = SystemColors.Window;
      this.dtCommitment.Location = new Point(131, 70);
      ...
      this.dtNotification.Location = new Point(131, 560);
      ...
      this.cmbSettlementMonth.Location = new Point(131, 536);
      ...
      this.label23.Location = new Point(8, 538);
      this.label23.Name = "label23";
      this.label23.Size = new Size(89, 14);
      this.label23.TabIndex = 56;
      this.label23.Text = "Settlement Month";
      this.label20.AutoSize = true;
      this.label20.Location = new Point(8, 515);
      ...
      this.dtSettlement.Location = new Point(131, 512);
      ...
      this.label12.Location = new Point(249, 494);
      this.label12.Name = "label12";
      this.label12.Size = new Size(17, 14);
      this.label12.TabIndex = 53;
      this.label12.Text = "%";
      this.label18.AutoSize = true;
      this.label18.Location = new Point(8, 492);
      this.label18.Name = "label18";
      this.label18.Size = new Size(123, 14);
      this.label18.TabIndex = 51;
      this.label18.Text = "Weighted Average Price";
      this.txtWeightedAvgPrice.Location = new Point(146, 489);
      ...
      this.label14.Location = new Point(8, 189);
      this.label14.Name = "label14";
      this.label14.Size = new Size(57, 14);
      this.label14.TabIndex = 49;
      this.label14.Text = "Term (yrs)";
      this.txtTerm.Location = new Point(131, 188);
      ...
      this.cmbAmortizationType.Location = new Point(131, 164);
      ...
      this.label10.Location = new Point(8, 166);
      this.label10.Name = "label10";
      this.label10.Size = new Size(93, 14);
      this.label10.TabIndex = 48;
      this.label10.Text = "Amortization Type";
      this.cmbMortgageType.DropDownStyle = ComboBoxStyle.DropDownList;
      this.cmbMortgageType.FormattingEnabled = true;
      this.cmbMortgageType.Location = new Point(131, 140);
      ...
      this.label22.Location = new Point(8, 142);
      this.label22.Name = "label22";
      this.label22.Size = new Size(78, 14);
      this.label22.TabIndex = 46;
      this.label22.Text = "Mortgage Type";
      this.label21.AutoSize = true;
      this.label21.Location = new Point(8, 97);
      this.label21.Name = "label21";
      this.label21.Size = new Size(36, 14);
      this.label21.TabIndex = 43;
      this.label21.Text = "CUSIP";
      this.txtCUSIP.Location = new Point(131, 94);
      ...
      this.label19.Location = new Point(8, 51);
      this.label19.Name = "label19";
      this.label19.Size = new Size(48, 14);
      this.label19.TabIndex = 41;
      this.label19.Text = "Suffix ID";
      this.txtSuffixID.Location = new Point(131, 48);
      ...
      this.cmbServicingType.Location = new Point(131, 419);
      ...
      this.cmbCommitmentType.Location = new Point(131, 232);
      ...
      this.dtActualDelivery.Location = new Point(131, 371);
      ...
      this.label24.Location = new Point(8, 234);
      ...
      this.dtPurchase.Location = new Point(131, 395);
      ...
      this.dtEarlyDelivery.Location = new Point(131, 324);
      ...
      this.txtInvestor.Location = new Point(131, 279);
      ...
      this.txtInvestor.KeyDown += new KeyEventHandler(this.txtInvestor_TextChanged);
      ...
      this.dtInvestorDelivery.Location = new Point(131, 301);
      ...
      this.label6.Location = new Point(8, 468);
      this.label6.Name = "label6";
      this.label6.Size = new Size(44, 14);
      this.label6.TabIndex = 6;
      this.label6.Text = "Coupon";
      this.txtCoupon.Location = new Point(131, 466);
      ...
      this.label4.Location = new Point(8, 211);
      this.label4.Name = "label4";
      this.label4.Size = new Size(66, 14);
      this.label4.TabIndex = 4;
      this.label4.Text = "Pool Amount";
      this.txtAmount.Location = new Point(131, 210);
      ...
      this.msrPricingEditor1.Location = new Point(192, 197);
      ...
      this.msrPricingEditor1.TabIndex = 15;
      this.ctlBuyUpDownEditor.Location = new Point(462, 4);
      this.ctlBuyUpDownEditor.Name = "ctlBuyUpDownEditor";
      this.ctlBuyUpDownEditor.ReadOnly = false;
      this.ctlBuyUpDownEditor.Size = new Size(482, 476);
      this.ctlBuyUpDownEditor.TabIndex = 14;
      this.ctlAdvancedPricing.BuyUpDownItems = (MbsPoolBuyUpDownItems) null;
      this.ctlAdvancedPricing.Location = new Point(16, 3);
      ...
      this.ctlAdvancedPricing.Size = new Size(439, 222);
      ...
      this.flowLayoutPanel2.Location = new Point(19, 3);
      this.flowLayoutPanel2.Name = "flowLayoutPanel2";
      this.flowLayoutPanel2.Size = new Size(271, 22);
      ...
      this.Name = nameof (MbsPoolEditor);
