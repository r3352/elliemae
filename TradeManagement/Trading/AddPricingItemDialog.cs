...
// Type: EllieMae.EMLite.Trading.AddPricingItemDialog
...
{
  public class AddPricingItemDialog : Form
  {
    ...
    public AddPricingItemDialog()
    {
      ...
      TextBoxFormatter.Attach(this.txtServiceFee, TextBoxContentRule.NonNegativeDecimal, this.decimalFormat);
      if (!Session.SessionObjects.Use10DecimalDigitInLockRequestSecondaryTradeAreas)
        return;
    ...
    public AddPricingItemDialog(bool ServiceFee)
      : this()
    {
      this.txtServiceFee.Visible = this.lblServiceFee.Visible = ServiceFee;
    }
    ...
    private bool AddPricingData()
    {
      ...
      this.pricingItem = !Session.SessionObjects.Use10DecimalDigitInLockRequestSecondaryTradeAreas ? new TradePricingItem(Utils.ParseDecimal((object) this.txtRate.Text), Utils.ParseDecimal((object) this.txtPrice.Text), Utils.ParseDecimal((object) this.txtServiceFee.Text, 0M)) : new TradePricingItem(Utils.ParseDecimal((object) this.txtRate.Text), Utils.ParseDecimal((object) this.txtPrice.Text, false, 10), Utils.ParseDecimal((object) this.txtServiceFee.Text, false, 10));
      return true;
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.btnCancel.Location = new Point(194, 91);
      this.btnCancel.Name = "btnCancel";
      this.btnCancel.Size = new Size(75, 22);
      this.btnCancel.TabIndex = 9;
      this.btnCancel.Text = "&Cancel";
      this.btnCancel.UseVisualStyleBackColor = true;
      this.btnOK.Location = new Point(14, 91);
      ...
      this.label3.Text = "%";
      this.btnAddAnother.Location = new Point(96, 91);
      ...
      this.txtServiceFee.Location = new Point(102, 61);
      this.txtServiceFee.MaxLength = 8;
      this.txtServiceFee.Name = "txtServiceFee";
      this.txtServiceFee.Size = new Size(88, 20);
      this.txtServiceFee.TabIndex = 6;
      this.txtServiceFee.TextAlign = HorizontalAlignment.Right;
      this.lblServiceFee.AutoSize = true;
      this.lblServiceFee.Location = new Point(31, 64);
      this.lblServiceFee.Name = "lblServiceFee";
      this.lblServiceFee.RightToLeft = RightToLeft.Yes;
      this.lblServiceFee.Size = new Size(65, 14);
      this.lblServiceFee.TabIndex = 5;
      ...
      this.ClientSize = new Size(282, 128);
      this.Controls.Add((Control) this.txtServiceFee);
      this.Controls.Add((Control) this.lblServiceFee);
      ...
      this.Name = nameof (AddPricingItemDialog);
      this.ShowIcon = false;
