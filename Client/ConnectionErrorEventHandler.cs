...
// Type: EllieMae.EMLite.Client.ConnectionErrorEventHandler
...
{
  public delegate void ConnectionErrorEventHandler(IConnection sender, ConnectionErrorType errType);
}
