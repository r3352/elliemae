...
// Type: Elli.CalculationEngine.Core.ExpressionParser.TemplateSubstitution
...
{
  [DataContract]
  public class TemplateSubstitution : IExtensibleDataObject
  {
    private ExtensionDataObject extensionData;

    public TemplateSubstitution(string parameterName, string value, bool isFieldName)
    {
