...
// Type: Elli.CalculationEngine.Core.EngineCore.PlanType
...
namespace Elli.CalculationEngine.Core.EngineCore
{
  ...
  {
    SingleFieldExecutionPlan,
    SingleFieldReferencePlan,
    SingleFieldInitializationPlan,
    DirectlyReferencedCalculations,
    DirectlyDependentCalculations,
    MergedExecutionPlan,
    MergedInitializationPlan,
    FullInitializationPlan,
  }
}
