...
// Type: Elli.CalculationEngine.Core.DataSource.IDataSource
...
{
  public interface IDataSource : IDisposable, IDataEntity, IDataElement
  {
    DataContractSerializer GetSerializer();

    IEnumerable<IDataEntity> GetAllEntitiesOfType(EntityDescriptor entityType);
  }
}
