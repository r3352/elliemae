...
// Type: Elli.CalculationEngine.Core.DataSource.GenericEntityWrapper
...
{
  public class GenericEntityWrapper(IDataEntity entity, DataSourceWrapper rootDataSource) : 
    DataEntityWrapper(entity, rootDataSource)
  {
  }
}
