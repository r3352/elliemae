...
// Type: Elli.CalculationEngine.Core.Configuration.UniqueOrDefaultSettingType
...
#nullable disable
namespace Elli.CalculationEngine.Core.Configuration
{
  public enum UniqueOrDefaultSettingType
  {
    Unknown,
    FirstOrDefault,
    SingleOrDefault,
