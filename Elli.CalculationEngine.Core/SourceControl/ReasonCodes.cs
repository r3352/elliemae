...
// Type: Elli.CalculationEngine.Core.SourceControl.ReasonCodes
...
{
  public class ReasonCodes : ConfigurationSection
  {
    [ConfigurationProperty("", IsRequired = true, IsDefaultCollection = true)]
    public ReasonCodeCollection Codes
    {
      get => (ReasonCodeCollection) this[""];
