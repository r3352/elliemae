...
// Type: Elli.CalculationEngine.Core.CalculationLibrary.CalculationLibraries
...
{
  public class CalculationLibraries
  {
    public List<Elli.CalculationEngine.Core.CalculationLibrary.CalculationLibrary> Instances { get; set; }
  }
}
