...
// Type: Elli.CalculationEngine.Core.CalculationLibrary.ICalculationLibrary
...
{
  public interface ICalculationLibrary
  {
    string Name { get; set; }
    ...
    string AssemblyLibraryPath { get; set; }

    string AssemblyOutputPath { get; set; }
  }
}
