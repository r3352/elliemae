...
// Type: EllieMae.EMLite.ClickLoanImpl.EncRemoteObjSponsor
...
{
  internal class EncRemoteObjSponsor : MarshalByRefObject, ISponsor
  {
    public TimeSpan Renewal(ILease lease) => TimeSpan.FromMinutes(10.0);
  }
}
