...
// Type: Elli.Service.Common.IMessage
...
namespace Elli.Service.Common
{
  public interface IMessage
  {
    ...
    string TryGetSourceUrnPart(StandardMessage.SourceUrnPart part, string defaultValue = "");

    string TryGetTypeUrnPart(StandardMessage.TypeUrnPart part, string defaultValue = "");
