...
// Type: Elli.Service.Common.Caching.ServiceCacheConfiguration
...
{
  public class ServiceCacheConfiguration(IEnumerable<Type> knownRequestTypes) : CacheConfiguration(knownRequestTypes, typeof (EnableServiceResponseCachingAttribute))
  {
  }
}
