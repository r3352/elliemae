...
// Type: Elli.Service.Common.Caching.ClientCacheConfiguration
...
{
  public class ClientCacheConfiguration(IEnumerable<Type> knownRequestTypes) : CacheConfiguration(knownRequestTypes, typeof (EnableClientResponseCachingAttribute))
  {
  }
}
