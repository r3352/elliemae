...
// Type: Elli.Interface.Engine.IEngine`2
...
#nullable disable
namespace Elli.Interface.Engine
{
  public interface IEngine<EngineType, EngineContextType>
  {
    EngineContextType CreateContext();
  }
}
